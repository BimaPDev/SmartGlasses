...
p = {"lang":"en_US","uuid":str(uuid.uuid4()),"version":"2.39.0",
     "appName":"MYVU AR","packageName":"com.upuphone.star.launcher.intl",
     "brandName":"Google","modelName":"Pixel 8"}
print(post("https://xr-nbs-global.myvu.cn/ar-ota/client/v1/super-app/latest-version/v2", p)[:800])
