...
|---|---|---|---|
| HUD GIFs | 12 | same | `gifs/` and `ui/gifs/` |
...
| Named HUD icons (weather/music/navi/…) | names only (98) | LittleFS | `ui/icon_resources.txt` |
...
| Pages / Views / Models | 69 | yes | `strings/pages.txt` + `ui/` |
