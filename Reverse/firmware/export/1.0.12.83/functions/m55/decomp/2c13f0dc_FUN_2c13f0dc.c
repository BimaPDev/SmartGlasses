/* FUN_2c13f0dc @ 0x2c13f0dc */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 FUN_2c13f0dc(byte *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  iVar6 = *(int *)(_DAT_2c13f1c0 + 0x14);
  if (iVar6 == 0) {
    FUN_2c13ee98(param_1,0xfffffff8,param_3,_DAT_2c13f1c0,param_4);
    return 0xffffffff;
  }
  uVar3 = _DAT_2c13f1c0;
  if ((param_1 == (byte *)0x0) || (uVar3 = (uint)*param_1, uVar3 != 0xf5)) {
    FUN_2c13ee98(param_1,0xfffffffc,param_3,uVar3,param_4);
    return 0xfffffffc;
  }
  if (param_1[0x18] == 0) {
    FUN_2c13ee98(param_1,0xfffffff1,param_3,0xf5,param_4);
    return 0xfffffffd;
  }
  if (*(int *)(param_1 + 0xc) != iVar6) {
    FUN_2c13ee98(param_1,0xfffffff2,param_3,*(int *)(param_1 + 0xc),param_4);
    return 0xfffffffd;
  }
  ...
  if (*(int *)(param_1 + 8) != 0) {
    iVar6 = FUN_2c14089c(param_1);
    FUN_2c140ec8(iVar6,0);
