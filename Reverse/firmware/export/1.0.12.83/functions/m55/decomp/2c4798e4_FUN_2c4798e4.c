/* FUN_2c4798e4 @ 0x2c4798e4 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c4798e4(void)

{
  ...
  if (*(char *)(_LAB_2c479930 + -0xbe48) == '\x11') {
    uVar6 = FUN_2c478604(_LAB_2c479930 + -0xbe46);
    if (uVar6 == 0) {
      uVar4 = (uint)*_LAB_2c479938;
    }
    else {
      if ((int)(uint)*_LAB_2c479938 <= (int)uVar6) {
        uVar6 = (uint)*_LAB_2c479938;
      }
      uVar4 = uVar6 & 0xffff;
      *_LAB_2c479938 = (ushort)uVar6;
    }
    ...
    FUN_2c48e518((int)uVar7,uVar2,_LAB_2c47741c);
  ...
  uVar6 = *(uint *)(_LAB_2c479930 + 0x50c) & 0xffff;
  iStack_1c = *DAT_2c47ae70;
  iVar5 = FUN_2c473878(_LAB_2c479934,uVar6,_LAB_2c479930 + -0xc000,0);
  if (iVar5 != 0) {
                    /* WARNING: Subroutine does not return */
    TRACE(4,0x186,DAT_2c47ae80,DAT_2c47ae7c,DAT_2c47ae74,DAT_2c47ae78,uVar6,
