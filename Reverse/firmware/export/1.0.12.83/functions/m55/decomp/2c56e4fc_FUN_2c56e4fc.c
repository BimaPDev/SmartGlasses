/* FUN_2c56e4fc @ 0x2c56e4fc */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c56e4fc(undefined4 *param_1)

{
  ...
  *param_1 = _LAB_2c56e5e4;
  if (piVar5 != (int *)0x0) {
    if (*(code **)(*piVar5 + 0xc) == _LAB_2c56e5e8) {
      iVar4 = piVar5[0x12];
      iVar6 = piVar5[0x13];
      iVar2 = _LAB_2c56e5ec + 0x24;
      *piVar5 = _LAB_2c56e5ec;
      piVar5[2] = iVar2;
      if (iVar4 != iVar6) {
        iVar2 = iVar4 + 0x20;
        do {
