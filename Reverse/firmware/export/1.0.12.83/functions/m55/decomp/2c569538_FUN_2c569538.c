/* FUN_2c569538 @ 0x2c569538 */

int * FUN_2c569538(int *param_1,int param_2,uint param_3,int *param_4,undefined4 param_5)
  ...
  if (local_2c[0] != '\0') {
    ...
    if (piVar3 != (int *)0x0) {
      ...
      do {
        while( true ) {
          piVar4 = (int *)*piVar3;
          iVar2 = piVar3[0xd] - local_28 * ((uint)piVar3[0xd] / local_28);
          if ((int *)piVar5[iVar2] == (int *)0x0) break;
          *piVar3 = *(int *)piVar5[iVar2];
          *(int **)piVar5[iVar2] = piVar3;
joined_r0x2c569626:
          piVar3 = piVar4;
          if (piVar4 == (int *)0x0) goto LAB_2c5695f6;
        }
        *piVar3 = param_1[2];
