/* FUN_2c55d7c0 @ 0x2c55d7c0 */

/* WARNING: Type propagation algorithm not settling */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 FUN_2c55d7c0(int *param_1)

{
  ...
  if ((piVar6 != (int *)0x0) && (piVar6[1] != 0)) {
    ...
    uVar2 = FUN_2c62e838(param_1,_LAB_2c55d824);
    iVar5 = piVar6[1];
    piVar6[1] = iVar5 + -1;
    if (iVar5 + -1 == 0) {
      ...
      piVar6[2] = iVar5 + -1;
      if (iVar5 + -1 == 0) {
                    /* WARNING: Could not recover jumptable at 0x2c55d80c. Too many branches */
