/* FUN_2c4e0c74 @ 0x2c4e0c74 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 FUN_2c4e0c74(int *param_1)

{
  ...
  if (param_1[0x58] == 0) {
    FUN_2c4de6ca(*(int *)(*param_1 + -0xc) + (int)param_1,0x2189,0x1c,1);
    uVar19 = 0x1c;
    uVar9 = _LAB_2c4e0d7c;
  }
  else if ((char)param_1[0x59] == '\0') {
    FUN_2c4de6ca(*(int *)(*param_1 + -0xc) + (int)param_1,0x2189,0x1d,1);
    uVar19 = 0x1d;
    uVar9 = _LAB_2c4e0d8c;
  }
  else if (*(char *)((int)param_1 + 0x165) == '\0') {
    FUN_2c4de6ca(*(int *)(*param_1 + -0xc) + (int)param_1,0x2189,0x1e,1);
    uVar19 = 0x1e;
    uVar9 = _LAB_2c4e0d90;
  }
  else {
    if (*(char *)((int)param_1 + 0x166) != '\0') {
      func_0x2c4e0558(_LAB_2c4e0d98,param_1[0x58],(char)param_1[0x59],
                      *(char *)((int)param_1 + 0x165),*(char *)((int)param_1 + 0x166));
      ...
      *(undefined4 *)((int)param_1 + iVar15 + 0x68) = uVar9;
      ...
      if (iVar15 != 0) {
        ...
        FUN_2c4e0504(_LAB_2c4dd3c4,4,0,0,_LAB_2c4dd3d0,0x48,_LAB_2c4dd3cc,0x1300,_LAB_2c4dd3c8,
                     iVar15,iVar18,uVar16,uVar9,uVar19,uVar10,uVar14,uVar3,uVar4,uVar5,uVar7,uVar8);
        if (piVar11[0x1a] != 0) {
    ...
    FUN_2c4de6ca(*(int *)(*param_1 + -0xc) + (int)param_1,0x2189,0x1f,1);
    uVar19 = 0x1f;
    uVar9 = _LAB_2c4e0d94;
  }
  FUN_2c4e0504(_LAB_2c4e0d88,0,0,0,_LAB_2c4e0d84,uVar19,_LAB_2c4e0d80,0x1300,uVar9);
  return 0;
}
