/* FUN_2c65d2ec @ 0x2c65d2ec */

undefined4 *
FUN_2c65d2ec(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  uVar2 = FUN_2c652d76(&local_40,&param_5);
  if (uVar2 == 0) {
    ...
    if ((((bVar16) || (*(char *)(iVar1 + 0x4b) == local_35)) &&
      ...
      local_3c = 0xffffffff;
      iVar3 = FUN_2c652d9a(&local_40,&param_5);
      if (iVar3 == 0) {
        uVar9 = 0;
        uVar10 = 0;
        uVar13 = 1;
...
LAB_2c65d3da:
          ...
          if (uVar11 != 10) goto LAB_2c65d3e0;
          if (uVar7 != 0) {
LAB_2c65d3d8:
            uVar10 = uVar10 + 1;
            goto LAB_2c65d3da;
...
LAB_2c65d454:
  local_34[0] = DAT_2c65d674;
  if (*(char *)(iVar1 + 0x10) != '\0') {
    FUN_2c6510f6(local_34,0x20);
  }
  uVar17 = FUN_2c672ae8(0xffffffff,0xffffffff,uVar11,0);
  ...
  if (uVar6 == 0) {
    ...
    uVar15 = uVar6;
    if (uVar13 == 0) {
      while (uVar6 = FUN_2c658fb4(uVar7,local_35), uVar6 != 0xffffffff) {
    ...
    while (uVar13 = uVar15, uVar15 = uVar14, uVar13 == 0) {
      while( true ) {
        ...
        if ((cVar5 == '\0') || (*(char *)(iVar1 + 0x25) != local_35)) {
          if (*(char *)(iVar1 + 0x24) == local_35) goto LAB_2c65d4fa;
          iVar3 = FUN_2c650c06(iVar1 + 0x4e,uVar7,&local_35);
          if (iVar3 == 0) {
            cVar5 = '\0';
            goto LAB_2c65d4fc;
          }
...
LAB_2c65d4fc:
  if (*(int *)(local_34[0] + -0xc) != 0) {
    FUN_2c651292(local_34,uVar10 & 0xff);
