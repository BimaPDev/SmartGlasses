/* FUN_2c5a8874 @ 0x2c5a8874 */

void FUN_2c5a8874(int *param_1,int param_2,uint param_3,int *param_4,uint param_5)

{
  ...
  if ((param_4 < piVar6) || ((int *)(iVar1 + (int)piVar6) < param_4)) {
    ...
    if (param_5 == 0) goto LAB_2c5a88ea;
    if (param_5 != 1) {
...
LAB_2c5a8950:
      if (iVar3 != 0) {
        if (param_3 == param_5) goto LAB_2c5a88ea;
        goto LAB_2c5a8958;
      }
    }
    else {
      ...
      if ((param_3 == param_5) || (iVar3 == 0)) goto LAB_2c5a88ea;
LAB_2c5a8958:
      if (iVar3 == 1) {
        puVar8[param_5] = puVar8[param_3];
      }
    ...
    if (param_5 <= param_3) goto LAB_2c5a88ea;
