/* FUN_2c653a6c @ 0x2c653a6c */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 *
FUN_2c653a6c(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_2c653b94:
        ...
        while (uVar5 = FUN_2c652d9a(&uStack_70,&param_5), uVar5 != 0) {
          if (iVar13 == iVar6) goto LAB_2c653bd6;
          cVar2 = FUN_2c652d58(&uStack_70);
          if (*(char *)(*(int *)(iVar8 + 0x14) + iVar13) != cVar2) goto LAB_2c653bc2;
          iVar13 = iVar13 + 1;
          FUN_2c652294(&uStack_70);
        }
        if (iVar13 != iVar6) {
      ...
      while (uVar5 = FUN_2c652d9a(&uStack_70,&param_5), uVar5 != 0) {
        ...
        if (iVar6 == 0) {
          if ((*(char *)(iVar8 + 0x11) == cVar2) && (uVar11 == 0)) {
            if (*(int *)(iVar8 + 0x2c) < 1) goto LAB_2c653d34;
            uStack_84 = uVar10;
            uVar11 = uVar5;
            uVar10 = 0;
          }
            ...
            if ((*(byte *)(iVar8 + 0x10) == 0) ||
               ((uVar5 = (uint)*(byte *)(iVar8 + 0x10), *(char *)(iVar8 + 0x12) != cVar2 ||
                (uVar5 = uVar11, uVar11 != 0)))) goto LAB_2c653d34;
            if (uVar10 == 0) {
              uVar5 = 0;
              goto LAB_2c653d34;
            }
          ...
          FUN_2c65ebe0(&pcStack_48,*(undefined1 *)(*_LAB_2c653e48 + (iVar6 - (iVar8 + 0x38))));
          uVar10 = uVar10 + 1;
        }
        FUN_2c652294(&uStack_70);
      }
...
LAB_2c653bf8:
  ...
  if (iVar9 == 0) goto LAB_2c653dbe;
  if (uVar12 == uVar7) goto LAB_2c653dc4;
  cVar2 = FUN_2c652d58(&uStack_70);
  if (*(char *)(iVar4 + uVar7) != cVar2) goto LAB_2c653b08;
  uVar7 = uVar7 + 1;
  FUN_2c652294(&uStack_70);
  goto LAB_2c653bf8;
LAB_2c653dbe:
