/* FUN_2c55c7ac @ 0x2c55c7ac */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c55c7ac(int *param_1,undefined4 *param_2)

{
  ...
  *(undefined4 *)((int)param_1 + iVar4 + 0x3c) = 0x95;
  uVar1 = _LAB_2c55c830;
  *(undefined4 *)((int)param_1 + *(int *)(*param_1 + -0x10) + 0x40) = 5000;
