/* FUN_2c671378 @ 0x2c671378 */

uint FUN_2c671378(undefined4 param_1,uint param_2,uint *param_3,undefined4 param_4)
    ...
    if (param_3[0xd] == 0) {
      ...
      *param_3 = (uint)((int)param_3 + 0x46);
      ...
      if (((int)param_3[0xe] <= (int)uVar2) &&
         (iVar1 = FUN_2c66db7c(param_1,param_3,uVar2,param_3[0xe],param_4), iVar1 != 0))
      goto LAB_2c671380;
      uVar2 = *param_3;
      *param_3 = uVar2 - 1;
