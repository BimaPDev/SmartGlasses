/* FUN_2c656ce2 @ 0x2c656ce2 */

undefined4 *
FUN_2c656ce2(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  local_38[2] = param_3;
  local_38[3] = param_4;
  uVar1 = FUN_2c65faf0(param_10 + 0x6c);
  iVar9 = -(param_9 * 4 + 7U & 0xfffffff8);
  iVar2 = FUN_2c656c1a(piVar7,&param_5);
  if (iVar2 != 0) {
    iVar2 = FUN_2c656bd8(piVar7);
    uVar8 = 0;
    for (iVar12 = 0; iVar12 != param_9; iVar12 = iVar12 + 1) {
      if ((**(int **)(iVar10 + iVar12 * 4) == iVar2) ||
         (local_38[1] = iVar2, iVar3 = FUN_2c656bcc(uVar1), iVar2 = local_38[1],
         iVar3 == local_38[1])) {
    ...
    uVar11 = 0;
    while (1 < uVar8) {
      uVar4 = FUN_2c66ea0c(*(undefined4 *)(iVar10 + *(int *)((int)local_38 + iVar9) * 4));
      uVar6 = 1;
      do {
        local_38[1] = uVar6;
        uVar5 = FUN_2c66ea0c(*(undefined4 *)
      ...
      uVar11 = uVar11 + 1;
      FUN_2c6561e8(piVar7);
      if ((uVar4 <= uVar11) || (iVar2 = FUN_2c656c1a(piVar7,&param_5), iVar2 == 0))
      goto LAB_2c656e20;
      iVar2 = uVar11 * 4;
      uVar4 = 0;
      do {
    ...
    if (uVar8 == 1) {
      ...
      uVar8 = FUN_2c66ea0c(iVar10);
      while( true ) {
        uVar11 = uVar11 + 1;
        if (uVar8 <= uVar11) break;
        iVar2 = FUN_2c656c1a(piVar7,&param_5);
        if (iVar2 == 0) goto LAB_2c656e20;
        local_38[1] = *(int *)(iVar10 + uVar11 * 4);
        iVar2 = FUN_2c656bd8(piVar7);
        if (local_38[1] != iVar2) goto LAB_2c656e20;
        FUN_2c6561e8(piVar7);
      }
      if (uVar11 == uVar8) {
        *param_7 = iVar9;
