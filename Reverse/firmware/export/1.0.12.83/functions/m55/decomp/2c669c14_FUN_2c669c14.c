/* FUN_2c669c14 @ 0x2c669c14 */

uint FUN_2c669c14(undefined4 *param_1,uint param_2)

{
  ...
  puVar1 = (uint *)FUN_2c669bd4(param_1,uVar7);
  if (puVar1 == (uint *)0xffffffff) {
    ...
    uVar5 = *puVar1;
    iVar2 = FUN_2c66b3a8(param_1,0);
    if ((int)puVar1 + uVar5 == iVar2) {
      uVar7 = ((uVar7 + 3) - *puVar1 & 0xfffffffc) + 8;
      if (uVar7 < 0xc) {
        uVar7 = 0xc;
      }
      iVar2 = FUN_2c669bd4(param_1,uVar7);
      if (iVar2 != -1) {
        *puVar1 = *puVar1 + uVar7;
        goto LAB_2c669cb4;
      }
