/* FUN_2c645ea4 @ 0x2c645ea4 */

undefined4 FUN_2c645ea4(undefined1 param_1,uint param_2)

{
  ...
  iVar1 = DAT_2c645e9c;
  if ((*(char *)(DAT_2c645eb8 + 8) != '\x02') || (*(int *)(DAT_2c645eb8 + 0x24) == 0)) {
    return 0;
  }
  iVar6 = *(int *)(DAT_2c645e9c + 0x14);
  FUN_2c643a7c(iVar6);
...
LAB_2c645e3a:
  ...
  *(int *)(iVar1 + 0x24) = iVar6;
  if (iVar6 != 0) {
    *(undefined4 *)(iVar6 + 0xc) = DAT_2c645ea0;
  }
