/* FUN_2c660aba @ 0x2c660aba */

undefined4
FUN_2c660aba(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_a8[0] = iVar6;
  local_34[0] = FUN_2c65fe52(auStack_48,iVar2,iVar1 + 0x2c,uVar5);
  ...
  piVar3 = piVar4;
  if (iVar6 == 0) {
    if ((-1 < (int)(uVar5 << 0x16)) || (param_7 == 0)) goto LAB_2c660b66;
    if (local_44 != 0x40) {
    ...
    if (-1 < (int)(uVar5 << 0x14)) goto LAB_2c660b66;
