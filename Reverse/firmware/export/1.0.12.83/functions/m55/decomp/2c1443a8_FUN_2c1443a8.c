/* FUN_2c1443a8 @ 0x2c1443a8 */

/* WARNING: Removing unreachable block (ram,0x2c14459c) */

undefined8 FUN_2c1443a8(uint param_1,uint param_2,uint param_3,uint param_4,uint *param_5)
  ...
  if (param_4 == 0) {
    if (param_2 < param_3) {
      ...
      if (param_3 == 0) {
        ...
        pcVar1 = (code *)software_udf(0xff,0x2c144482);
        (*pcVar1)();
      }
      iVar6 = LZCOUNT(param_3);
      if (iVar6 == 0) {
