/* FUN_2c010324 @ 0x2c010324 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c010324(uint param_1)

{
  ...
  if (param_1 < _DAT_2c01036c) {
    uVar6 = *_DAT_2c010370 & 0xffffff7f;
  }
  else {
    uVar6 = *_DAT_2c010370 | 0x80;
  }
  *_DAT_2c010370 = uVar6;
  if (iVar7 == 0) {
    *_DAT_2c010368 = 0xffffffff;
  }
  puVar4 = DAT_2c00fa3c;
  bVar2 = (bool)isCurrentModePrivileged();
  if (bVar2) {
