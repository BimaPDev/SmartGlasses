/* FUN_2c661844 @ 0x2c661844 */

undefined4 *
FUN_2c661844(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_2c6618ea:
    ...
    if (uVar8 == 0) goto LAB_2c6618ea;
    uVar4 = 0;
    FUN_2c660394(puVar10);
  ...
  while (iVar3 = FUN_2c656c1a(auStack_38 + 2,&param_5), iVar3 != 0) {
    ...
    while (uVar9 < uVar4) {
      if (uVar6 < puVar10[uVar9]) {
        if (*(int *)(*(int *)(iVar1 + puVar7[uVar9] * 4) + uVar6 * 4) == iVar3) goto LAB_2c661926;
        uVar4 = uVar4 - 1;
