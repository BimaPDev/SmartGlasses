/* FUN_2c65d950 @ 0x2c65d950 */

undefined4 *
FUN_2c65d950(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  iVar9 = FUN_2c659864(iVar9);
  local_38 = DAT_2c65dc08;
  uVar8 = 0;
  if ((*(int *)(iVar9 + 0x20) != 0) && (uVar8 = 0, *(int *)(iVar9 + 0x28) != 0)) {
    uVar8 = 1;
  }
  local_3c = DAT_2c65dc08;
...
LAB_2c65da68:
        ...
        while (uVar5 = FUN_2c652d9a(&local_48,&param_5), uVar5 != 0) {
          if (iVar14 == iVar6) goto LAB_2c65daaa;
          cVar2 = FUN_2c652d58(&local_48);
          if (*(char *)(*(int *)(iVar9 + 0x14) + iVar14) != cVar2) goto LAB_2c65da96;
          iVar14 = iVar14 + 1;
          FUN_2c659e18(&local_48);
        }
        if (iVar14 != iVar6) {
LAB_2c65da96:
        ...
        if (local_34._3_1_ != '\x04') {
          if (uVar8 == 0) goto switchD_2c65d9c8_default;
          uVar5 = uVar8;
          if (local_34._3_1_ != '\x03') break;
        }
        goto LAB_2c65da68;
      }
switchD_2c65d9c8_default:
      uVar5 = 1;
      break;
    case 3:
      ...
      while (uVar5 = FUN_2c652d9a(&local_48,&param_5), uVar5 != 0) {
        ...
        if (iVar6 == 0) {
          if ((*(char *)(iVar9 + 0x11) == cVar2) && (uVar12 == 0)) {
            if (*(int *)(iVar9 + 0x2c) < 1) goto LAB_2c65dc12;
            local_5c = uVar11;
            uVar12 = uVar5;
            uVar11 = 0;
          }
            ...
            if ((*(byte *)(iVar9 + 0x10) == 0) ||
               ((uVar5 = (uint)*(byte *)(iVar9 + 0x10), *(char *)(iVar9 + 0x12) != cVar2 ||
                (uVar5 = uVar12, uVar12 != 0)))) goto LAB_2c65dc12;
            if (uVar11 == 0) {
              uVar5 = 0;
              goto LAB_2c65dc12;
            }
          ...
          FUN_2c651292(&local_38,*(undefined1 *)(*DAT_2c65dc0c + (iVar6 - (iVar9 + 0x38))));
          uVar11 = uVar11 + 1;
        }
        FUN_2c659e18(&local_48);
      }
...
LAB_2c65dc12:
      ...
      break;
    default:
      goto switchD_2c65d9c8_default;
    }
LAB_2c65daaa:
    iVar10 = iVar10 + 1;
    if (iVar10 == 4) {
      if (uVar13 < 2) {
        if (uVar5 != 0) goto LAB_2c65dca6;
      }
      else if (uVar5 != 0) {
        if (local_64 == 0) {
...
LAB_2c65dacc:
  ...
  if (iVar10 == 0) goto LAB_2c65dca0;
  if (uVar13 == uVar8) goto LAB_2c65dca6;
  cVar2 = FUN_2c652d58(&local_48);
  if (*(char *)(iVar4 + uVar8) != cVar2) goto LAB_2c65d9dc;
  uVar8 = uVar8 + 1;
  FUN_2c659e18(&local_48);
  goto LAB_2c65dacc;
LAB_2c65dca0:
