/* FUN_2c65b0d0 @ 0x2c65b0d0 */

undefined4 *
FUN_2c65b0d0(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  uVar4 = FUN_2c659524(param_10 + 0x6c);
  iVar11 = -(param_9 * 4 + 7U & 0xfffffff8);
  iVar5 = FUN_2c652d9a(ppiVar9,&param_5);
  if (iVar5 != 0) {
    bVar2 = FUN_2c652d58(ppiVar9);
    uVar10 = 0;
    for (iVar5 = 0; iVar5 != param_9; iVar5 = iVar5 + 1) {
      if (((uint)**(byte **)(iVar14 + iVar5 * 4) == (uint)bVar2) ||
         (uVar6 = FUN_2c6523ac(uVar4), uVar6 == bVar2)) {
    ...
    uVar6 = 0;
    while (1 < uVar10) {
      uVar7 = FUN_2c66c4ec(*(undefined4 *)(iVar14 + *(int *)((int)local_38 + iVar11) * 4));
      local_38[0] = (int *)((int)local_38 + uVar10 * 4 + iVar11);
      piVar12 = (int *)((int)local_38 + iVar11 + 4);
      do {
        piVar13 = piVar12 + 1;
        uVar8 = FUN_2c66c4ec(*(undefined4 *)(iVar14 + *piVar12 * 4));
        if (uVar8 <= uVar7) {
          uVar7 = uVar8;
        }
        piVar12 = piVar13;
      ...
      uVar6 = uVar6 + 1;
      FUN_2c659e18(ppiVar9);
      if ((uVar7 <= uVar6) || (iVar5 = FUN_2c652d9a(ppiVar9,&param_5), iVar5 == 0))
      goto LAB_2c65b196;
      uVar7 = 0;
      do {
    ...
    if (uVar10 == 1) {
      ...
      uVar10 = FUN_2c66c4ec(iVar14);
      while( true ) {
        uVar6 = uVar6 + 1;
        if (uVar10 <= uVar6) break;
        iVar5 = FUN_2c652d9a(ppiVar9,&param_5);
        if ((iVar5 == 0) ||
           (cVar1 = *(char *)(iVar14 + uVar6), cVar3 = FUN_2c652d58(ppiVar9), cVar1 != cVar3))
        goto LAB_2c65b196;
        FUN_2c659e18(ppiVar9);
      }
      if (uVar6 == uVar10) {
