/* FUN_2c141900 @ 0x2c141900 */

undefined4 FUN_2c141900(byte *param_1,int param_2,undefined4 param_3,uint param_4)
...
LAB_2c141926:
  ...
  if (param_2 != 0) {
    FUN_2c13eed0();
    iVar3 = FUN_2c140be8(99,param_2);
    if (iVar3 != 0) {
      FUN_2c14086c(param_1,*(undefined4 *)(DAT_2c14197c + 0x14));
      return 0xfffffffe;
    }
    FUN_2c13eed4(param_1);
    return 0xfffffffe;
  }
  FUN_2c13eedc();
  return 0xfffffffd;
