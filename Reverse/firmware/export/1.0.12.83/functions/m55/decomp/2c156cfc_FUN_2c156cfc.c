/* FUN_2c156cfc @ 0x2c156cfc */

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c156cfc(undefined4 param_1,int param_2)

{
  ...
  if (param_2 == 0) {
    ...
    *(uint *)(uVar3 + 0x14) = uVar3;
    *(undefined4 *)(uVar3 + 0x54) = 0;
    uRam00000011 = (undefined1)uVar4;
    cVar2 = (char)uRam00000054;
    *(char *)(*(int *)(uVar3 + 100) + 0x19) = (char)uVar6;
    *(char *)(uVar8 + 9) = (char)uVar3;
    *(uint *)(uVar3 + 0x14) = uVar8;
    *(char *)(uVar8 + 1) = cVar2 + 'm';
    func_0x2b658a18((int)*(short *)(uVar8 + (in_r12 & 4)),&stack0x000003a0,
                    uVar4 >> (uVar8 & 0x1f) | uVar4 << 0x20 - (uVar8 & 0x1f));
                    /* WARNING: Bad instruction - Truncating control flow here */
    halt_baddata();
  }
  if (unaff_r4 != 0x4e) {
                    /* WARNING: Does not return */
    pcVar1 = (code *)software_udf(0xd5,0x2c156d1c);
    (*pcVar1)();
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
