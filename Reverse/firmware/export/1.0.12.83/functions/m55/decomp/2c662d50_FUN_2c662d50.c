/* FUN_2c662d50 @ 0x2c662d50 */

undefined4 *
FUN_2c662d50(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_2c662e94:
  ...
  if (uVar2 == 0) {
    ...
    uVar11 = uVar2;
    if (uVar9 == 0) {
      while (uVar2 = FUN_2c65f550(uVar6,local_38), uVar2 != 0xffffffff) {
    ...
    while (uVar9 = uVar11, uVar11 = uVar10, uVar9 == 0) {
      while( true ) {
        ...
        if ((cVar13 == '\0') || (local_38 != *(int *)(iVar1 + 0x28))) {
          if (local_38 == *(int *)(iVar1 + 0x24)) goto LAB_2c662f32;
          iVar3 = FUN_2c65137e(iVar1 + 0xcc,uVar6,&local_38);
          if (iVar3 == 0) {
            cVar13 = '\0';
            goto LAB_2c662f36;
          }
