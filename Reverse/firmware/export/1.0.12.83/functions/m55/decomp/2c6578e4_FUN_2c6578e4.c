/* FUN_2c6578e4 @ 0x2c6578e4 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 *
FUN_2c6578e4(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_2c657a0e:
        ...
        while (uVar5 = FUN_2c656c1a(&uStack_70,&param_5), uVar5 != 0) {
          if (iVar13 == iVar4) goto LAB_2c657a4e;
          iVar3 = FUN_2c656bd8(&uStack_70);
          if (*(int *)(*(int *)(iVar8 + 0x1c) + iVar13 * 4) != iVar3) goto LAB_2c657a3a;
          iVar13 = iVar13 + 1;
          FUN_2c6561e8(&uStack_70);
        }
        if (iVar13 != iVar4) {
      ...
      while (uVar5 = FUN_2c656c1a(&uStack_70,&param_5), uVar5 != 0) {
        ...
        if (iVar4 == 0) {
          if ((*(int *)(iVar8 + 0x14) == iStack_64) && (uVar11 == 0)) {
            if (*(int *)(iVar8 + 0x34) < 1) goto LAB_2c657ba8;
            uStack_80 = uVar10;
            uVar11 = uVar5;
            uVar10 = 0;
          }
            ...
            if ((*(byte *)(iVar8 + 0x10) == 0) ||
               ((uVar5 = (uint)*(byte *)(iVar8 + 0x10), iStack_64 != *(int *)(iVar8 + 0x18) ||
                (uVar5 = uVar11, uVar11 != 0)))) goto LAB_2c657ba8;
            if (uVar10 == 0) {
              uVar5 = 0;
              goto LAB_2c657ba8;
            }
          ...
          FUN_2c65ebe0(&pcStack_48,*(undefined1 *)(*_LAB_2c657cc4 + (iVar4 - (iVar8 + 0x40) >> 2)));
          uVar10 = uVar10 + 1;
        }
        FUN_2c6561e8(&uStack_70);
      }
...
LAB_2c657a70:
  iVar4 = FUN_2c656c1a(&uStack_70,&param_5);
  if (iVar4 == 0) goto LAB_2c657c3a;
  if (uVar12 == uVar7) goto LAB_2c657c40;
  iVar4 = FUN_2c656bd8(&uStack_70);
  if (*(int *)(iVar9 + uVar7 * 4) != iVar4) goto LAB_2c657982;
  uVar7 = uVar7 + 1;
  FUN_2c6561e8(&uStack_70);
  goto LAB_2c657a70;
LAB_2c657c3a:
