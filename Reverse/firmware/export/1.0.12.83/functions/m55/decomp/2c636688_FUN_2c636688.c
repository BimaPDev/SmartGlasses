/* FUN_2c636688 @ 0x2c636688 */

void FUN_2c636688(int param_1,uint param_2)

{
  ...
  local_14 = *DAT_2c636788;
  if (0x168 < param_2) {
    param_2 = param_2 - 0x168 & 0xffff;
  }
  uVar7 = (uint)*(ushort *)(param_1 + 0x26);
  sVar1 = *(short *)(param_1 + 0x28) - *(ushort *)(param_1 + 0x26);
  sVar2 = *(short *)(param_1 + 0x28) - (short)param_2;
  iVar4 = (int)sVar1;
  iVar6 = (int)sVar2;
  if (iVar4 < 0) {
