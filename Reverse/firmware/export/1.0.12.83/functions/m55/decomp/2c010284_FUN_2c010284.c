/* FUN_2c010284 @ 0x2c010284 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c010284(uint param_1)

{
  ...
  if (param_1 < _DAT_2c0102cc) {
    uVar6 = *_DAT_2c0102d0 & 0xfffffdff;
  }
  else {
    uVar6 = *_DAT_2c0102d0 | 0x200;
  }
  *_DAT_2c0102d0 = uVar6;
  if (iVar7 == 0) {
    *_DAT_2c0102c8 = 0xffffffff;
  }
  puVar4 = DAT_2c00fa3c;
  bVar2 = (bool)isCurrentModePrivileged();
  if (bVar2) {
