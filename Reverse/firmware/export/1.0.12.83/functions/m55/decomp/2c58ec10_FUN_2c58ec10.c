/* FUN_2c58ec10 @ 0x2c58ec10 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 FUN_2c58ec10(int param_1,int param_2)

{
  ...
  iStack_24 = *_LAB_2c58ecf0;
  uVar3 = 0;
  if (piVar2 == (int *)0x0) goto LAB_2c58ec34;
  iVar1 = FUN_2c58d730(piVar2[3],piVar2[4],_LAB_2c58ecf4,0);
  uVar6 = _LAB_2c58ecfc;
  if (iVar1 != 0) {
    uVar3 = 0;
    goto LAB_2c58ec34;
  ...
  if (uVar4 < 0x10) {
    ...
    else if (uVar4 != 0) goto LAB_2c58ecce;
  }
  else {
    puStack_4c = (uint *)FUN_2c58d6c0(&uStack_54,0);
