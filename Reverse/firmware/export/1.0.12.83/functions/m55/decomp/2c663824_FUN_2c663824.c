/* FUN_2c663824 @ 0x2c663824 */

undefined4 *
FUN_2c663824(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  uVar2 = FUN_2c656bf6(&local_48,&param_5);
  if (uVar2 == 0) {
    ...
    if ((((bVar17) || (*(int *)(iVar1 + 0xc0) == local_38)) &&
      ...
      local_44 = 0xffffffff;
      iVar3 = FUN_2c656c1a(&local_48,&param_5);
      if (iVar3 == 0) {
        uVar10 = 0;
        uVar11 = 0;
        uVar14 = 1;
...
LAB_2c6638fe:
          ...
          if (uVar12 != 10) goto LAB_2c663904;
          if (uVar8 != 0) {
LAB_2c6638fc:
            uVar11 = uVar11 + 1;
            goto LAB_2c6638fe;
...
LAB_2c663976:
  local_34[0] = DAT_2c663b8c;
  if (*(char *)(iVar1 + 0x10) != '\0') {
    FUN_2c6510f6(local_34,0x20);
  }
  uVar18 = FUN_2c672ae8(0xffffffff,0xffffffff,uVar12,0);
  ...
  if (uVar6 == 0) {
    ...
    uVar16 = uVar6;
    if (uVar14 == 0) {
      while (uVar6 = FUN_2c65f550(uVar8,local_38), uVar6 != 0xffffffff) {
    ...
    while (uVar14 = uVar16, uVar16 = uVar15, uVar14 == 0) {
      while( true ) {
        ...
        if ((cVar5 == '\0') || (local_38 != *(int *)(iVar1 + 0x28))) {
          if (local_38 == *(int *)(iVar1 + 0x24)) goto LAB_2c663a16;
          uVar19 = FUN_2c65137e(iVar1 + 0xcc,uVar8,&local_38);
          ...
          if (uVar11 == 0) goto LAB_2c663a18;
          uVar15 = uVar11 & 0xff;
          uVar11 = 0;
          FUN_2c651292(local_34,uVar15);
          iVar3 = extraout_r1;
          uVar15 = uVar16;
        }
        FUN_2c65f53c(local_48,iVar3);
        local_44 = 0xffffffff;
        iVar3 = FUN_2c656c1a(&local_48,&param_5);
        uVar16 = uVar6;
        if (iVar3 == 0) break;
...
LAB_2c663a18:
  if (*(int *)(local_34[0] + -0xc) != 0) {
    FUN_2c651292(local_34,uVar11 & 0xff);
    iVar3 = FUN_2c665bc0(*(undefined4 *)(iVar1 + 8),*(undefined4 *)(iVar1 + 0xc),local_34);
    if (iVar3 == 0) {
      *param_8 = 4;
    }
  }
