/* FUN_2c6703ec @ 0x2c6703ec */

undefined4 FUN_2c6703ec(int *param_1,uint *param_2,uint *param_3)
...
LAB_2c67041c:
  while( true ) {
    ...
    bVar1 = *(byte *)(iVar4 + 1);
    if (bVar1 == 0) break;
    uVar2 = FUN_2c66feea(bVar1);
    if (uVar2 != 0) {
      iVar12 = iVar12 + 1;
      iVar14 = iVar14 + 1;
      if (8 < iVar12) goto code_r0x2c6704dc;
      goto LAB_2c6704e8;
    }
    if (0x20 < bVar1) {
      if (bVar1 != 0x29) goto LAB_2c67051c;
      *param_1 = iVar4 + 2;
      break;
    }
    iVar4 = iVar7;
    if (local_38 < iVar14) {
      if ((puVar11 < puVar5) && (iVar12 < 8)) {
        FUN_2c6703a0(puVar11,puVar5,iVar12);
      }
      if (param_3 < puVar11) {
        puVar5 = puVar11 + -1;
        puVar11[-1] = 0;
