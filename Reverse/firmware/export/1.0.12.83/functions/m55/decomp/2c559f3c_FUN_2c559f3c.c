/* FUN_2c559f3c @ 0x2c559f3c */

int * FUN_2c559f3c(int *param_1,uint *param_2,uint *param_3,uint param_4)
      ...
      if (piVar12 != (int *)0x0) {
        ...
        while (uVar5 != uVar7) {
          ...
          if ((piVar2 == (int *)0x0) ||
             ...
             iVar6 != uVar7 - uVar10 * (uVar7 / uVar10))) goto LAB_2c55a040;
        }
        if (*piVar12 != 0) goto LAB_2c55a01c;
      }
LAB_2c55a040:
      if (*piVar1 == 0) {
        FUN_2c4723c4();
      ...
      *piVar12 = 0;
      ...
      if (local_3c[0] == '\0') {
        ...
        if (piVar8 == (int *)0x0) goto LAB_2c55a128;
LAB_2c55a088:
        *piVar12 = *piVar8;
...
joined_r0x2c55a164:
              piVar2 = piVar3;
              if (piVar3 == (int *)0x0) goto LAB_2c55a102;
            }
            *piVar2 = param_1[2];
...
LAB_2c55a102:
        ...
        *param_1 = (int)piVar8;
        ...
        if (piVar8 != (int *)0x0) goto LAB_2c55a088;
LAB_2c55a128:
        *piVar12 = param_1[2];
