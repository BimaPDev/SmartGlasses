/* FUN_2c513568 @ 0x2c513568 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c513568(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (cVar1 == '\v') {
    uStack_18 = registry_lookup(_LAB_2c5135e8);
  }
  else {
    if (cVar1 != '\x12') {
      return;
    }
    uStack_18 = registry_lookup(_LAB_2c5135ec);
  }
  iVar2 = *DAT_2c5e40ac;
  uStack_1c = 0;
  uStack_10 = 1;
