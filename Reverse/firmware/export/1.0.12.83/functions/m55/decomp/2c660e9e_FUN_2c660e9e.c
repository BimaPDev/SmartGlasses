/* FUN_2c660e9e @ 0x2c660e9e */

undefined4
FUN_2c660e9e(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_40 = param_3;
  uStack_3c = param_4;
  iVar1 = FUN_2c660988(auStack_38,param_5 + 0x6c);
  ...
  local_f8[2] = iVar7;
  local_48 = local_f8[0];
  local_34[0] = FUN_2c65febe(&local_48,local_f8[0],iVar2,iVar5);
  ...
  if (*(char *)(iVar1 + 0x10) != '\0') {
    ...
    *(int **)((int)local_f8 + iVar2 + 4) = piVar4;
    FUN_2c65fe28(param_2,*(undefined4 *)(iVar1 + 8),*(undefined4 *)(iVar1 + 0xc),
                 *(undefined4 *)(iVar1 + 0x28));
  }
  piVar3 = piVar4;
  if (iVar7 == 0) {
    if ((-1 < (int)(uVar6 << 0x16)) || (param_7 == 0 && param_8 == 0)) goto LAB_2c660f58;
    if (local_44 != 0x40) {
    ...
    if (-1 < (int)(uVar6 << 0x14)) goto LAB_2c660f58;
...
LAB_2c660f58:
  ...
  *piVar9 = local_34[0];
  FUN_2c6565e8(param_1,local_40,uStack_3c,piVar4);
  return param_1;
}
