/* FUN_2c65a8de @ 0x2c65a8de */

undefined4
FUN_2c65a8de(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_40 = param_3;
  uStack_3c = param_4;
  iVar1 = FUN_2c65a49c(auStack_38,param_5 + 0x6c);
  ...
  local_80[2] = iVar8;
  local_48 = local_80[0];
  local_34[0] = FUN_2c659d7c(&local_48,local_80[0],iVar5,iVar6);
  ...
  if (*(char *)(iVar1 + 0x10) != '\0') {
    ...
    *(undefined1 **)((int)local_80 + iVar5 + 4) = puVar2;
    FUN_2c659c12(param_2,*(undefined4 *)(iVar1 + 8),*(undefined4 *)(iVar1 + 0xc),uVar4);
  }
  puVar3 = puVar2;
  if (iVar8 == 0) {
    if ((-1 < (int)(uVar7 << 0x16)) || (param_7 == 0 && param_8 == 0)) goto LAB_2c65a99e;
    if (local_44 != 0x40) {
    ...
    if (-1 < (int)(uVar7 << 0x14)) goto LAB_2c65a99e;
...
LAB_2c65a99e:
  ...
  *piVar10 = local_34[0];
  FUN_2c65277c(param_1,local_40,uStack_3c,puVar2);
  return param_1;
}
