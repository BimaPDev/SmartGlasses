/* FUN_2c59ef40 @ 0x2c59ef40 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int * FUN_2c59ef40(int *param_1,int param_2,int *param_3)

{
  ...
  *(int *)(iVar1 + 0x28) = iVar5;
  FUN_2c59e860(&iStack_2c,param_2,iVar1 + 0x10);
  if (iStack_28 == 0) {
