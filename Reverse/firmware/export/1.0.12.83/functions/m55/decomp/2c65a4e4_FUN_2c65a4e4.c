/* FUN_2c65a4e4 @ 0x2c65a4e4 */

undefined4
FUN_2c65a4e4(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_38 = param_3;
  uStack_34 = param_4;
  iVar1 = FUN_2c65a49c(auStack_30,param_5 + 0x6c);
  ...
  local_68[0] = iVar7;
  local_2c[0] = FUN_2c659d1a(auStack_44,iVar5,local_40,uVar6);
  ...
  puVar3 = puVar2;
  if (iVar7 == 0) {
    if ((-1 < (int)(uVar6 << 0x16)) || (param_7 == 0)) goto LAB_2c65a592;
    if (local_3c != 0x40) {
    ...
    if (-1 < (int)(uVar6 << 0x14)) goto LAB_2c65a592;
...
LAB_2c65a592:
  ...
  *piVar9 = local_2c[0];
  FUN_2c65277c(param_1,local_38,uStack_34,puVar2);
  return param_1;
}
