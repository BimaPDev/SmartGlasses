/* FUN_2c539348 @ 0x2c539348 */

int * FUN_2c539348(int *param_1,int param_2,uint param_3,int *param_4,uint param_5)

{
  ...
  if ((param_4 < piVar6) || ((int *)(iVar1 + (int)piVar6) < param_4)) {
    ...
    if (param_5 == 0) goto LAB_2c5393be;
    if (param_5 != 1) {
...
LAB_2c539428:
      if (iVar3 != 0) goto joined_r0x2c53942e;
    }
    else {
      if (param_5 == 1) {
      ...
      if (iVar3 == 0) goto LAB_2c5393be;
joined_r0x2c53942e:
      if (param_3 == param_5) goto LAB_2c5393be;
      if (iVar3 == 1) {
        puVar8[param_5] = puVar8[param_3];
      }
      else {
    ...
    if (param_5 <= param_3) goto LAB_2c5393be;
