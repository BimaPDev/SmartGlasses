/* FUN_2c6726dc @ 0x2c6726dc */

ulonglong FUN_2c6726dc(uint param_1,uint param_2,uint param_3,uint param_4)
...
LAB_2c67291c:
  ...
  if (0xfffff < uVar10) {
    ...
    if (0x1fffff < uVar10) {
      ...
      uVar9 = uVar8;
      if (0xffbfffff < uVar8 * 0x200000) goto LAB_2c67291c;
    }
LAB_2c6727e8:
  ...
  uVar9 = uVar8 - 2;
  if (uVar8 - 1 != 0 && 0xfffff < uVar10) goto LAB_2c6727e8;
  uVar5 = uVar12;
  uVar8 = uVar10;
  if (uVar10 == 0) {
    uVar5 = 0;
