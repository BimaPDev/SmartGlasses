/* FUN_2c019ef4 @ 0x2c019ef4 */

undefined4 FUN_2c019ef4(byte *param_1,byte *param_2)

{
  ...
  param_1[0xb] = 0xf;
  iVar2 = DAT_2c01a014;
  bVar1 = *(byte *)(DAT_2c01a014 + (*param_2 ^ 0xf));
  param_1[0xb] = bVar1;
  if ((param_1[7] & 3) == 0) {
    param_1[1] = *param_2 >> 6;
