/* FUN_2c61a5d0 @ 0x2c61a5d0 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c61a5d0(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar18 = FUN_2c602110(_LAB_2c61a5ec);
  if (iVar18 != 1) {
    return;
  }
  ...
  if (iVar18 == 0x15) {
    ...
    FUN_2c60747c(iVar12,&sStack_1cc);
    iVar27 = iVar12 + 0x30;
    func_0x2c614f78(&uStack_128);
    iVar18 = FUN_2c6033b4(iVar12,0x50000,0x51);
    bStack_117 = bStack_117 & 0xfb | (iVar18 != 0) << 2;
    ...
    bVar6 = FUN_2c6033b4(iVar12,0,0x60);
    FUN_2c600b9c(&sStack_ec,uVar13);
    puStack_cc = &uStack_128;
    uStack_b8 = 0x20000;
    uStack_e8 = _LAB_2c619df4;
    uStack_e4 = 0;
    for (pbVar14 = (byte *)FUN_2c62ca18(iVar27); pbVar14 != (byte *)0x0;
        pbVar14 = (byte *)FUN_2c62ca28(iVar27,pbVar14)) {
      if (pbVar14[4] == 3) {
        uStack_128 = *(undefined4 *)(pbVar14 + 0x18);
        uVar25 = (uint)uStack_124 >> 0x10;
        uStack_124 = CONCAT22((short)uVar25,*(undefined2 *)(pbVar14 + 0x10));
        bStack_118 = bVar6;
        if (pbVar14[5] < 0xfe) {
          bStack_118 = (byte)((uint)pbVar14[5] * (uint)bVar6 >> 8);
        }
        iVar18 = *(int *)pbVar14;
        uVar8 = FUN_2c62e4a8(*(undefined4 *)(pbVar14 + 8),*(undefined4 *)(iVar18 + 0x1c),
                             *(undefined4 *)(iVar18 + 0x20),(int)*(short *)(iVar18 + 0x28),
                             (uint)*(ushort *)(iVar18 + 0x26) + (int)*(short *)(iVar18 + 0x28));
        uVar9 = FUN_2c62e4a8(*(undefined4 *)(pbVar14 + 0xc),*(undefined4 *)(iVar18 + 0x1c),
                             *(undefined4 *)(iVar18 + 0x20),(int)*(short *)(iVar18 + 0x28),
                             (uint)*(ushort *)(iVar18 + 0x26) + (int)*(short *)(iVar18 + 0x28));
        psStack_c8 = (short *)&uStack_150;
        sStack_b0 = *(short *)(pbVar14 + 0x1c) + sVar5;
        pbStack_a8 = pbVar14;
        FUN_2c602340(iVar12,0x1a,&sStack_ec);
        FUN_2c614f94(uVar13,&uStack_128,&uStack_150,sStack_b0,uVar8,uVar9);
        FUN_2c602340(iVar12,0x1b,&sStack_ec);
      }
    }
    iVar20 = (int)(short)((sStack_1c8 + 1) - sStack_1cc);
    iVar18 = (int)(short)((sStack_1c6 + 1) - sStack_1ca);
    if (iVar20 < 0) {
      iVar20 = iVar20 + 1;
    }
    if (iVar18 < 0) {
    ...
    FUN_2c600968(iVar12,0x60000,&bStack_1a4);
    bStack_199 = bStack_199 | 0x10;
    FUN_2c6129e4(&uStack_150);
    FUN_2c6007ec(iVar12,0x60000,&uStack_150);
    FUN_2c600b9c(&sStack_ec,uVar13);
    uStack_e8 = DAT_2c61a1b0;
    uStack_b8 = 0x60000;
    uStack_e4 = 3;
    pbStack_d4 = &bStack_1a4;
    pbVar14 = (byte *)FUN_2c62ca18(iVar12 + 0x24);
    if (pbVar14 != (byte *)0x0) {
      if (iVar20 < 0x82) {
        iVar20 = 0x82;
      }
      do {
        sVar4 = *(short *)(pbVar14 + 0x12);
        sStack_1be = sVar5 - *(short *)(pbVar14 + 6);
        sStack_1c2 = *(short *)(pbVar14 + 6) - sVar5;
        sVar11 = sVar5 - sVar4;
        ...
        uVar15 = FUN_2c613e5c(&sStack_168,0);
        uVar25 = (uint)*(ushort *)(pbVar14 + 0x10);
        if (uVar25 == 0) {
          uStack_1fc = 0xffff;
        }
        else {
        ...
        if (uVar19 != 0) {
          ...
          do {
            ...
            iVar18 = FUN_2c62e4a8(uStack_1f4,0,uVar19 - 1,*(undefined4 *)(pbVar14 + 0x1c),
                                  *(undefined4 *)(pbVar14 + 0x20));
            bVar6 = *pbVar14;
            bVar1 = pbVar14[1];
            bVar2 = pbVar14[2];
            bVar3 = pbVar14[3];
            sVar4 = *(short *)(pbVar14 + 8);
            while( true ) {
              ...
              for (; iVar21 != 0; iVar21 = FUN_2c62ca28(iVar27,iVar21)) {
                if (((*(char *)(iVar21 + 4) == '\x02') && (*(int *)(iVar21 + 8) <= iVar18)) &&
                   (iVar18 <= *(int *)(iVar21 + 0xc))) {
                  ...
                  if (*(int *)(iVar21 + 0x14) == *(int *)(iVar21 + 0x18)) {
                    ...
                    if ((*(byte *)(iVar21 + 0x1c) & 1) == 0) {
                      bVar7 = FUN_2c62e4a8(iVar18,*(undefined4 *)(pbVar14 + 0x1c),
                                           *(undefined4 *)(pbVar14 + 0x20),
                                           *(byte *)(iVar21 + 0x1c) & 1,0xff);
                    }
                    else {
                      bVar7 = FUN_2c62e4a8(iVar18,*(int *)(iVar21 + 8),*(int *)(iVar21 + 0xc),0,0xff
                                          );
                    }
                    uVar25 = (uint)bVar7;
                    iVar22 = 0xff - uVar25;
              ...
              iVar21 = *(short *)(pbVar14 + 0x28) * 10 +
                       (int)(uStack_1f4 * *(ushort *)(pbVar14 + 0x26) * 10) /
                       (int)(*(ushort *)(pbVar14 + 4) - 1);
              ...
              if (puStack_1f8 == (undefined4 *)0x0) {
                ...
                FUN_2c613ee4(uVar15);
                sStack_1d4 = (sVar11 - *(short *)(pbVar14 + 0x16)) + sStack_1dc;
                ...
                FUN_2c612a20(uVar13,puStack_d8,&sStack_1ac,puStack_c0,0);
                uVar15 = FUN_2c613e5c(&sStack_168,0);
                psVar16 = (short *)&uStack_180;
              }
              uStack_218 = uStack_218 + 1;
              uVar17 = FUN_2c613e5c(psVar16,0);
              FUN_2c6120f4(uVar13,&bStack_1a4,&sStack_1d8,&sStack_1dc);
              FUN_2c613ee4(uVar17);
              FUN_2c602340(iVar12,0x16,&sStack_ec);
              uVar19 = (uint)*(ushort *)(pbVar14 + 4);
              bStack_1a4 = bVar6;
              bStack_1a3 = bVar1;
              bStack_1a2 = bVar2;
              ...
              uStack_1fc = uStack_1fc + 1;
              if (uStack_1fc != *(ushort *)(pbVar14 + 0x10)) break;
LAB_2c61a258:
              uStack_1f4 = uStack_218 & 0xffff;
              uStack_1fc = 0;
              iVar18 = FUN_2c62e4a8(uStack_1f4,0,uVar19 - 1,*(undefined4 *)(pbVar14 + 0x1c),
...
LAB_2c61a2cc:
        ...
        FUN_2c613ee4(uVar15);
        pbVar14 = (byte *)FUN_2c62ca28(iVar12 + 0x24,pbVar14);
    ...
    FUN_2c600968(iVar12,0x50000,&uStack_150);
    FUN_2c614a0c(&uStack_128);
    FUN_2c6008ac(iVar12,0x50000,&uStack_128);
    bVar6 = FUN_2c6033b4(iVar12,0,0x60);
    FUN_2c600b9c(&sStack_ec,uVar13);
    psStack_c8 = psStack_1e8;
    uStack_e8 = DAT_2c61a5c8;
    pbVar14 = (byte *)FUN_2c62ca18(iVar27);
    iVar18 = DAT_2c61a5cc;
    for (; pbVar14 != (byte *)0x0; pbVar14 = (byte *)FUN_2c62ca28(iVar27,pbVar14)) {
      while( true ) {
        iVar20 = *(int *)pbVar14;
        pbStack_a8 = pbVar14;
        if (pbVar14[4] != 1) break;
        sVar10 = FUN_2c62e4a8(*(undefined4 *)(pbVar14 + 0xc),*(undefined4 *)(iVar20 + 0x1c),
                              *(undefined4 *)(iVar20 + 0x20),(int)*(short *)(iVar20 + 0x28),
                              (uint)*(ushort *)(iVar20 + 0x26) + (int)*(short *)(iVar20 + 0x28));
        sVar4 = *(short *)(iVar20 + 0x24);
        sVar11 = *(short *)(pbVar14 + 0x12);
        iVar20 = FUN_2c62e208((int)sVar10);
        iVar21 = (int)(short)(sVar11 + sVar5 + sVar4);
        iVar20 = iVar20 * iVar21;
        sStack_166 = ((short)((int)((ulonglong)((longlong)iVar18 * (longlong)iVar20) >> 0x20) +
                              iVar20 >> 0xe) - (short)(iVar20 >> 0x1f)) + sStack_196;
        iVar20 = FUN_2c62e208((int)(short)(sVar10 + 0x5a));
        iVar21 = iVar21 * iVar20;
        sStack_168 = ((short)((int)((ulonglong)((longlong)iVar18 * (longlong)iVar21) >> 0x20) +
                              iVar21 >> 0xe) - (short)(iVar21 >> 0x1f)) + sStack_198;
        uStack_150 = *(undefined4 *)(pbVar14 + 0x14);
        uStack_14c = *(undefined2 *)(pbVar14 + 0x10);
        bStack_146 = bVar6;
        if (pbVar14[5] < 0xfe) {
          bStack_146 = (byte)((uint)bVar6 * (uint)pbVar14[5] >> 8);
        }
        pbStack_d4 = (byte *)&uStack_150;
        psStack_c4 = &sStack_168;
        uStack_b4 = 1;
        FUN_2c602340(iVar12,0x1a,&sStack_ec);
        FUN_2c6120f4(uVar13,&uStack_150,psStack_1e8,&sStack_168);
        FUN_2c602340(iVar12,0x1b,&sStack_ec);
        pbVar14 = (byte *)FUN_2c62ca28(iVar27,pbVar14);
        if (pbVar14 == (byte *)0x0) goto LAB_2c61a518;
      }
      if ((pbVar14[4] == 0) && (*(int *)(pbVar14 + 0x10) != 0)) {
        iVar20 = FUN_2c62e4a8(*(undefined4 *)(pbVar14 + 0xc),*(undefined4 *)(iVar20 + 0x1c),
                              *(undefined4 *)(iVar20 + 0x20),(int)*(short *)(iVar20 + 0x28),
                              (uint)*(ushort *)(iVar20 + 0x26) + (int)*(short *)(iVar20 + 0x28));
        FUN_2c612838(*(undefined4 *)(pbVar14 + 0x10),&uStack_180);
        sStack_168 = sStack_198 - *(short *)(pbVar14 + 0x14);
        sStack_166 = sStack_196 - *(short *)(pbVar14 + 0x16);
        sStack_164 = sStack_168 + ((ushort)((uint)(uStack_180 << 0xb) >> 0x15) - 1);
        sStack_162 = sStack_166 + ((uStack_180._2_2_ >> 5) - 1);
        bStack_f7 = bVar6;
        if (pbVar14[5] < 0xfe) {
          bStack_f7 = (byte)((uint)bVar6 * (uint)pbVar14[5] >> 8);
        }
        uStack_124 = *(undefined4 *)(pbVar14 + 0x14);
        iVar20 = iVar20 * 10;
        if (0xe10 < iVar20) {
          iVar20 = iVar20 + -0xe10;
        }
        ...
        FUN_2c602340(iVar12,0x1a,&sStack_ec);
        FUN_2c614a3c(uVar13,&uStack_128,&sStack_168,*(undefined4 *)(pbVar14 + 0x10));
        FUN_2c602340(iVar12,0x1b,&sStack_ec);
      }
    }
LAB_2c61a518:
    ...
    FUN_2c6004cc(iVar12,0x20000,auStack_a4);
    sVar11 = FUN_2c6033b4(iVar12,0x20000,1);
    iVar18 = (int)sVar11;
    sVar11 = FUN_2c6033b4(iVar12,0x20000,4);
    uVar25 = (uint)sVar11;
    if (iVar18 < 0) {
      iVar18 = iVar18 + 1;
    }
