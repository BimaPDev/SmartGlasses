/* FUN_2c4bcfa0 @ 0x2c4bcfa0 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_2c4bcfa0(uint param_1,undefined2 param_2,undefined4 param_3,short param_4,short param_5,
...

{
  ...
  if (1 < param_1) {
    ...
    FUN_2c673ca8(_LAB_2c4bd01c,param_1);
  }
  if (*(char *)(_LAB_2c4bd018 + param_1 * 0x70) == '\0') {
    uVar8 = FUN_2c4bc030(param_1,param_3,param_4 + param_5,0,0,1,param_2,1,param_6,param_7);
    if (uVar8 < 2) {
