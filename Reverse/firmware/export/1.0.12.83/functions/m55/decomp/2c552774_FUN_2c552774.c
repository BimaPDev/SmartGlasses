/* FUN_2c552774 @ 0x2c552774 */

bool FUN_2c552774(int *param_1,int param_2,undefined4 param_3)

{
  ...
  local_24 = *DAT_2c5528ac;
  puVar7 = *(undefined1 **)(param_2 + 4);
  uVar5 = *(uint *)(param_2 + 8);
  local_54 = local_4c;
  if ((puVar7 + uVar5 != (undefined1 *)0x0) && (puVar7 == (undefined1 *)0x0)) goto LAB_2c552898;
  local_58 = uVar5;
  if (uVar5 < 0x10) {
    if (uVar5 == 1) {
      local_4c[0] = CONCAT31(local_4c[0]._1_3_,*puVar7);
    }
    else if (uVar5 != 0) goto LAB_2c55286e;
  }
  else {
