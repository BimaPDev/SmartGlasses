/* FUN_2c6616d4 @ 0x2c6616d4 */

undefined4 *
FUN_2c6616d4(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
  ...
  if (iVar2 != 0) {
    ...
    if (uVar8 == 1) {
      ...
      while( true ) {
        ...
        iVar2 = FUN_2c656c1a(piVar7,&param_5);
        if (iVar2 == 0) goto LAB_2c661812;
        local_38[1] = *(int *)(iVar10 + uVar11 * 4);
        iVar2 = FUN_2c656bd8(piVar7);
        if (local_38[1] != iVar2) goto LAB_2c661812;
        FUN_2c660394(piVar7);
      }
      if (uVar11 == uVar8) {
        *param_7 = iVar9;
