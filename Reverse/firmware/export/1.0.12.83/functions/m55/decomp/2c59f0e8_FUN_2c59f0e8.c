/* FUN_2c59f0e8 @ 0x2c59f0e8 */

int * FUN_2c59f0e8(int *param_1,int param_2,int param_3,undefined4 *param_4)

{
  ...
  if (param_3 == param_2 + 4) {
    ...
    if (uVar5 == 0) {
      if ((int)(uVar6 - uVar7) < 0) goto LAB_2c59f16c;
LAB_2c59f140:
      iVar1 = uVar7 - uVar6;
    }
    else {
...
LAB_2c59f1da:
  FUN_2c59f038(param_1,param_2,param_4);
LAB_2c59f14e:
  if (*DAT_2c59f234 == iVar4) {
    return param_1;
  }
