/* FUN_2c5cb3b0 @ 0x2c5cb3b0 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c5cb3b0(undefined4 param_1,char *param_2)

{
  ...
  if ((param_2 == (char *)0x0) || (*param_2 == '\0')) goto LAB_2c5cb3ca;
  uVar1 = FUN_2c5c685c();
  iVar2 = func_0x2c5c6e80(uVar1,param_2);
  if (iVar2 != 0) {
                    /* WARNING: Subroutine does not return */
    FUN_2c62c82c(4,_LAB_2c5cb4c0,0x273,_LAB_2c5cb4bc,_LAB_2c5cb4b8);
  }
  puStack_34 = auStack_2c;
  uStack_30 = FUN_2c66c4ec(param_2);
  uStack_40 = uStack_30;
  if (uStack_30 < 0x10) {
    puVar3 = auStack_2c;
    if (uStack_30 == 1) {
      auStack_2c[0] = CONCAT31(auStack_2c[0]._1_3_,*param_2);
    }
    ...
    puVar3 = puStack_34;
LAB_2c5cb47c:
    FUN_2c674668(puVar3,param_2,uStack_30);
    puVar3 = puStack_34;
    uStack_30 = uStack_40;
  }
  *(undefined1 *)((int)puVar3 + uStack_30) = 0;
  ...
  if (uStack_40 != uStack_3c) {
    ...
    do {
      ...
      iVar2 = iVar2 + 0x18;
      uVar5 = uStack_40;
    } while (uStack_3c != uVar4);
  }
  if (uVar5 != 0) {
                    /* WARNING: Subroutine does not return */
    FUN_2c472680(0,uVar5);
  }
