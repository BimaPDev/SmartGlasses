/* FUN_2c5a0654 @ 0x2c5a0654 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c5a0654(int param_1,undefined4 param_2,undefined4 *param_3)
...
LAB_2c5a06a6:
  ...
  *(undefined1 *)(uVar1 + 0x30) = 0;
  *(uint *)(uVar1 + 0x28) = uVar1 + 0x30;
  FUN_2c5a0504(&uStack_2c,param_1,param_2,uVar1 + 0x10);
  uVar4 = uStack_2c;
  if (iStack_28 == 0) {
    if (uVar1 + 0x30 != *(int *)(uVar1 + 0x28)) {
  ...
  if ((*_LAB_2c5a0798 ^ uStack_24) != 0) {
                    /* WARNING: Subroutine does not return */
    stack_chk_fail(uVar4,uVar3,*_LAB_2c5a0798 ^ uStack_24,0);
  }
  return;
}
