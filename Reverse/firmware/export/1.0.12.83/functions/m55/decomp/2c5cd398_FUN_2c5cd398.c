/* FUN_2c5cd398 @ 0x2c5cd398 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c5cd398(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)

{
  ...
  iVar4 = FUN_2c48e424(param_1,_LAB_2c5cd434);
  if (iVar4 == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_2c62c82c(3,_LAB_2c5cd450,0x3e4,_LAB_2c5cd44c);
  }
  if (param_4 == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_2c62c82c(3,_LAB_2c5cd450,0x3e9,_LAB_2c5cd44c);
  }
  FUN_2c48e424(iVar4,_LAB_2c5cd438);
  pcVar5 = (char *)FUN_2c48de10();
  if ((pcVar5 == (char *)0x0) || (*pcVar5 == '\0')) {
                    /* WARNING: Subroutine does not return */
    FUN_2c62c82c(3,_LAB_2c5cd450,0x3ee,_LAB_2c5cd44c);
  }
  iVar6 = FUN_2c66b624(pcVar5,_LAB_2c5cd43c);
  if (iVar6 != 0) {
    return;
  }
  FUN_2c48e424(iVar4,_LAB_2c5cd440);
  pcVar5 = (char *)FUN_2c48de10();
  FUN_2c48e424(iVar4,_LAB_2c5cd444);
  uVar7 = FUN_2c48de10();
  ...
  if (((pcVar5 == (char *)0x0) || (*pcVar5 == '\0')) ||
     (iVar4 = FUN_2c66b624(pcVar5,_LAB_2c5cd374), iVar4 != 0)) {
  ...
  FUN_2c5c55d8();
  uVar3 = FUN_2c5c5b3c();
  iVar4 = FUN_2c66b624(_LAB_2c5cd378,uVar3);
  if (iVar4 == 0) {
                    /* WARNING: Subroutine does not return */
  ...
  iVar4 = func_0x2c5d7060(&uStack_54,0x25);
  if (iVar4 == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_2c62c82c(4,_LAB_2c5cd384,0x416,_LAB_2c5cd388,_LAB_2c5cd38c);
  }
  uVar3 = FUN_2c66c4ec(&uStack_54);
  FUN_2c5ccb68(&puStack_b4,0,uStack_b0,&uStack_54,uVar3);
  uStack_b8 = 0;
  iVar4 = FUN_2c487c80(&uStack_b8);
  if (iVar4 == 0) {
                    /* WARNING: Subroutine does not return */
  ...
  if (puStack_6c == auStack_64) {
    ...
    *(undefined1 *)((int)puStack_9c + iVar6) = 0;
    iStack_98 = iVar6;
  }
  else {
    bVar8 = puStack_9c != auStack_94;
...
LAB_2c5cd20c:
  ...
  *(undefined1 *)puStack_6c = 0;
  ...
  FUN_2c5cbb5c(param_4,200,&puStack_b4,&puStack_9c,&puStack_84);
  puVar1 = puStack_b4;
  uVar3 = FUN_2c66c4ec(puStack_b4);
  func_0x2c5d70c8(puVar1,uVar3,_LAB_2c5cd37c,iVar4,uStack_b8,uVar7);
  func_0x2c487e98(iVar4);
