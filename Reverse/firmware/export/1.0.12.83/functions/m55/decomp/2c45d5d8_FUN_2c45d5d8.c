...
int FUN_2c45d5d8(int *param_1,int param_2,int param_3,int param_4)

{
  ...
  iVar6 = _LAB_2c45d808;
  coprocessor_moveto2(6,7,unaff_lr,param_2,in_cr8);
  if (in_CY && !in_ZR) {
    software_interrupt(0xea);
                    /* WARNING: Bad instruction - Truncating control flow here */
    halt_baddata();
  }
  *(int *)(unaff_r6 + 0x24) = unaff_r6;
  iVar8 = _LAB_2c45dd1c;
  ...
  if (!SCARRY4(unaff_r5,5)) {
    ...
    *(char *)(uVar9 + 0xc) = (char)iVar8;
    func_0x2b7a3754();
    iVar6 = func_0x2bc1d33e();
    auVar15._4_12_ = extraout_var;
    auVar15._0_4_ = extraout_s0;
    uVar4 = *(ushort *)(extraout_r3_00 + iVar8);
    VectorHalvingAdd(in_d17,auVar15._0_8_,1,1);
    *(char *)(extraout_r1 + iVar6) = (char)iVar6;
  ...
  *(char *)(unaff_r6 + 3) = (char)in_stack_000000c8;
  if (!SBORROW4(param_2,0xb8)) {
    ...
    iVar6 = (*UNRECOVERED_JUMPTABLE)(param_1,param_2);
    return iVar6;
  }
  ...
  *(int *)(in_stack_000000c8 + -0xaf) = param_4;
  ...
  coprocessor_moveto2(0xf,4,param_4,&iStack_10,in_cr9);
  iVar8 = *piVar11;
