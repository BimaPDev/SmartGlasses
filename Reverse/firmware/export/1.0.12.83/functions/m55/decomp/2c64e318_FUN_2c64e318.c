/* FUN_2c64e318 @ 0x2c64e318 */

void FUN_2c64e318(int param_1)

{
  ...
  if (*(int *)(param_1 + 8) == 0) {
    puVar2 = (undefined4 *)FUN_2c64ca5c(0x128);
    uVar1 = DAT_2c64e39c;
    puVar2[1] = 0;
    *puVar2 = uVar1;
  ...
  iVar6 = *(int *)(param_1 + 8);
  *(undefined4 *)(iVar6 + 8) = DAT_2c64e3a0;
  ...
  *(undefined4 *)(iVar6 + 0x14) = DAT_2c64e3ac;
  *(undefined4 *)(iVar6 + 0x18) = 4;
  *(undefined4 *)(iVar6 + 0x1c) = DAT_2c64e3b0;
