/* FUN_2c4e102c @ 0x2c4e102c */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_2c4e102c(int param_1,uint param_2,int *param_3)

{
  ...
  iVar2 = func_0x2c4df80c(param_1 + 0x15c);
  if (iVar2 != 0) {
    return iVar2;
  }
  iVar2 = func_0x2c4de348();
  if (iVar2 != 0) {
    return iVar2;
  }
...
LAB_2c4df4ae:
    ...
    if (param_2 != uVar4) {
      ...
      if (param_2 == _LAB_2c4de574) {
        iVar2 = *(int *)((int)piVar1 + iVar2 + 0x38);
LAB_2c4de56a:
        *param_3 = iVar2;
        return 1;
      }
      if (param_2 < _LAB_2c4de574) {
        if (param_2 == _LAB_2c4de578) {
          iVar2 = *(int *)((int)piVar1 + iVar2 + 0x3c);
          goto LAB_2c4de56a;
        }
      }
      else if ((param_2 == _LAB_2c4de57c) || (param_2 == _LAB_2c4de57c + 0x9005b34)) {
        iVar2 = func_0x2c4de9bc((int)piVar1 + iVar2 + 0x30);
        *param_3 = iVar2;
        return 1;
      }
      if (param_2 == _LAB_2c4de5c8) {
        iVar3 = *(int *)((int)piVar1 + iVar2 + 0xc);
        *param_3 = *(int *)((int)piVar1 + iVar2 + 8);
        param_3[1] = iVar3;
      }
      else {
