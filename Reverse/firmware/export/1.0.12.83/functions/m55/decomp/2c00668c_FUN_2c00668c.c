/* FUN_2c00668c @ 0x2c00668c */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c00668c(uint *param_1,undefined4 param_2,undefined4 param_3,byte param_4)

{
  ...
  do {
    *(byte *)(*(int *)(unaff_r8 + 0x18) + unaff_lr) =
         *(byte *)(*(int *)(unaff_r8 + 0x18) + unaff_lr) & 0xf | param_4 & 0xf0;
    uVar6 = unaff_r5;
    iVar1 = unaff_r11;
LAB_2c005ff4:
    while( true ) {
