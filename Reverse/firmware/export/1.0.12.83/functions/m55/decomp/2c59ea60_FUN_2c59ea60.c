/* FUN_2c59ea60 @ 0x2c59ea60 */

void FUN_2c59ea60(int param_1,undefined4 param_2,undefined4 *param_3)
...
LAB_2c59eab2:
  ...
  *(undefined4 *)(uVar1 + 0x28) = 0;
  FUN_2c59e910(&local_2c,param_1,param_2,uVar1 + 0x10);
  uVar4 = local_2c;
  if (iStack_28 == 0) {
  ...
  if ((*DAT_2c59eb88 ^ local_24) != 0) {
                    /* WARNING: Subroutine does not return */
    stack_chk_fail(uVar4,uVar3,*DAT_2c59eb88 ^ local_24,0);
  }
  return;
}
