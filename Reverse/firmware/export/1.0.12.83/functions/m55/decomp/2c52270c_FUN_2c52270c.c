/* FUN_2c52270c @ 0x2c52270c */

void FUN_2c52270c(int *param_1,int param_2,uint param_3,int *param_4,uint param_5)

{
  ...
  if ((param_4 < piVar6) || ((int *)(iVar1 + (int)piVar6) < param_4)) {
    ...
    if (param_5 == 0) goto LAB_2c522782;
    if (param_5 != 1) {
...
LAB_2c5227e8:
      if (iVar3 != 0) {
        if (param_3 == param_5) goto LAB_2c522782;
        goto LAB_2c5227f0;
      }
    }
    else {
      ...
      if ((param_3 == param_5) || (iVar3 == 0)) goto LAB_2c522782;
LAB_2c5227f0:
      if (iVar3 == 1) {
        puVar8[param_5] = puVar8[param_3];
      }
    ...
    if (param_5 <= param_3) goto LAB_2c522782;
