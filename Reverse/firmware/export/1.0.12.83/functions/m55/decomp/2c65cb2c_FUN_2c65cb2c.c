/* FUN_2c65cb2c @ 0x2c65cb2c */

undefined4 *
FUN_2c65cb2c(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_2c65cc84:
  ...
  if (uVar2 == 0) {
    ...
    uVar11 = uVar2;
    if (uVar9 == 0) {
      while (uVar2 = FUN_2c658fb4(uVar6,local_35), uVar2 != 0xffffffff) {
    ...
    while (uVar9 = uVar11, uVar11 = uVar10, uVar9 == 0) {
      while( true ) {
        ...
        if ((cVar13 == '\0') || (*(char *)(iVar1 + 0x25) != local_35)) {
          if (*(char *)(iVar1 + 0x24) == local_35) goto LAB_2c65cd28;
          iVar3 = FUN_2c650c06(iVar1 + 0x4e,uVar6,&local_35);
          if (iVar3 == 0) {
            cVar13 = '\0';
            goto LAB_2c65cd2c;
          }
          ...
          if (uVar12 == 0) goto LAB_2c65cd2c;
          uVar10 = uVar12 & 0xff;
          uVar12 = 0;
          FUN_2c651292(local_34,uVar10);
          uVar10 = uVar11;
        }
        FUN_2c658fa0(local_40);
        local_3c = 0xffffffff;
...
LAB_2c65cd2c:
  if (*(int *)(local_34[0] + -0xc) != 0) {
    FUN_2c651292(local_34,uVar12 & 0xff);
