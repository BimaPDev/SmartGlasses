/* FUN_2c5193ac @ 0x2c5193ac */

void FUN_2c5193ac(int param_1,undefined4 param_2)

{
  ...
  iStack_1c = *DAT_2c519540;
  FUN_2c607df0();
  iVar3 = FUN_2c614f58(param_2);
  if (iVar3 == 3) {
    if ((*(byte *)(param_1 + 0x2c) & 7) - 1 < 2) {
      FUN_2c62bea8(*(undefined4 *)(param_1 + 0x28));
    }
    *(undefined4 *)(param_1 + 0x28) = 0;
    *(byte *)(param_1 + 0x2c) = *(byte *)(param_1 + 0x2c) & 0xf8 | 3;
    goto LAB_2c51941e;
  }
  ...
  *(ushort *)(param_1 + 0x24) = uVar7;
  *(byte *)(param_1 + 0x2c) = (byte)iVar3 & 7 | (byte)((uStack_24 & 0x1f) << 3);
  FUN_2c607588(param_1);
  FUN_2c607df0(param_1);
LAB_2c51941e:
  if (*DAT_2c519540 == iStack_1c) {
    return;
  }
