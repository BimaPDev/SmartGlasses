/* FUN_2c010234 @ 0x2c010234 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c010234(uint param_1)

{
  ...
  if (param_1 < _DAT_2c01027c) {
    uVar6 = *_DAT_2c010280 & 0xfffffeff;
  }
  else {
    uVar6 = *_DAT_2c010280 | 0x100;
  }
  *_DAT_2c010280 = uVar6;
  if (iVar7 == 0) {
    *_DAT_2c010278 = 0xffffffff;
  }
  puVar4 = DAT_2c00fa3c;
  bVar2 = (bool)isCurrentModePrivileged();
  if (bVar2) {
