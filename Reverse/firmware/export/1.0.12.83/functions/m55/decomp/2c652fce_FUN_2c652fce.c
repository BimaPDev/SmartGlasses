/* FUN_2c652fce @ 0x2c652fce */

undefined4 *
FUN_2c652fce(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
  ...
  while (iVar6 = FUN_2c652d9a(&uStack_30,&param_5), iVar6 != 0) {
    ...
    while (uVar7 < uVar8) {
      if (uVar10 < puVar12[uVar7]) {
        if (*(char *)(*(int *)(iVar1 + puVar9[uVar7] * 4) + uVar10) == cVar4) goto LAB_2c6530ae;
        uVar8 = uVar8 - 1;
