/* FUN_2c013230 @ 0x2c013230 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c013230(int param_1)

{
  ...
  if (param_1 == 0) {
    uVar6 = *_DAT_2c013278 & 0xfffdffff;
  }
  else {
    uVar6 = *_DAT_2c013278 | 0x20000;
  }
  *_DAT_2c013278 = uVar6;
  if (iVar7 == 0) {
    *_DAT_2c013274 = 0xffffffff;
  }
  puVar4 = DAT_2c00fa3c;
  bVar2 = (bool)isCurrentModePrivileged();
  if (bVar2) {
