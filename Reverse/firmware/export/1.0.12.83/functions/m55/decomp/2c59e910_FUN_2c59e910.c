/* FUN_2c59e910 @ 0x2c59e910 */

int * FUN_2c59e910(int *param_1,int param_2,int param_3,undefined4 *param_4)

{
  ...
  if (param_3 == param_2 + 4) {
    ...
    if (uVar5 == 0) {
      if ((int)(uVar6 - uVar7) < 0) goto LAB_2c59e994;
LAB_2c59e968:
      iVar1 = uVar7 - uVar6;
    }
    else {
...
LAB_2c59ea02:
  FUN_2c59e860(param_1,param_2,param_4);
LAB_2c59e976:
  if (*DAT_2c59ea5c == iVar4) {
    return param_1;
  }
