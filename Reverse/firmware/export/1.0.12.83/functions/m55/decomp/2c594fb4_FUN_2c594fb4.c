/* FUN_2c594fb4 @ 0x2c594fb4 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_2c594fb4(int param_1)

{
  ...
  if (*(int *)(param_1 + 0x3c) == 0) {
    ...
    FUN_2c62c82c(4,_LAB_2c595018,0x42e);
  }
  iVar3 = FUN_2c5479e0(*(int *)(param_1 + 0x3c),*(undefined4 *)(*(int *)(param_1 + 0x40) + 4));
  if (((iVar3 == 0) &&
      (iVar3 = FUN_2c5479e0(*(undefined4 *)(param_1 + 0x3c),
                            *(undefined4 *)(*(int *)(param_1 + 0x40) + 0x28)), iVar3 == 0)) &&
     (iVar3 = FUN_2c5479e0(*(undefined4 *)(param_1 + 0x3c),
                           *(undefined4 *)(*(int *)(param_1 + 0x40) + 0x30)), iVar3 == 0)) {
    return;
  }
  iVar4 = *(int *)(param_1 + 0x3c);
  iVar5 = *(int *)(*(int *)(param_1 + 0x40) + 8);
