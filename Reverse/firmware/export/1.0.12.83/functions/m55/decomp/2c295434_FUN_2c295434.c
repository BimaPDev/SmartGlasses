/* FUN_2c295434 @ 0x2c295434 */

/* WARNING: Control flow encountered bad instruction data */

void FUN_2c295434(undefined4 param_1,int param_2)

{
  ...
  coprocessor_moveto(0xe,7,7,0,in_cr14,in_cr15);
  ...
  *(uint *)(param_2 + 0x22) = in_stack_00000048;
  *(undefined2 *)((in_stack_00000048 >> 0xc) + 0x3e) = unaff_r5;
  iVar2 = *(int *)(*(int *)(in_stack_00000048 * 0x80 + 0x14) + 4);
  uVar3 = *(undefined4 *)(iVar2 + 8);
  iVar4 = *(int *)(iVar2 + 0xc);
  if (SBORROW4(in_stack_00000048,0x50)) {
  ...
  *(short *)(*(int *)(iVar2 + 4) + 0x1e) = (short)*(int *)(iVar2 + 4);
  coprocessor_load(0,in_cr0,&stack0x00000008);
