/* FUN_140e0dc8 @ 0x140e0dc8 */

int FUN_140e0dc8(uint param_1,uint param_2,uint param_3,int *param_4,int *param_5)

{
  ...
  local_24 = param_4;
  piStack_20 = param_5;
  iVar1 = FUN_140e05e4(param_3,1);
  if (iVar1 == 0) {
    FUN_140da8c8(DAT_140e0e7c,0x30a,0,DAT_140e0e78);
  }
  ...
  if (uVar6 == 0) {
    *param_4 = uVar2 - 0x432;
    iVar3 = FUN_140e07cc(*(undefined4 *)(iVar1 + iVar4 * 4 + 0x10));
