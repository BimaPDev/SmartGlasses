/* FUN_140debc0 @ 0x140debc0 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_140debc0(int param_1,int param_2,int *param_3)

{
  ...
  if (*(int *)UNRECOVERED_JUMPTABLE - 0x31U < 9) {
    FUN_140df66c(UNRECOVERED_JUMPTABLE,local_4a8,10);
    UNRECOVERED_JUMPTABLE = local_4a8[0];
  }
  iVar6 = iRam00000074;
