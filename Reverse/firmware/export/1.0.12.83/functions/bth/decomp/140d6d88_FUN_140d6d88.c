/* FUN_140d6d88 @ 0x140d6d88 */

undefined4 *
FUN_140d6d88(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  iVar8 = FUN_140d3150(iVar8);
  local_3c = DAT_140d703c;
  uVar7 = 0;
  if ((*(int *)(iVar8 + 0x28) != 0) && (uVar7 = 0, *(int *)(iVar8 + 0x30) != 0)) {
    uVar7 = 1;
  }
  local_40 = DAT_140d703c;
...
LAB_140d6ea4:
        ...
        while (uVar5 = FUN_140c9da6(&local_48,&param_5), uVar5 != 0) {
          if (iVar13 == iVar4) goto LAB_140d6ee4;
          iVar3 = FUN_140c9d64(&local_48);
          if (*(int *)(*(int *)(iVar8 + 0x1c) + iVar13 * 4) != iVar3) goto LAB_140d6ed0;
          iVar13 = iVar13 + 1;
          FUN_140d32a8(&local_48);
        }
        if (iVar13 != iVar4) {
LAB_140d6ed0:
        ...
        if (local_38._3_1_ != '\x04') {
          if (uVar7 == 0) goto switchD_140d6e04_default;
          uVar5 = uVar7;
          if (local_38._3_1_ != '\x03') break;
        }
        goto LAB_140d6ea4;
      }
switchD_140d6e04_default:
      uVar5 = 1;
      break;
    case 3:
      ...
      while (uVar5 = FUN_140c9da6(&local_48,&param_5), uVar5 != 0) {
        ...
        if (iVar4 == 0) {
          if ((*(int *)(iVar8 + 0x14) == local_34[0]) && (uVar11 == 0)) {
            if (*(int *)(iVar8 + 0x34) < 1) goto LAB_140d7046;
            local_58 = uVar10;
            uVar11 = uVar5;
            uVar10 = 0;
          }
            ...
            if ((*(byte *)(iVar8 + 0x10) == 0) ||
               ((uVar5 = (uint)*(byte *)(iVar8 + 0x10), local_34[0] != *(int *)(iVar8 + 0x18) ||
                (uVar5 = uVar11, uVar11 != 0)))) goto LAB_140d7046;
            if (uVar10 == 0) {
              uVar5 = 0;
              goto LAB_140d7046;
            }
          ...
          FUN_140c4416(&local_3c,*(undefined1 *)(*DAT_140d7040 + (iVar4 - (iVar8 + 0x40) >> 2)));
          uVar10 = uVar10 + 1;
        }
        FUN_140d32a8(&local_48);
      }
...
LAB_140d7046:
      ...
      break;
    default:
      goto switchD_140d6e04_default;
    }
LAB_140d6ee4:
    iVar9 = iVar9 + 1;
    if (iVar9 == 4) {
      if (uVar12 < 2) {
        if (uVar5 != 0) goto LAB_140d70e2;
      }
      else if (uVar5 != 0) {
        if (local_60 == 0) {
...
LAB_140d6f06:
  iVar4 = FUN_140c9da6(&local_48,&param_5);
  if (iVar4 == 0) goto LAB_140d70dc;
  if (uVar12 == uVar7) goto LAB_140d70e2;
  iVar4 = FUN_140c9d64(&local_48);
  if (*(int *)(iVar9 + uVar7 * 4) != iVar4) goto LAB_140d6e18;
  uVar7 = uVar7 + 1;
  FUN_140d32a8(&local_48);
  goto LAB_140d6f06;
LAB_140d70dc:
