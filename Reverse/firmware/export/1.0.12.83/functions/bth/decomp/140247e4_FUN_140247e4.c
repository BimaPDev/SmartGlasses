/* FUN_140247e4 @ 0x140247e4 */

undefined4 FUN_140247e4(uint *param_1,byte *param_2,uint param_3,int param_4)

{
  ...
  uVar5 = uVar3 & 0xff;
  *param_2 = (byte)uVar3;
  func_0x13f4aa28(param_2 + 1,0,param_4);
  param_2[0x42] = 0;
  if (uVar5 == 1) {
    if (0 < (int)param_3) {
      uVar3 = 0;
