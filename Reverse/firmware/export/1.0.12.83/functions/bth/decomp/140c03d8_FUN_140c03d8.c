/* FUN_140c03d8 @ 0x140c03d8 */

void FUN_140c03d8(int param_1,undefined4 param_2,int param_3,undefined4 param_4)

{
  ...
  if (param_3 != 0) {
    ...
    if (*(int *)(param_1 + 8) - 1U < uVar1) {
      ...
      iVar2 = thunk_FUN_140bff34(iVar9);
      ...
      FUN_140e5658(iVar2 + uVar3 * 4,0,iVar6,uVar8,param_4);
      iVar6 = *(int *)(param_1 + 0xc);
      iVar9 = thunk_FUN_140bff34(iVar9);
      uVar3 = *(uint *)(param_1 + 8);
      for (uVar8 = 0; uVar3 != uVar8; uVar8 = uVar8 + 1) {
      ...
      FUN_140e5658(iVar9 + uVar3 * 4,0,iVar7,uVar8,param_4);
      *(int *)(param_1 + 0xc) = iVar9;
      *(int *)(param_1 + 4) = iVar2;
      *(uint *)(param_1 + 8) = uVar10;
      if (iVar11 != 0) {
        thunk_FUN_140db700(iVar11);
      }
      if (iVar6 != 0) {
        thunk_FUN_140db700(iVar6);
      }
    }
    iVar11 = *(int *)(param_1 + 4);
    ...
    if (*(int *)(iVar11 + uVar1 * 4) != 0) {
      while (*piVar4 != 0) {
        ...
        if (uVar1 == (uint)uVar12) {
          iVar2 = *(int *)(param_1 + 4);
          uVar12 = FUN_140c03c0(*(undefined4 *)(iVar9 + 4));
          iVar9 = (int)uVar12;
          if (*(int *)(iVar2 + iVar9 * 4) != 0) {
            iVar6 = FUN_140c8514(param_3,*(undefined4 *)((int)((ulonglong)uVar12 >> 0x20) + 4));
LAB_140c04b2:
            *(int *)(iVar6 + 4) = *(int *)(iVar6 + 4) + 1;
            FUN_140c028a(*(undefined4 *)(iVar2 + iVar9 * 4));
        ...
        if (uVar1 == (uint)uVar12) {
          iVar2 = *(int *)(param_1 + 4);
          uVar12 = FUN_140c03c0(*puVar5);
          iVar9 = (int)uVar12;
          if (*(int *)(iVar2 + iVar9 * 4) != 0) {
            iVar6 = FUN_140c3328(param_3,*(undefined4 *)((ulonglong)uVar12 >> 0x20));
            goto LAB_140c04b2;
          }
          break;
        }
      ...
      FUN_140c028a(*(undefined4 *)(iVar11 + uVar1 * 4));
    }
