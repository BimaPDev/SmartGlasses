/* FUN_140e16e4 @ 0x140e16e4 */

undefined4 FUN_140e16e4(undefined4 param_1,uint *param_2,int *param_3,undefined4 *param_4)

{
  ...
  iVar11 = 0;
  local_34[0] = *DAT_140e18c4;
  local_34[1] = DAT_140e18c4[1];
  local_34[2] = DAT_140e18c4[2];
  pcVar3 = DAT_140e18cc;
  if (param_2[6] != 3) {
    pcVar3 = DAT_140e18c8;
  }
  ...
  *param_2 = *param_2 | 0xd00;
  puVar10 = puVar8;
  do {
    iVar1 = FUN_140bd5f0(local_34[iVar11],*(undefined1 *)*param_3,2);
    if (iVar1 != 0) {
      if (iVar11 == 1) {
        if (param_2[1] == 0) {
          param_2[1] = 8;
...
LAB_140e176a:
        *param_2 = uVar4;
        ...
        if ((*param_2 & 0x600) != 0x200) goto LAB_140e179a;
        uVar4 = *param_2 | 0x100;
        param_2[1] = 0x10;
        goto LAB_140e176a;
      }
...
LAB_140e179a:
  ...
  iVar11 = 0;
  FUN_140e18f8(param_2[5],DAT_140e18d0 - param_2[1]);
  while( true ) {
    puVar7 = puVar10;
