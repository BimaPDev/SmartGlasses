/* FUN_140e3494 @ 0x140e3494 */

ulonglong FUN_140e3494(uint param_1,uint param_2,uint param_3,uint param_4)
...
LAB_140e36d4:
  ...
  if (0xfffff < uVar10) {
    ...
    if (0x1fffff < uVar10) {
      ...
      uVar9 = uVar8;
      if (0xffbfffff < uVar8 * 0x200000) goto LAB_140e36d4;
    }
LAB_140e35a0:
  ...
  uVar9 = uVar8 - 2;
  if (uVar8 - 1 != 0 && 0xfffff < uVar10) goto LAB_140e35a0;
  uVar5 = uVar12;
  uVar8 = uVar10;
  if (uVar10 == 0) {
    uVar5 = 0;
