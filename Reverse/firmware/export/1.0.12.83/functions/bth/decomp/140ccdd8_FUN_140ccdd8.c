/* FUN_140ccdd8 @ 0x140ccdd8 */

int FUN_140ccdd8(undefined1 *param_1,undefined4 param_2,uint param_3,uint param_4,int param_5,
...

{
  ...
  if (param_7 == '\0') {
    ...
    do {
      ...
      uVar1 = (uint)uVar5;
      FUN_140e414c(uVar1,uVar3,10,0);
      puVar4 = puVar4 + -1;
      *puVar4 = *(undefined1 *)(extraout_r2 + param_5 + 4);
      uVar5 = FUN_140e414c(uVar1,uVar3,10,0);
