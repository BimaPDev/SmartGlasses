/* FUN_14005e70 @ 0x14005e70 */

undefined4 FUN_14005e70(undefined1 param_1,uint param_2)

{
  ...
  iVar1 = DAT_14005e68;
  if ((*(char *)(DAT_14005e84 + 8) != '\x02') || (*(int *)(DAT_14005e84 + 0x24) == 0)) {
    return 0;
  }
  iVar6 = *(int *)(DAT_14005e68 + 0x14);
  FUN_14003be8(iVar6);
...
LAB_14005e04:
  ...
  *(int *)(iVar1 + 0x24) = iVar6;
  if (iVar6 != 0) {
    *(undefined4 *)(iVar6 + 0xc) = DAT_14005e6c;
  }
