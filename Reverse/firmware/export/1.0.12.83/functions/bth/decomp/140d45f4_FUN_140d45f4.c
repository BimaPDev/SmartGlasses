/* FUN_140d45f4 @ 0x140d45f4 */

undefined4 *
FUN_140d45f4(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
  ...
  if (iVar2 != 0) {
    ...
    if (uVar8 == 1) {
      ...
      while( true ) {
        ...
        iVar2 = FUN_140c9da6(piVar7,&param_5);
        if (iVar2 == 0) goto LAB_140d4732;
        local_38[1] = *(int *)(iVar10 + uVar11 * 4);
        iVar2 = FUN_140c9d64(piVar7);
        if (local_38[1] != iVar2) goto LAB_140d4732;
        FUN_140d32a8(piVar7);
      }
      if (uVar11 == uVar8) {
        *param_7 = iVar9;
