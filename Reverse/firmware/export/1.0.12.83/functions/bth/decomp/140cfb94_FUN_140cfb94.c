/* FUN_140cfb94 @ 0x140cfb94 */

undefined4 *
FUN_140cfb94(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
    ...
    while (uVar9 = uVar11, uVar11 = uVar10, uVar9 == 0) {
      while( true ) {
        ...
        if ((cVar13 == '\0') || (*(char *)(iVar1 + 0x25) != local_35)) {
          if (*(char *)(iVar1 + 0x24) == local_35) goto LAB_140cfd90;
