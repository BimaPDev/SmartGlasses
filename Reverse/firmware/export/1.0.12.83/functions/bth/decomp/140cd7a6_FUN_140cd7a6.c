/* FUN_140cd7a6 @ 0x140cd7a6 */

undefined4
FUN_140cd7a6(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_38 = param_3;
  uStack_34 = param_4;
  iVar3 = FUN_140cd4fc(auStack_30,param_5 + 0x6c);
  ...
  local_3c = local_68[0];
  local_2c[0] = FUN_140ccd76(auStack_44,param_7,local_40,uVar6);
  ...
  if (*(char *)(iVar3 + 0x10) != '\0') {
    ...
    *(undefined1 **)((int)local_68 + iVar2 + 4) = puVar5;
    FUN_140ccc6e(param_2,*(undefined4 *)(iVar3 + 8),*(undefined4 *)(iVar3 + 0xc),uVar1);
  }
  puVar4 = puVar5;
  ...
  if (local_2c[0] < iVar3) {
    ...
    *(undefined1 **)((int)piVar8 + iVar2) = puVar5;
    FUN_140ccd5a(param_2,param_6,iVar3,param_5);
  }
  *(undefined4 *)(param_5 + 8) = 0;
  *piVar9 = local_2c[0];
  FUN_140c5900(param_1,local_38,uStack_34,puVar5);
  return param_1;
}
