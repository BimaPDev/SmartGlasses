/* FUN_140db8a8 @ 0x140db8a8 */

uint FUN_140db8a8(undefined4 *param_1,uint param_2)

{
  ...
  puVar1 = (uint *)FUN_140db868(param_1,uVar7);
  if (puVar1 == (uint *)0xffffffff) {
    ...
    uVar5 = *puVar1;
    iVar2 = FUN_140dc29c(param_1,0);
    if ((int)puVar1 + uVar5 == iVar2) {
      uVar7 = ((uVar7 + 3) - *puVar1 & 0xfffffffc) + 8;
      if (uVar7 < 0xc) {
        uVar7 = 0xc;
      }
      iVar2 = FUN_140db868(param_1,uVar7);
      if (iVar2 != -1) {
        *puVar1 = *puVar1 + uVar7;
        goto LAB_140db948;
      }
