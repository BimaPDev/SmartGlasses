/* FUN_140e4250 @ 0x140e4250 */

/* WARNING: Removing unreachable block (ram,0x140e4444) */

undefined8 FUN_140e4250(uint param_1,uint param_2,uint param_3,uint param_4,uint *param_5)
  ...
  if (param_4 == 0) {
    if (param_2 < param_3) {
      ...
      if (param_3 == 0) {
        ...
        pcVar1 = (code *)software_udf(0xff,0x140e432a);
        (*pcVar1)();
      }
      iVar6 = LZCOUNT(param_3);
      if (iVar6 == 0) {
