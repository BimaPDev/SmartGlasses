/* FUN_140ae6f4 @ 0x140ae6f4 */

int FUN_140ae6f4(undefined4 param_1,int param_2)

{
  ...
  if (uVar2 != 0) {
    if (puVar4 + -1 == (uint *)0x0) goto LAB_140ae75e;
    uVar2 = *puVar4;
    if (-1 < (int)(uVar2 << 0x1f)) {
      return param_2;
    }
    ...
    FUN_140ae3b4(param_1,puVar4 + -1,iVar1,uVar2);
    if ((*(uint *)(param_2 + 4) & 0xfffffffc) == 0) {
                    /* WARNING: Subroutine does not return */
      FUN_1402b0f8(DAT_140ae77c,DAT_140ae780,0x2bd);
    }
...
LAB_140ae75e:
                    /* WARNING: Subroutine does not return */
  FUN_1402b0f8(DAT_140ae77c,DAT_140ae778,0x2d7);
}
