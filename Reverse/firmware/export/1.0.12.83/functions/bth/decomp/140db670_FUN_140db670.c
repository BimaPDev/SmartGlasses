/* FUN_140db670 @ 0x140db670 */

void FUN_140db670(int param_1,int *param_2)

{
  ...
  if (-1 < (int)((uint)*(ushort *)(param_2 + 3) << 0x1e)) {
    local_18 = param_1;
    local_14 = param_2;
    uVar1 = FUN_140db626(param_1,param_2,&local_18,&local_14);
    iVar2 = FUN_140db8a8(param_1,local_18);
    if (iVar2 != 0) {
      *(undefined4 *)(param_1 + 0x28) = DAT_140db6ec;
      *param_2 = iVar2;
      param_2[4] = iVar2;
      *(ushort *)(param_2 + 3) = *(ushort *)(param_2 + 3) | 0x80;
      param_2[5] = local_18;
      if ((local_14 != (int *)0x0) &&
         (iVar2 = FUN_140e04e4(param_1,(int)*(short *)((int)param_2 + 0xe)), iVar2 != 0)) {
