/* FUN_140ae5b4 @ 0x140ae5b4 */

uint FUN_140ae5b4(int param_1,uint param_2)

{
  ...
  if (iVar1 + 0xcU != (iVar1 + 0xfU & 0xfffffffc)) {
    ...
    FUN_1402b0f8(DAT_140ae654,DAT_140ae650,0x2ad);
  }
    ...
    if (0xb < (uVar4 & 0xfffffffc)) {
      *(uint *)(param_1 + 4) = param_2 | *(uint *)(param_1 + 4) & 3;
      ...
      FUN_140ae4dc();
                    ...
                    /* WARNING: Subroutine does not return */
    FUN_1402b0f8(DAT_140ae654,DAT_140ae650,0x2b2);
  }
                    /* WARNING: Subroutine does not return */
  FUN_1402b0f8(DAT_140ae654,DAT_140ae650,0x2b0);
}
