/* FUN_140cd6aa @ 0x140cd6aa */

undefined4 *
FUN_140cd6aa(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if ((local_44 & 1) == 0) {
    ...
    FUN_140cd544(&local_30,param_2,param_3,param_4);
    goto LAB_140cd6e4;
  }
  local_48 = local_58[1];
  iVar5 = FUN_140cd4fc(auStack_34,param_5 + 0x6c);
  if (param_7 == 0) {
