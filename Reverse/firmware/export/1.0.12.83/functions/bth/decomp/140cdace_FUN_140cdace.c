/* FUN_140cdace @ 0x140cdace */

undefined4
FUN_140cdace(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  local_38 = param_3;
  uStack_34 = param_4;
  uVar10 = FUN_140cd4fc(auStack_30,param_5 + 0x6c);
  iVar5 = (int)uVar10;
  ...
  local_40 = local_80[0];
  local_3c = local_80[2];
  local_2c[0] = FUN_140ccdd8(&local_48,(int)((ulonglong)uVar10 >> 0x20),local_44,local_48);
  ...
  if (*(char *)(iVar5 + 0x10) != '\0') {
    ...
    *(undefined1 **)((int)local_80 + iVar2 + 4) = puVar4;
    FUN_140ccc6e(param_2,*(undefined4 *)(iVar5 + 8),*(undefined4 *)(iVar5 + 0xc),uVar1);
  }
  puVar3 = puVar4;
  ...
  *piVar9 = local_2c[0];
  FUN_140c5900(param_1,local_38,uStack_34,puVar4);
  return param_1;
}
