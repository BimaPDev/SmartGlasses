/* FUN_10088288 @ 0x10088288 */

int FUN_10088288(int param_1,int param_2,int param_3,int param_4)
    ...
    for (iVar9 = 0; iVar9 != iVar5; iVar9 = iVar9 + 1) {
      ...
      if ((iVar6 == 0) && (iVar6 = FUN_10124cb8(iVar10,0x1000), iVar6 != 0)) {
        if (iVar2 == 2) {
          ...
          iVar6 = *(int *)(param_1 + 0x1c) - iVar4;
        }
        else if (iVar2 == 3) {
          iVar10 = *(int *)(iVar10 + 0x14) +
                   ((*(int *)(iVar10 + 0x1c) + 1) - *(int *)(iVar10 + 0x14)) / 2;
          iVar6 = *(int *)(param_1 + 0x14) + iVar3 +
                  ((*(int *)(param_1 + 0x1c) + (1 - (iVar4 + iVar3))) - *(int *)(param_1 + 0x14)) /
                  2;
        }
        else {
          if (iVar2 != 1) goto LAB_10088348;
          iVar10 = *(int *)(iVar10 + 0x14);
          iVar6 = *(int *)(param_1 + 0x14) + iVar3;
        }
