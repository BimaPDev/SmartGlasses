/* FUN_100c4f64 @ 0x100c4f64 */

int FUN_100c4f64(uint param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                undefined4 param_5)

{
  ...
  if (param_1 < 0x10) {
    ...
    iVar3 = FUN_100c19e4(DAT_100c4fb0,param_5);
    if (iVar3 != 0) {
  ...
  iVar3 = FUN_100c4e24(1,param_4,param_3,param_4);
  return iVar3;
}
