/* FUN_10003798 @ 0x10003798 */

ulonglong FUN_10003798(uint param_1,uint param_2,uint param_3,uint param_4)
...
LAB_100039dc:
  ...
  if (0xfffff < uVar11) {
    ...
    if (0x1fffff < uVar11) {
      ...
      uVar10 = uVar9;
      if (0xffbfffff < uVar9 * 0x200000) goto LAB_100039dc;
    }
LAB_100038a8:
  ...
  uVar10 = uVar9 - 2;
  if (uVar9 - 1 != 0 && 0xfffff < uVar11) goto LAB_100038a8;
  uVar6 = uVar5;
  uVar9 = uVar11;
  if (uVar11 == 0) {
    uVar6 = 0;
