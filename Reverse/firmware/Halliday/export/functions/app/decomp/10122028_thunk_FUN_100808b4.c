/* thunk_FUN_100808b4 @ 0x10122028 */

undefined4 thunk_FUN_100808b4(int *param_1)
    ...
    if (*(ushort *)(*piVar29 + 0xe) < 0x201) {
      ...
      do {
        ...
        *(char *)piVar10 = (char)iVar15;
        FUN_10121e98(param_1,*DAT_10080bfc,iVar15,0,0xf,0,&uStack_4c);
        if ((char)uStack_4c == -1) {
          if (uStack_46 == 0x80bb) {
            piVar29[0x7ad] = iVar15;
          }
          else if (uStack_46 == 0x80ee) {
...
LAB_100809a6:
    ...
    if (*(ushort *)(*piVar29 + 0xe) < 0x201) {
      ...
      iVar32 = 0;
      do {
        iVar42 = (int)(&uStack_3c)[iVar32] / (int)(uint)*(ushort *)(*piVar29 + 0xe);
        FUN_10121e98(param_1,*DAT_10080bfc,iVar42,0,0xf,0,acStack_5c);
        if (acStack_5c[0] == -1) {
          if (sStack_56 == -0x7f45) {
      ...
      *pbVar33 = (byte)uVar9;
      if (((undefined1 *)(iVar23 + 0x30))[uVar9 * 0x1c] != '\0') {
        ...
        for (uVar31 = (uint)*(byte *)(iVar15 + 0x10d2); uVar31 < *(ushort *)(iVar15 + 0x10d8);
          ...
          if ((((iVar42 == 0) &&
               (iVar32 = FUN_10121e98(param_1,*pbVar33,uVar31,0,0xf,0,&uStack_4c),
               (char)uStack_4c == -1)) && (uVar43 = (uint)uStack_46, uVar43 != 0x80dd)) &&
             ((uVar43 != 0x80bb && (uVar43 != 0x80ee)))) {
            pcStack_88 = (char *)((int)pcStack_88 + 1);
            if (0x28 < pcStack_88) break;
            if (((uStack_46 & 0x8000) != 0) && ((uVar43 & 0x3ff) == 0xaa)) {
              uVar17 = (uint)*pbVar33;
              ...
              if (uVar43 < *(byte *)(uVar17 * 0x1c + iVar15 + 0x30)) {
                ...
                if (*(short *)(iVar42 + 100) == -1) {
                  ...
                  do {
                    iVar1 = iVar8 + iVar6 >> 1;
                    FUN_10121e98(param_1,uVar17,uVar31,iVar1 << 2,0xf,iVar34 + 0xc6,&uStack_3c);
                    if (uStack_3c._3_1_ == -1) {
                      iVar6 = iVar1 + -1;
                    }
                    else {
                      iVar8 = iVar1 + 1;
                  ...
                  *(ushort *)(iVar32 + 6) =
                  ...
                  iVar32 = FUN_10121e98(param_1,*pbVar33,uVar31,iVar42 + 2,0xf,0,&uStack_4c);
                  bVar20 = *pbVar33;
                  if (iVar32 == 0x3000) {
LAB_1008106a:
                    FUN_10121fb8(param_1,bVar20,uVar31);
                  }
                  else if (uStack_4c._3_1_ == -1) {
                    iVar6 = iVar15 + 0xc6;
...
LAB_10080c8a:
          ...
          for (; (int)uVar31 < (int)(uint)*(ushort *)(piVar29 + 0x436); uVar31 = uVar31 + 1) {
            ...
            if (iVar15 == 0) {
              ...
              FUN_10121e98(param_1,*DAT_10081290,uVar31,0,iVar15,0,&uStack_3c);
              if ((char)uStack_3c == -1) {
                ...
                *(short *)(pbVar25 + 2) = *(short *)(pbVar25 + 2) + 1;
                ...
                if (uVar43 == 0xffff) {
                  if (*(int *)(*param_1 + 0x2d) != 0) {
                    FUN_10120a74(param_1,&uStack_3c,*pbVar25,uVar31,0);
                    iVar42 = (**(code **)(*param_1 + 0x2d))(param_1,&uStack_3c);
                  ...
                  if ((int)(uVar43 << 0x10) < 0) {
                    if (uVar17 == 0xaa) {
                      if (uStack_70 < 0x28) goto LAB_10081272;
                      if ((*(char *)(*param_1 + 0x10) != '\0') &&
                         (pcVar24 = *(code **)(*param_1 + 0xc), pcVar24 != (code *)0x0)) {
                    ...
                    if ((uVar43 < *(byte *)(iVar42 + 0x30)) && (uVar17 < *(uint *)(iVar42 + 0x34)))
                    {
                      ...
                      if ((uVar30 & 0xc) == 0) {
                        ...
                        pcStack_88 = (char *)(uVar30 & 0xfff);
                        FUN_10121e98(param_1,(uint)*pbVar25,pcStack_88,uVar26,0xf,uVar26,&uStack_3c)
                        ;
                        pbVar33 = DAT_1008163c;
                        bVar20 = uStack_3c._2_1_;
                        uVar41 = (uint)uStack_3c._2_1_;
                        FUN_10121e98(param_1,*DAT_1008163c,uVar31,uVar26,0xf,uVar26,&uStack_3c);
                        uVar12 = (uint)*pbVar33;
                        iVar34 = param_1[3];
                        uVar44 = (uint)uStack_3c._2_1_;
...
LAB_1008145e:
                        pcVar19 = pcStack_88;
                        if (uVar44 == uVar41) {
                          iVar6 = FUN_10121f80(param_1,uVar12,uVar31,pcStack_88);
                          pcVar19 = (char *)uVar31;
                          if (iVar6 != 0) {
                            *(ushort *)(DAT_1008163c + iVar42 * 2) =
                        ...
                        else if (((int)(char)uStack_3c._2_1_ - (int)(char)bVar20) * 0x1000000 < 0) {
                          *(ushort *)(DAT_1008163c + iVar42 * 2) =
                               *(ushort *)(DAT_1008163c + iVar42 * 2) & 0xf000 |
                               (ushort)uVar31 & 0xfff;
                          uVar44 = uVar41;
                          if ((int)(char)bVar20 == (int)(char)(uStack_3c._2_1_ + 1)) {
LAB_1008156a:
                            pcVar19 = pcStack_88;
                            if (uVar26 == 0xffffffff) {
                                    ...
                                    if ((*(ushort *)(pbVar25 + iVar42 * 8 + 8) & 0xfff) == 0xfff) {
                                      ...
                                      *(ushort *)(pbVar25 + iVar42 * 8 + 8) =
                                           *(ushort *)(pbVar25 + iVar42 * 8 + 8) & 0x1000 |
                                           (ushort)((uint)((int)pcStack_88 << 0x14) >> 0x14);
                              ...
                              uVar41 = *(ushort *)
                                       ...
                                       0xfff;
                              FUN_10121e98(param_1,uVar12,uVar41,0,0xf,0,&uStack_3c);
                              uVar17 = uStack_3c >> 0x10;
                              iVar42 = FUN_10121f80(param_1,*pbVar25,uVar41,pcStack_88);
                          ...
                          pcStack_88 = (char *)uVar31;
                          if ((int)(char)uStack_3c._2_1_ == (int)(char)(bVar20 + 1))
                          goto LAB_1008156a;
                          pcVar19 = (char *)uVar31;
...
LAB_10081826:
          ...
          while( true ) {
            ...
            if (*pcVar38 == '\0') {
              iVar42 = *(int *)(iVar42 + 0x34) - (int)(short)puStack_84[-4];
              ...
              for (iVar42 = 0; iVar42 < *(int *)((uint)*pbVar25 * 0x1c + iVar15 + 0x34);
                ...
                if ((*puVar13 & 0xfff) == 0xfff) {
                  ...
                  *puVar13 = (ushort)((uint)(iVar6 << 0x14) >> 0x14) | *puVar13 & 0x1000;
                  puStack_84[-4] = puStack_84[-4] + 1;
                }
                puVar13 = puVar13 + 1;
              }
            }
            iVar32 = iVar32 + 1;
            puStack_84 = puStack_84 + 0x424;
            pcVar38 = pcVar38 + 1;
          }
          ...
          if (bVar2) {
            iVar32 = 0;
            piVar29 = (int *)param_1[3];
            pcStack_88 = DAT_10081c54;
            puStack_84 = (ushort *)DAT_10081c54;
            while( true ) {
              iVar15 = 1;
              ...
              if (*pcStack_80 == '\0') {
                ...
                FUN_1011ea48(puVar39,0x42,
                             ...
                             0x200);
                FUN_1011ea40(puVar39,(undefined1 *)((int)puStack_84 + 0x2016),0x7fe);
                uVar5 = FUN_10120ab0(puVar39,0x3ff);
                *(undefined2 *)(piVar29 + 0x231) = uVar5;
                FUN_1011ea48(&uStack_3c,0xff,0x10);
                uStack_3c = CONCAT13(0x55,(undefined3)uStack_3c);
                if (uVar30 == 0) {
                ...
                iVar15 = FUN_10121fd8(param_1,*pbVar25,uVar21,uVar30,iVar15,puVar39,&uStack_3c);
                if (iVar15 != 1) {
                  if ((*(char *)(*param_1 + 0x10) != '\0') &&
                     (pcVar24 = *(code **)(*param_1 + 0xc), pcVar24 != (code *)0x0)) {
                ...
                puVar18 = puVar39;
                puVar27 = (undefined4 *)((int)puStack_84 + 0x2816);
                do {
                  puVar28 = puVar27 + 1;
                  *puVar18 = *puVar27;
                  puVar18 = puVar18 + 1;
                  puVar27 = puVar28;
                } while (puVar28 != (undefined4 *)((int)puStack_84 + 0x2856));
                uVar5 = FUN_10120ab0(puVar39,0x20);
                *(undefined2 *)(piVar29 + 0x231) = uVar5;
                uVar16 = FUN_1011ea48(&uStack_3c,0xff,0x10);
                uStack_3c = CONCAT13(0x55,(undefined3)uStack_3c);
                uVar31 = (uint)*(byte *)(*piVar29 + 10) * (uint)*(byte *)(*piVar29 + 0xb);
                if (uVar31 == 0x20) {
                  iVar15 = -1;
              ...
              iVar32 = iVar32 + 1;
              puStack_84 = (ushort *)((int)puStack_84 + 0x848);
