/* FUN_1007ce0c @ 0x1007ce0c */

void FUN_1007ce0c(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar3 = DAT_1007ce64;
  iVar2 = DAT_1007ccf8;
  if (*(char *)(DAT_1007ce64 + 0x13f) == '\x01') {
    uVar6 = (DAT_1007ce6c - DAT_1007ce68) * 0x20 & 0xff00;
    if (*(char *)(DAT_1007ce64 + 0x1c) == '\x01') {
      FUN_100a5b78(DAT_1007ce70 | uVar6,PTR_s_bat_charge_state_low_1007ce78,
                   PTR_s_start_precharge_1007ce74);
      FUN_1007cb20(*(undefined1 *)(iVar3 + 0x144));
      uVar5 = 2;
    }
    else {
      FUN_100a5b78(uVar6 | 0x1120031,PTR_s_bat_charge_state_low_1007ce78,
                   PTR_s_change_to_normal_1007ce7c);
      uVar5 = 3;
    }
    *(undefined1 *)(iVar3 + 0x141) = uVar5;
    return;
  }
