/* FUN_100d88cc @ 0x100d88cc */

void FUN_100d88cc(void)

{
  ...
  iVar8 = FUN_100d5e14();
  pbVar15 = (byte *)*piVar4;
  local_34 = *(undefined4 *)(pbVar15 + 2);
  local_30 = *(uint *)(pbVar15 + 6);
  local_2c = *(short *)(pbVar15 + 10);
  if ((((((*pbVar15 & 0x41) == 0x41) && ((*(byte *)(*piVar5 + 0x30) & 0xf) != uVar7)) &&
    ...
    if ((uVar7 == 0) && (iVar11 = *piVar4, (int)((uint)*(byte *)(iVar11 + 0xc) << 0x1e) < 0)) {
      local_34 = CONCAT22(*(undefined2 *)(iVar11 + 0xe),(undefined2)local_34);
      local_30._2_2_ = (short)(local_30 >> 0x10);
      local_30 = CONCAT22(local_30._2_2_,*(undefined2 *)(iVar11 + 0x10));
    }
    uVar12 = 1;
  }
  else {
...
LAB_100d8944:
      local_30 = CONCAT22(*(undefined2 *)(pbVar15 + 0x12),(undefined2)local_30);
      local_2c = *(short *)(pbVar15 + 0x14);
    }
    cVar14 = '\x01';
    uVar7 = uVar12 | 2;
  }
...
LAB_100d8a08:
  ...
  if (*(short *)(pbVar15 + 0x18) == local_34._2_2_) {
    bVar2 = false;
    if ((local_30 & 0xffff) != (uint)*(ushort *)(pbVar15 + 0x1a)) {
      bVar2 = true;
    }
  }
  else {
  ...
  if (*(short *)(pbVar15 + 0x1c) == local_30._2_2_) {
    bVar3 = false;
    if (local_2c != *(short *)(pbVar15 + 0x1e)) {
      bVar3 = true;
    }
  }
  else {
...
LAB_100d8a4a:
  ...
  if (bVar2) {
    ...
    FUN_100a5b78((DAT_100d8bc0 - DAT_100d8bbc) * 0x20 & 0xff00U | 0x8e0032,DAT_100d8bc8,DAT_100d8bd0
                 ,local_34._2_2_,uVar10);
    FUN_10131b64(local_34._2_2_,uVar10);
    if ((*(short *)(*piVar4 + 4) == local_34._2_2_) && (*(ushort *)(*piVar4 + 6) == uVar10)) {
      uVar9 = 0;
    }
    else {
      uVar9 = 1;
...
LAB_100d8ae2:
    FUN_100a5b78((DAT_100d8bc0 - DAT_100d8bbc) * 0x20 & 0xff00U | 0x990032,DAT_100d8bc8,DAT_100d8bd4
                 ,local_30._2_2_,local_2c);
    FUN_10131acc(local_30._2_2_,local_2c);
    if ((*(short *)(*piVar4 + 8) == local_30._2_2_) && (*(short *)(*piVar4 + 10) == local_2c)) {
      uVar9 = 0;
    }
    else {
      uVar9 = 1;
  ...
  iVar6 = *piVar4;
  *(undefined4 *)(iVar6 + 0x16) = local_34;
  *(uint *)(iVar6 + 0x1a) = local_30;
  *(short *)(iVar6 + 0x1e) = local_2c;
LAB_100d8b3e:
  if (bVar16) {
    uVar10 = (DAT_100d8bc0 - DAT_100d8bbc) * 0x20 & 0xff00;
