/* FUN_101197d0 @ 0x101197d0 */

void FUN_101197d0(undefined4 param_1,int param_2,int param_3,undefined4 param_4)

{
  ...
  iVar2 = FUN_1013d7a2(param_2,param_3,param_3,param_4,param_4);
  bVar16 = -1 < iVar2;
  if (iVar2 == 0) {
    iVar2 = FUN_10119374(param_1,0);
    if (iVar2 != 0) {
    ...
    iVar3 = FUN_10119374(param_1,*(undefined4 *)(iVar6 + 4));
    if (iVar3 != 0) {
      ...
      *(int *)(iVar3 + 0xc) = iVar2;
      ...
      do {
        puVar7 = puVar7 + 1;
        puVar14 = puVar12 + 1;
        uVar5 = ((*puVar7 & 0xffff) + iVar2) - (*puVar12 & 0xffff);
  ...
  FUN_10117c88(DAT_101198ec,uVar4,0,DAT_101198e8);
}
