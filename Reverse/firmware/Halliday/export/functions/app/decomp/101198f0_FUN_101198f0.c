/* FUN_101198f0 @ 0x101198f0 */

int FUN_101198f0(uint param_1,uint param_2,uint param_3,int *param_4,int *param_5)

{
  ...
  if (iVar1 != 0) {
    ...
    if (uVar6 == 0) {
      *param_4 = uVar2 - 0x432;
      iVar3 = FUN_1013d702(*(undefined4 *)(iVar1 + iVar4 * 4 + 0x10));
  ...
  FUN_10117c88(DAT_101199a4,0x30a,0,DAT_101199a0);
}
