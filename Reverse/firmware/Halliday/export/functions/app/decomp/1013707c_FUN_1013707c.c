/* FUN_1013707c @ 0x1013707c */

undefined4 FUN_1013707c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((((iVar2 != 0) && (*(char *)(iVar2 + 0x60) < '\0')) && (*(char *)(iVar2 + 200) < '\0')) &&
    ...
    if ((iVar2 == 0) || (-1 < *(char *)(iVar2 + 0x60))) {
      ...
      iVar3 = FUN_100de004(0,9,0,iVar2 + 0xe8,iVar2);
      if (iVar3 == 0) {
        uVar1 = 0xfffffff4;
      }
      else {
