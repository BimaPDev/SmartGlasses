/* FUN_1012c3b6 @ 0x1012c3b6 */

void FUN_1012c3b6(int param_1,int param_2,undefined4 param_3)

{
  ...
  iVar2 = iVar1 + local_14 + 1 + *(int *)(iVar2 + 8);
  local_18 = *(int *)(param_1 + 0x48);
  local_14 = iVar2;
  iVar1 = FUN_10125790(*(undefined4 *)(param_1 + 0x2c));
  if (iVar2 < iVar1) {
