/* FUN_1013755e @ 0x1013755e */

undefined4 FUN_1013755e(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  *(byte *)(param_1 + 0x13c) = bVar1 & 0xf | (byte)((uStack_10 & 0xf) << 4);
  ...
  if ((param_1 == 0) || (-1 < *(char *)(param_1 + 0x60))) {
    ...
    iVar3 = FUN_100de004(0,0xc,0,param_1 + 0xe8,param_1);
    if (iVar3 == 0) {
      uVar2 = 0xfffffff4;
    }
    else {
