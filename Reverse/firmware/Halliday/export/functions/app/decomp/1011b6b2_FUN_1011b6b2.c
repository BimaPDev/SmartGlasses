/* FUN_1011b6b2 @ 0x1011b6b2 */

uint FUN_1011b6b2(void)

{
  ...
  piVar1 = DAT_1005c0ac;
  *DAT_1005c0ac = 0;
  puVar5 = local_1c + (iVar3 + 0x7ffffff) * 8;
  do {
    if (puVar5 < local_1c) {
      return 0;
    }
