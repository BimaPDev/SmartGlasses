...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m2403deprecated_getByte(long index) {
        return getByte(index);
    }

    /* JADX INFO: compiled from: Buffer.kt */
    @Metadata(m490d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\u000e\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0017\u001a\u00020\bJ\u0006\u0010\u0018\u001a\u00020\bJ\u000e\u0010\u0019\u001a\u00020\n2\u0006\u0010\u001a\u001a\u00020\nJ\u000e\u0010\u001b\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u001c\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0080\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u0012\u0010\u0013\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u001c"}, m491d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", "end", "", TypedValues.CycleType.S_WAVE_OFFSET, "", "readWrite", "", "segment", "Lokio/Segment;", "getSegment$okio", "()Lokio/Segment;", "setSegment$okio", "(Lokio/Segment;)V", "start", "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "okio"}, m492k = 1, m493mv = {1, 5, 1}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        return ((55296 > i || i > 57343) && i >= i3) ? i : Utf8.REPLACEMENT_CODE_POINT;
    }
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        if (size() - fromIndex < fromIndex) {
            ...
            while (size < j) {
                byte[] bArr = segment.data;
                int iMin = (int) Math.min(segment.limit, (((long) segment.pos) + j) - size);
        ...
        while (size < j) {
            ...
            int iMin2 = (int) Math.min(segment.limit, (((long) segment.pos) + j) - size);
            i = (int) ((((long) segment.pos) + fromIndex) - size);
            while (i < iMin2) {
                if (bArr2[i] != b) {
                    i++;
    ...
    public long indexOf(ByteString bytes, long fromIndex) throws IOException {
        ...
        if (segment == null) {
            ...
            if (segment != null) {
                ...
                while (j2 < size3) {
                    byte[] bArr = segment.data;
                    int iMin = (int) Math.min(segment.limit, (((long) segment.pos) + size3) - j2);
                    int i = (int) ((((long) segment.pos) + j3) - j2);
                    if (i < iMin) {
                        while (true) {
                            int i2 = i + 1;
                            if (bArr[i] == b && _BufferKt.rangeEquals(segment, i2, bArrInternalArray$okio, 1, size2)) {
            ...
            while (true) {
                long j4 = ((long) (segment.limit - segment.pos)) + j;
                if (j4 > fromIndex) {
                    break;
                }
                segment = segment.next;
            ...
            if (segment != null) {
                ...
                while (j5 < size5) {
                    ...
                    int i3 = (int) ((((long) segment.pos) + j6) - j5);
                    if (i3 < iMin2) {
                        while (true) {
                            int i4 = i3 + 1;
                            if (bArr2[i3] == b2 && _BufferKt.rangeEquals(segment, i4, bArrInternalArray$okio2, 1, size4)) {
                                return ((long) (i3 - segment.pos)) + j5;
                            }
                            if (i4 >= iMin2) {
                                break;
                            }
    ...
    public boolean rangeEquals(long offset, ByteString bytes, int bytesOffset, int byteCount) {
        ...
        if (byteCount > 0) {
            ...
            while (true) {
                int i2 = i + 1;
                if (getByte(((long) i) + offset) != bytes.getByte(i + bytesOffset)) {
                    return false;
                }
                if (i2 >= byteCount) {
                    break;
