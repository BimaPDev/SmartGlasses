...
public final class ResourceFileSystem extends FileSystem {
    ...
    static final class Companion {
        ...
        public final Path removeBase(Path path, Path base) {
            ...
            return getROOT().resolve(StringsKt.replace$default(StringsKt.removePrefix(path.toString(), (CharSequence) base.toString()), '\\', JsonPointer.SEPARATOR, false, 4, (Object) null));
        }
        ...
        public final Pair<FileSystem, Path> toFileRoot(URL url) {
            ...
            if (Intrinsics.areEqual(url.getProtocol(), "file")) {
                return TuplesKt.m498to(FileSystem.SYSTEM, Path.Companion.get$default(Path.INSTANCE, new File(url.toURI()), false, 1, (Object) null));
            }
            return null;
        }
        ...
        public final Pair<FileSystem, Path> toJarRoot(URL url) {
            ...
            return TuplesKt.m498to(ZipKt.openZip(Path.Companion.get$default(companion, new File(URI.create(strSubstring)), false, 1, (Object) null), FileSystem.SYSTEM, new Function1<ZipEntry, Boolean>() { // from class: okio.internal.ResourceFileSystem$Companion$toJarRoot$zip$1
