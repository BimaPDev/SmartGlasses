...
public final class _BufferKt {
    ...
    public static final long commonReadHexadecimalUnsignedLong(Buffer buffer) throws EOFException {
        int i;
        Intrinsics.checkNotNullParameter(buffer, "<this>");
        if (buffer.size() == 0) {
            throw new EOFException();
    ...
    public static final long commonIndexOf(Buffer buffer, ByteString bytes, long j) {
        ...
        while (true) {
            long j6 = ((long) (segment2.limit - segment2.pos)) + j3;
            if (j6 > j) {
                break;
            }
        ...
        while (j2 < size5) {
            ...
            int iMin2 = (int) Math.min(segment3.limit, (((long) segment3.pos) + size5) - j2);
            segment = segment3;
            i = (int) ((((long) segment.pos) + j7) - j2);
            if (i < iMin2) {
                while (true) {
                    int i3 = i + 1;
                    z = true;
    ...
    public static final boolean commonRangeEquals(Buffer buffer, long j, ByteString bytes, int i, int i2) {
        ...
        while (true) {
            int i4 = i3 + 1;
            if (buffer.getByte(((long) i3) + j) != bytes.getByte(i3 + i)) {
                return false;
            }
            if (i4 >= i2) {
                return true;
