...
public final class Address {
    ...
    public final List<ConnectionSpec> m2267deprecated_connectionSpecs() {
    ...
    public final List<Protocol> m2270deprecated_protocols() {
    ...
    public String toString() {
        ...
        return sbAppend.append(proxy != null ? Intrinsics.stringPlus("proxy=", proxy) : Intrinsics.stringPlus("proxySelector=", this.proxySelector)).append('}').toString();
    }
}
