                    ...
                    while (i4 < length3) {
                        ...
                        if (Intrinsics.areEqual(header2.name, asciiLowercase)) {
                            ...
                            if (Intrinsics.areEqual(header3.value, byteString)) {
                                length2 = Hpack.INSTANCE.getSTATIC_HEADER_TABLE().length + (i4 - this.nextHeaderIndex);
                                break;
                            } else if (length == -1) {
                                length = Hpack.INSTANCE.getSTATIC_HEADER_TABLE().length + (i4 - this.nextHeaderIndex);
                            }
                        }
                        i4 = i5;
                    }
