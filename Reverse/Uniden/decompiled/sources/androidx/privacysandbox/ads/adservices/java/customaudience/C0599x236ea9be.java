...
@DebugMetadata(m503c = "androidx.privacysandbox.ads.adservices.java.customaudience.CustomAudienceManagerFutures$Api33Ext4JavaImpl$leaveCustomAudienceAsync$1", m504f = "CustomAudienceManagerFutures.kt", m505i = {}, m506l = {123}, m507m = "invokeSuspend", m508n = {}, m509s = {})
final class C0599x236ea9be extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    C0599x236ea9be(CustomAudienceManagerFutures.Api33Ext4JavaImpl api33Ext4JavaImpl, LeaveCustomAudienceRequest leaveCustomAudienceRequest, Continuation<? super C0599x236ea9be> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C0599x236ea9be(this.this$0, this.$request, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C0599x236ea9be) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
