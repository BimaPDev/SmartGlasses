...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0476R.id.special_effects_controller_view_tag);
        ...
        viewGroup.setTag(C0476R.id.special_effects_controller_view_tag, specialEffectsControllerCreateController);
    ...
    void forceCompleteAllOperations() {
        ...
        synchronized (this.mPendingOperations) {
            ...
            for (Operation operation : new ArrayList(this.mRunningOperations)) {
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v(FragmentManager.TAG, "SpecialEffectsController: " + (zIsAttachedToWindow ? "" : "Container " + this.mContainer + " is not attached to window. ") + "Cancelling running operation " + operation);
                }
                operation.cancel();
            }
            for (Operation operation2 : new ArrayList(this.mPendingOperations)) {
                if (FragmentManager.isLoggingEnabled(2)) {
                    Log.v(FragmentManager.TAG, "SpecialEffectsController: " + (zIsAttachedToWindow ? "" : "Container " + this.mContainer + " is not attached to window. ") + "Cancelling pending operation " + operation2);
                }
                operation2.cancel();
            }
        }
    ...
    static class Operation {
        ...
        enum State {
            ...
            void applyState(View view) {
                int i = C05343.f124xe493b431[ordinal()];
                if (i == 1) {
        ...
        final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C05343.f123xb9e640f0[lifecycleImpact.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C05343 {
        ...
        static {
            ...
            try {
                f123xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f123xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f124xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f124xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f124xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
