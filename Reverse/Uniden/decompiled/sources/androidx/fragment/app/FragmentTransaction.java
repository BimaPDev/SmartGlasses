...
public abstract class FragmentTransaction {
    ...
    static final class C0523Op {
        ...
        C0523Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0523Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0523Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0523Op(C0523Op c0523Op) {
            this.mCmd = c0523Op.mCmd;
            this.mFragment = c0523Op.mFragment;
            this.mFromExpandedOp = c0523Op.mFromExpandedOp;
            this.mEnterAnim = c0523Op.mEnterAnim;
            this.mExitAnim = c0523Op.mExitAnim;
            this.mPopEnterAnim = c0523Op.mPopEnterAnim;
            this.mPopExitAnim = c0523Op.mPopExitAnim;
            this.mOldMaxState = c0523Op.mOldMaxState;
            this.mCurrentMaxState = c0523Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0523Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C0523Op(it.next()));
        }
    ...
    void addOp(C0523Op c0523Op) {
        this.mOps.add(c0523Op);
        c0523Op.mEnterAnim = this.mEnterAnim;
        c0523Op.mExitAnim = this.mExitAnim;
        c0523Op.mPopEnterAnim = this.mPopEnterAnim;
        c0523Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0523Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0523Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0523Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0523Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0523Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0523Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0523Op(10, fragment, state));
        return this;
    }
