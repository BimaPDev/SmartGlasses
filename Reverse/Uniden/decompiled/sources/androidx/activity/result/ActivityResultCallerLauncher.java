...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<Unit> {
    ...
    public ActivityResultCallerLauncher(ActivityResultLauncher<I> launcher, ActivityResultContract<I, O> callerContract, I i) {
        ...
        this.callerInput = i;
        this.resultContract = LazyKt.lazy(new Function0<ActivityResultCallerLauncher$resultContract$2.C00311<I, O>>(this) { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2
            ...
            public final C00311<I, O> invoke() {
