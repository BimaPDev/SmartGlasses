...
import androidx.databinding.library.C0337R;
...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    protected void setRootTag(View view) {
        view.setTag(C0337R.id.dataBinding, this);
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0337R.id.dataBinding);
        }
        return null;
    }
        ...
        if (view instanceof ViewGroup) {
            ...
            while (i6 < childCount) {
                ...
                if (i < 0 || !(childAt.getTag() instanceof String)) {
                    ...
                    if (!str2.endsWith("_0") || !str2.startsWith("layout") || str2.indexOf(47) <= 0 || (iFindIncludeIndex = findIncludeIndex(str2, i7, includedLayouts, i)) < 0) {
                        i2 = i6;
                        i3 = i7;
                        z3 = false;
                    } else {
