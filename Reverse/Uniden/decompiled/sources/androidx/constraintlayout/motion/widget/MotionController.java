...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f57x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f58y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f57x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f58y;
    }
    ...
    KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f57x;
        rectF.top = this.mStartMotionPath.f58y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f57x;
        rectF2.top = this.mEndMotionPath.f58y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f57x - this.mStartMotionPath.f57x;
        float f2 = this.mEndMotionPath.f58y - this.mStartMotionPath.f58y;
        float f3 = this.mStartMotionPath.f57x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f58y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        while (true) {
            ...
            while (i14 < i) {
                if (motionPathsArr[i14].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i];
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i, motionPathsArr[i14].getCustomDataCount(str10));
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i16 = 0; i16 < i; i16++) {
                ...
                dArr6[i16][0] = motionPathsArr[i16].f57x;
                dArr6[i16][1] = motionPathsArr[i16].f58y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f57x + " y: " + this.mStartMotionPath.f58y + " end: x: " + this.mEndMotionPath.f57x + " y: " + this.mEndMotionPath.f58y;
    }
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f4 = this.mStartMotionPath.f57x + ((this.mEndMotionPath.f57x - this.mStartMotionPath.f57x) * f3);
            float f5 = f4 + 0.5f;
            int i4 = (int) f5;
            float f6 = this.mStartMotionPath.f58y + ((this.mEndMotionPath.f58y - this.mStartMotionPath.f58y) * f3) + 0.5f;
            int i5 = (int) f6;
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f57x - this.mStartMotionPath.f57x;
        float f3 = this.mEndMotionPath.f58y - this.mStartMotionPath.f58y;
