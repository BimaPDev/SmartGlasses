...
public class MotionEffect extends MotionHelper {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C0180R.styleable.MotionEffect);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C0180R.styleable.MotionEffect_motionEffect_start) {
                ...
                } else if (index == C0180R.styleable.MotionEffect_motionEffect_end) {
                ...
                } else if (index == C0180R.styleable.MotionEffect_motionEffect_translationX) {
                ...
                } else if (index == C0180R.styleable.MotionEffect_motionEffect_translationY) {
    ...
    public void onPreSetup(MotionLayout motionLayout, HashMap<View, MotionController> controllerMap) {
        ...
        while (i6 < views.length) {
            ...
            if (motionController2 != null) {
                ...
                } else if (i2 != 3 || finalX2 <= 0.0f || (this.motionEffectStrictMove && finalY2 != 0.0f)) {
                    i = this.viewTransitionId;
                    if (i == -1) {
                        motionController2.addKey(keyAttributes4);
                        motionController2.addKey(keyAttributes5);
