...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int i = C01481.$SwitchMap$androidx$constraintlayout$core$state$State$Direction[this.mDirection.ordinal()];
        int i2 = 3;
        if (i == 3 || i == 4) {
            i2 = 1;
        } else if (i == 5) {
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.core.state.helpers.BarrierReference$1 */
