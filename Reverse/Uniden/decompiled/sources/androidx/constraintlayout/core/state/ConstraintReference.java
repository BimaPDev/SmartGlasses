...
public class ConstraintReference implements Reference {
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.core.state.ConstraintReference$1 */
    ...
    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C01461.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    public ConstraintReference bias(float f) {
        ...
        int i = C01461.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()];
        if (i == 17) {
            this.mHorizontalBias = f;
        } else if (i != 18) {
            switch (i) {
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int i = C01461.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        switch (C01461.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
            case 1:
