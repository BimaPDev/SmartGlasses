...
public class State {
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i = C01471.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i == 1) {
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.core.state.State$1 */
