...
public class CLToken extends CLElement {
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.core.parser.CLToken$1 */
    ...
    public boolean validate(char c, long j) {
        int i = C01451.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        boolean z = false;
        if (i == 1) {
