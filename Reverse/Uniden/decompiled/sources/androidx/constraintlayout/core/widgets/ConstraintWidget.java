...
public class ConstraintWidget {
    ...
    protected int getRootX() {
        return this.f41mX + this.mOffsetX;
    }

    protected int getRootY() {
        return this.f42mY + this.mOffsetY;
    }
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f41mX + ", " + this.f42mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }

    public int getX() {
        ConstraintWidget constraintWidget = this.mParent;
        return (constraintWidget == null || !(constraintWidget instanceof ConstraintWidgetContainer)) ? this.f41mX : ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f41mX;
    }

    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        return (constraintWidget == null || !(constraintWidget instanceof ConstraintWidgetContainer)) ? this.f42mY : ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f42mY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C01521.f43x6930e354[type.ordinal()];
        if (i2 == 1) {
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C01521.f43x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 15661. Try increasing type updates limit count.
    ...
    /* JADX WARN: Code duplicated, block: B:234:0x03ac  */
    ...
    /* JADX WARN: Code duplicated, block: B:251:0x040d  */
    /* JADX WARN: Code duplicated, block: B:260:0x042f  */
    /* JADX WARN: Code duplicated, block: B:270:0x0447  */
    /* JADX WARN: Code duplicated, block: B:273:0x044d  */
    /* JADX WARN: Code duplicated, block: B:274:0x044f A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:277:0x0455 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:280:0x045a  */
    ...
    /* JADX WARN: Code duplicated, block: B:290:0x046d  */
    /* JADX WARN: Code duplicated, block: B:292:0x0470  */
    /* JADX WARN: Code duplicated, block: B:295:0x0477  */
    /* JADX WARN: Code duplicated, block: B:297:0x047d A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:301:0x0485  */
    /* JADX WARN: Code duplicated, block: B:304:0x0497  */
    /* JADX WARN: Code duplicated, block: B:306:0x049b  */
    /* JADX WARN: Code duplicated, block: B:307:0x04a0  */
    /* JADX WARN: Code duplicated, block: B:309:0x04a3  */
    /* JADX WARN: Code duplicated, block: B:311:0x04a9 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:319:0x04c4  */
    ...
    private void applyConstraints(LinearSystem linearSystem, boolean z, boolean z2, boolean z3, boolean z4, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z5, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, int i6, int i7, int i8, float f2, boolean z11) {
        ...
        int i29 = z6 ? 3 : i5;
        int i30 = C01521.f44x6d00e4a2[dimensionBehaviour.ordinal()];
        if (i30 != 1 && i30 != 2 && i30 != 3 && i30 == 4) {
            ...
            if (z11 || z8) {
                ...
                if (i13 >= c && z2 && z14) {
                    ...
                    int i31 = (z || this.mBaseline.mTarget == null) ? 1 : i15;
                    if (!z && this.mBaseline.mTarget != null) {
                        ConstraintWidget constraintWidget5 = this.mBaseline.mTarget.mOwner;
                        if (constraintWidget5.mDimensionRatio == 0.0f || constraintWidget5.mListDimensionBehaviors[i15] != DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget5.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT) {
                            return;
                        }
                    } else if (i31 == 0) {
                        return;
            ...
            if (zIsConnected || zIsConnected2 || zIsConnected3) {
                        ...
                        if (zIsConnected && zIsConnected2) {
                            ...
                            if (!z13) {
                                ...
                                if (z15) {
                                    ...
                                    linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), i16);
                                    solverVariableCreateObjectVariable4 = solverVariableCreateObjectVariable4;
                                    linearSystem.addLowerThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable6, -constraintAnchor2.getMargin(), i16);
                                } else {
                                    solverVariableCreateObjectVariable4 = solverVariableCreateObjectVariable4;
                                }
                                if (z19 || !z10 || (constraintWidget6 instanceof Barrier) || (constraintWidget7 instanceof Barrier)) {
                                    ...
                                    if (z18) {
                                        if (z17 && (!z9 || z3)) {
                                            ...
                                            iMax = Math.max(i21, iMax);
                                        }
                                        if (z19) {
                                            iMin2 = Math.min(i16, iMax);
                ...
                int margin3 = constraintAnchor2.mTarget != null ? constraintAnchor2.getMargin() : i20;
                if (solverVariableCreateObjectVariable6 != solverVariable2) {
                    ...
                    linearSystem.addGreaterThan(solverVariable2, solverVariableCreateObjectVariable4, margin3, i27);
                    return;
                }
                return;
            }
    ...
    static /* synthetic */ class C01521 {
        ...
        static final /* synthetic */ int[] f44x6d00e4a2;
        ...
        static {
            ...
            try {
                f44x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f44x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f43x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f43x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f41mX = constraintWidget.f41mX;
        this.f42mY = constraintWidget.f42mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f41mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f42mY);
        sb.append("\n");
