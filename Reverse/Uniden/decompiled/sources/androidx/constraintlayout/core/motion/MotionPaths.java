...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f21x;
        float f9 = motionPaths.f22y;
        float f10 = (motionPaths2.f21x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f22y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f21x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f22y = (int) ((f9 + (f11 * f)) - f15);
        ...
        this.mMode = 0;
        this.f21x = (int) (((motionPaths.f21x + (f16 * f10)) + (f18 * f11)) - f13);
        this.f22y = (int) (((motionPaths.f22y + (f10 * f17)) + (f11 * f)) - f15);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f21x;
            float f11 = motionPaths.f21x;
            this.f21x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f22y;
            float f13 = motionPaths.f22y;
            this.f22y = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f21x;
                float f15 = motionPaths.f21x;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f21x = fMin;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f22y;
                float f17 = motionPaths.f22y;
                f = (f2 * (f16 - f17)) + f17;
            } else {
                f = motionKeyPosition.mPercentY;
            }
            ...
            float f19 = motionPaths2.f21x;
            float f20 = motionPaths.f21x;
            this.f21x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f22y;
            float f22 = motionPaths.f22y;
            this.f22y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f21x + (this.width / 2.0f)) - motionPaths.f21x) - (motionPaths.width / 2.0f);
        double d2 = ((this.f22y + (this.height / 2.0f)) - motionPaths.f22y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f21x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f22y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f22y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f21x;
        float f9 = motionPaths.f22y;
        float f10 = motionPaths2.f21x + (f4 / 2.0f);
        float f11 = motionPaths2.f22y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f21x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f22y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f21x = (int) (motionKeyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f22y = (int) (motionKeyPosition.mPercentY * ((int) (i2 - this.height)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = (motionPaths2.f21x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f22y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        this.f21x = (int) ((f6 + f12) - f14);
        float f15 = f * f11;
        float f16 = f5 * f3;
        float f17 = f16 / 2.0f;
        this.f22y = (int) ((f8 + f15) - f17);
        ...
        this.mMode = 1;
        float f19 = (int) ((motionPaths.f21x + f12) - f14);
        this.f21x = f19;
        float f20 = (int) ((motionPaths.f22y + f15) - f17);
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f21x, motionPaths.f21x);
        boolean zDiff2 = diff(this.f22y, motionPaths.f22y);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f21x;
        float fCos = this.f22y;
        float f = this.width;
