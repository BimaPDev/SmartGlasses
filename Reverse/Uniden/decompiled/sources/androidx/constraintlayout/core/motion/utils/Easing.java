...
public class Easing {
    ...
    static class CubicEasing extends Easing {
        ...
        private double getX(double d) {
            double d2 = 1.0d - d;
            double d3 = 3.0d * d2;
            return (this.f23x1 * d2 * d3 * d) + (this.f24x2 * d3 * d * d) + (d * d * d);
        }

        private double getY(double d) {
            double d2 = 1.0d - d;
            double d3 = 3.0d * d2;
            return (this.f25y1 * d2 * d3 * d) + (this.f26y2 * d3 * d * d) + (d * d * d);
        }
        ...
        CubicEasing(String str) {
            ...
            this.f23x1 = Double.parseDouble(str.substring(iIndexOf + 1, iIndexOf2).trim());
            int i = iIndexOf2 + 1;
            int iIndexOf3 = str.indexOf(44, i);
            this.f25y1 = Double.parseDouble(str.substring(i, iIndexOf3).trim());
            int i2 = iIndexOf3 + 1;
            int iIndexOf4 = str.indexOf(44, i2);
            this.f24x2 = Double.parseDouble(str.substring(i2, iIndexOf4).trim());
            int i3 = iIndexOf4 + 1;
            this.f26y2 = Double.parseDouble(str.substring(i3, str.indexOf(41, i3)).trim());
        }
