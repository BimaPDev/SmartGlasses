...
public class Motion implements TypedValues {
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f21x;
        floatRect.top = this.mStartMotionPath.f22y;
        ...
        floatRect2.left = this.mEndMotionPath.f21x;
        floatRect2.top = this.mEndMotionPath.f22y;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f21x - this.mStartMotionPath.f21x;
        float f4 = this.mEndMotionPath.f22y - this.mStartMotionPath.f22y;
        float f5 = this.mStartMotionPath.f21x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f22y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i19 = 0; i19 < i4; i19++) {
                ...
                dArr6[i19][0] = motionPathsArr[i19].f21x;
                dArr6[i19][1] = motionPathsArr[i19].f22y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f21x + " y: " + this.mStartMotionPath.f22y + " end: x: " + this.mEndMotionPath.f21x + " y: " + this.mEndMotionPath.f22y;
    }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff(this.f18mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f21x + ((this.mEndMotionPath.f21x - this.mStartMotionPath.f21x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f22y + ((this.mEndMotionPath.f22y - this.mStartMotionPath.f22y) * f4) + 0.5f;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f21x - this.mStartMotionPath.f21x;
        float f6 = this.mEndMotionPath.f22y - this.mStartMotionPath.f22y;
