...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(C0713R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = typedArrayObtainStyledAttributes.getColor(C0713R.styleable.f139xaa980688, DEFAULT_BACKGROUND_COLOR);
