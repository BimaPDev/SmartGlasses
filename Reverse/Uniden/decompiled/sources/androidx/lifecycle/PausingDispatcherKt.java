...
public final class PausingDispatcherKt {
    ...
    /* JADX INFO: compiled from: PausingDispatcher.jvm.kt */
    @Metadata(m490d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m491d2 = {"<anonymous>", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m492k = 3, m493mv = {1, 8, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m503c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m504f = "PausingDispatcher.jvm.kt", m505i = {0}, m506l = {205}, m507m = "invokeSuspend", m508n = {"controller"}, m509s = {"L$0"})
    static final class C05562<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C05562(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C05562> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05562 c05562 = new C05562(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c05562.L$0 = obj;
            return c05562;
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C05562(lifecycle, state, function2, null), continuation);
    }
}
