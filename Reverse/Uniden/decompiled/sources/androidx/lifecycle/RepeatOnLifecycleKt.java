...
public final class RepeatOnLifecycleKt {
    public static final Object repeatOnLifecycle(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C05573(lifecycle, state, function2, null), continuation);
    ...
    @DebugMetadata(m503c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3", m504f = "RepeatOnLifecycle.kt", m505i = {}, m506l = {84}, m507m = "invokeSuspend", m508n = {}, m509s = {})
    static final class C05573 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C05573(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C05573> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05573 c05573 = new C05573(this.$this_repeatOnLifecycle, this.$state, this.$block, continuation);
            c05573.L$0 = obj;
            return c05573;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C05573) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX INFO: renamed from: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1, reason: invalid class name */
        /* JADX INFO: compiled from: RepeatOnLifecycle.kt */
        @Metadata(m490d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m491d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m492k = 3, m493mv = {1, 8, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        @DebugMetadata(m503c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1", m504f = "RepeatOnLifecycle.kt", m505i = {0, 0}, m506l = {166}, m507m = "invokeSuspend", m508n = {"launchedJob", "observer"}, m509s = {"L$0", "L$1"})
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                try {
                    ...
                    objectRef4.element = new LifecycleEventObserver() { // from class: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1
                        ...
                        /* JADX INFO: compiled from: RepeatOnLifecycle.kt */
                        @Metadata(m490d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m491d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m492k = 3, m493mv = {1, 8, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
                        @DebugMetadata(m503c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1", m504f = "RepeatOnLifecycle.kt", m505i = {0, 1}, m506l = {171, 110}, m507m = "invokeSuspend", m508n = {"$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, m509s = {"L$0", "L$0"})
                        static final class C05581 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            C05581(Mutex mutex, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C05581> continuation) {
                                super(2, continuation);
                                this.$mutex = mutex;
                                this.$block = function2;
                            }
                            ...
                            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                return new C05581(this.$mutex, this.$block, continuation);
                            }
                        ...
                        public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                            ...
                            if (event == eventUpTo) {
                                objectRef3.element = BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C05581(mutexMutex$default, function2, null), 3, null);
                                return;
                            }
                            ...
                            if (event == Lifecycle.Event.ON_DESTROY) {
                                ...
                                cancellableContinuation.resumeWith(Result.m695constructorimpl(Unit.INSTANCE));
                            }
                        }
                    };
