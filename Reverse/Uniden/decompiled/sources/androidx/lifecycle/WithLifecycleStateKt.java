...
public final class WithLifecycleStateKt {
    public static final <R> Object withStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked(lifecycle, state, zIsDispatchNeeded, immediate, new C05692(function0), continuation);
    }
    ...
    /* JADX INFO: compiled from: WithLifecycleState.kt */
    @Metadata(m490d1 = {"\u0000\u0004\n\u0002\b\u0004\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, m491d2 = {"<anonymous>", "R", "invoke", "()Ljava/lang/Object;"}, m492k = 3, m493mv = {1, 8, 0}, m495xi = 176)
    public static final class C05692<R> extends Lambda implements Function0<R> {
        final /* synthetic */ Function0<R> $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C05692(Function0<? extends R> function0) {
            super(0);
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.INSTANCE.upTo(state)) {
                    ...
                    try {
                        ...
                        objM695constructorimpl = Result.m695constructorimpl(function1.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM695constructorimpl = Result.m695constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(objM695constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    continuation3.resumeWith(Result.m695constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
            coroutineDispatcher.mo2252dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$lambda$2$$inlined$Runnable$1
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            ...
            public final void invoke2(Throwable th) {
                if (coroutineDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    final C0567xfdb59cc4<R> c0567xfdb59cc4 = r2;
                    coroutineDispatcher2.mo2252dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2$invoke$$inlined$Runnable$1
                        @Override // java.lang.Runnable
                        public final void run() {
                            lifecycle2.removeObserver(c0567xfdb59cc4);
                        }
                    });
                    return;
                }
