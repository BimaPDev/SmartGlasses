    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + JsonPointer.SEPARATOR + Uri.encode(strSubstring, RemoteSettings.FORWARD_SLASH_STRING)).build();
        ...
        private boolean belongsToRoot(String str, String str2) {
            ...
            return strRemoveTrailingSlash.equals(strRemoveTrailingSlash2) || strRemoveTrailingSlash.startsWith(new StringBuilder().append(strRemoveTrailingSlash2).append(JsonPointer.SEPARATOR).toString());
        }
    }
