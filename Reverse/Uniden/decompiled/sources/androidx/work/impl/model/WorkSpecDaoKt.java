    ...
    public static final Flow<WorkInfo> getWorkStatusPojoFlowDataForIds(WorkSpecDao workSpecDao, UUID id) {
        ...
        return FlowKt.distinctUntilChanged(new Flow<WorkInfo>() { // from class: androidx.work.impl.model.WorkSpecDaoKt$getWorkStatusPojoFlowDataForIds$$inlined$map$1
            ...
            public Object collect(FlowCollector<? super WorkInfo> flowCollector, Continuation continuation) {
                Object objCollect = workStatusPojoFlowDataForIds.collect(new C08382(flowCollector), continuation);
            ...
            public static final class C08382<T> implements FlowCollector {
                ...
                @DebugMetadata(m503c = "androidx.work.impl.model.WorkSpecDaoKt$getWorkStatusPojoFlowDataForIds$$inlined$map$1$2", m504f = "WorkSpecDao.kt", m505i = {}, m506l = {223}, m507m = "emit", m508n = {}, m509s = {})
                public static final class AnonymousClass1 extends ContinuationImpl {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        return C08382.this.emit(null, this);
                    }
                }

                public C08382(FlowCollector flowCollector) {
    ...
    public static final Flow<List<WorkInfo>> dedup(final Flow<? extends List<WorkSpec.WorkInfoPojo>> flow, CoroutineDispatcher dispatcher) {
        ...
        return FlowKt.flowOn(FlowKt.distinctUntilChanged(new Flow<List<? extends WorkInfo>>() { // from class: androidx.work.impl.model.WorkSpecDaoKt$dedup$$inlined$map$1
            ...
            public Object collect(FlowCollector<? super List<? extends WorkInfo>> flowCollector, Continuation continuation) {
                Object objCollect = flow.collect(new C08372(flowCollector), continuation);
                return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
            }
            ...
            /* JADX INFO: compiled from: Emitters.kt */
            @Metadata(m490d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0007\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m491d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1", "kotlinx/coroutines/flow/FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2"}, m492k = 3, m493mv = {1, 8, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
            public static final class C08372<T> implements FlowCollector {
                final /* synthetic */ FlowCollector $this_unsafeFlow;

                /* JADX INFO: renamed from: androidx.work.impl.model.WorkSpecDaoKt$dedup$$inlined$map$1$2$1, reason: invalid class name */
                /* JADX INFO: compiled from: Emitters.kt */
                @Metadata(m492k = 3, m493mv = {1, 8, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
                @DebugMetadata(m503c = "androidx.work.impl.model.WorkSpecDaoKt$dedup$$inlined$map$1$2", m504f = "WorkSpecDao.kt", m505i = {}, m506l = {223}, m507m = "emit", m508n = {}, m509s = {})
                public static final class AnonymousClass1 extends ContinuationImpl {
                    Object L$0;
                    int label;
                    /* synthetic */ Object result;
                    ...
                    public final Object invokeSuspend(Object obj) {
                        this.result = obj;
                        this.label |= Integer.MIN_VALUE;
                        return C08372.this.emit(null, this);
                    }
                }

                public C08372(FlowCollector flowCollector) {
                    this.$this_unsafeFlow = flowCollector;
                }
