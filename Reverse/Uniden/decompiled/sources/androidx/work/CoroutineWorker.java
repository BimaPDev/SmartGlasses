...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    @DebugMetadata(m503c = "androidx.work.CoroutineWorker$startWork$1", m504f = "CoroutineWorker.kt", m505i = {}, m506l = {68}, m507m = "invokeSuspend", m508n = {}, m509s = {})
    static final class C07971 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C07971(continuation);
        }
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(this.job)), null, null, new C07971(null), 3, null);
        return this.future;
    }
    ...
    public final ListenableFuture<ForegroundInfo> getForegroundInfoAsync() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, null, new C07961(jobListenableFuture, this, null), 3, null);
    ...
    /* JADX INFO: compiled from: CoroutineWorker.kt */
    @Metadata(m490d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m491d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m492k = 3, m493mv = {1, 8, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m503c = "androidx.work.CoroutineWorker$getForegroundInfoAsync$1", m504f = "CoroutineWorker.kt", m505i = {}, m506l = {134}, m507m = "invokeSuspend", m508n = {}, m509s = {})
    static final class C07961 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07961(JobListenableFuture<ForegroundInfo> jobListenableFuture, CoroutineWorker coroutineWorker, Continuation<? super C07961> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C07961(this.$jobFuture, this.this$0, continuation);
        }
