...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0036R.id.decor_content_parent);
        ...
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0036R.id.action_bar_container);
