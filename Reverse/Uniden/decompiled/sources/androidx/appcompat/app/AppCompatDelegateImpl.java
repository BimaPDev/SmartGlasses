...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    class C00491 implements Thread.UncaughtExceptionHandler {
        final /* synthetic */ Thread.UncaughtExceptionHandler val$defHandler;

        C00491(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            ...
            viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId) : this.mContext).inflate(C0036R.layout.abc_screen_toolbar, (ViewGroup) null);
            DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0036R.id.decor_content_parent);
    ...
    class C00524 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        C00524() {
        }
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(contextThemeWrapper, (AttributeSet) null, C0036R.attr.actionModePopupWindowStyle);
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C0036R.styleable.AppCompatTheme);
            String string = typedArrayObtainStyledAttributes.getString(C0036R.styleable.AppCompatTheme_viewInflaterClass);
            typedArrayObtainStyledAttributes.recycle();
            if (string == null) {
    ...
    protected static final class PanelFeatureState {
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0036R.layout.abc_list_menu_item_layout);
