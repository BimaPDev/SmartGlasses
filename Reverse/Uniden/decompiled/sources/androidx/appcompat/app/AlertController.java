...
class AlertController {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View viewFindViewById = this.mWindow.findViewById(C0036R.id.scrollIndicatorUp);
    ...
    class C00392 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00392(View view, View view2) {
            this.val$top = view;
    ...
    class RunnableC00403 implements Runnable {
        ...
        RunnableC00403(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    class C00414 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;
    ...
    class RunnableC00425 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00425(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
