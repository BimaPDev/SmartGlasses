...
class AppCompatTextViewAutoSizeHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        float dimension = typedArrayObtainStyledAttributes.hasValue(C0036R.styleable.AppCompatTextView_autoSizeStepGranularity) ? typedArrayObtainStyledAttributes.getDimension(C0036R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f) : -1.0f;
        float dimension2 = typedArrayObtainStyledAttributes.hasValue(C0036R.styleable.AppCompatTextView_autoSizeMinTextSize) ? typedArrayObtainStyledAttributes.getDimension(C0036R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f) : -1.0f;
        float dimension3 = typedArrayObtainStyledAttributes.hasValue(C0036R.styleable.AppCompatTextView_autoSizeMaxTextSize) ? typedArrayObtainStyledAttributes.getDimension(C0036R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f) : -1.0f;
