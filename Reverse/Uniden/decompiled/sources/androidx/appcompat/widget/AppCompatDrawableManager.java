        ...
        if (INSTANCE == null) {
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                public Drawable createDrawableFor(ResourceManagerInternal resourceManagerInternal, Context context, int i) {
                    ...
                    if (i == C0036R.drawable.abc_ratingbar_material) {
                        return getRatingBarLayerDrawable(resourceManagerInternal, context, C0036R.dimen.abc_star_big);
                    }
                    if (i == C0036R.drawable.abc_ratingbar_indicator_material) {
                        return getRatingBarLayerDrawable(resourceManagerInternal, context, C0036R.dimen.abc_star_medium);
                    }
                    if (i == C0036R.drawable.abc_ratingbar_small_material) {
                        return getRatingBarLayerDrawable(resourceManagerInternal, context, C0036R.dimen.abc_star_small);
                    }
                    return null;
                }
                ...
                private LayerDrawable getRatingBarLayerDrawable(ResourceManagerInternal resourceManagerInternal, Context context, int i) {
                    ...
                    Drawable drawable = resourceManagerInternal.getDrawable(context, C0036R.drawable.abc_star_black_48dp);
                    Drawable drawable2 = resourceManagerInternal.getDrawable(context, C0036R.drawable.abc_star_half_black_48dp);
                ...
                public boolean tintDrawableUsingColorFilter(Context context, int i, Drawable drawable) {
                    ...
                    if (arrayContains(this.COLORFILTER_TINT_COLOR_CONTROL_NORMAL, i)) {
                        i2 = C0036R.attr.colorControlNormal;
                    } else {
                        if (arrayContains(this.COLORFILTER_COLOR_CONTROL_ACTIVATED, i)) {
                            i2 = C0036R.attr.colorControlActivated;
                        } else {
                            if (arrayContains(this.COLORFILTER_COLOR_BACKGROUND_MULTIPLY, i)) {
                                mode = PorterDuff.Mode.MULTIPLY;
                            } else if (i == C0036R.drawable.abc_list_divider_mtrl_alpha) {
                                z = true;
                                iRound = Math.round(40.8f);
                                i2 = 16842800;
                                mode = mode;
                            } else if (i != C0036R.drawable.abc_dialog_material_background) {
                                i2 = 0;
                                z = false;
                                iRound = -1;
                            }
