...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (resourceId != -1) {
            ...
            string = tintTypedArrayObtainStyledAttributes2.hasValue(C0036R.styleable.TextAppearance_textLocale) ? tintTypedArrayObtainStyledAttributes2.getString(C0036R.styleable.TextAppearance_textLocale) : null;
            string2 = (Build.VERSION.SDK_INT < 26 || !tintTypedArrayObtainStyledAttributes2.hasValue(C0036R.styleable.TextAppearance_fontVariationSettings)) ? null : tintTypedArrayObtainStyledAttributes2.getString(C0036R.styleable.TextAppearance_fontVariationSettings);
        ...
        if (tintTypedArrayObtainStyledAttributes3.hasValue(C0036R.styleable.TextAppearance_textLocale)) {
            string = tintTypedArrayObtainStyledAttributes3.getString(C0036R.styleable.TextAppearance_textLocale);
        }
        if (Build.VERSION.SDK_INT >= 26 && tintTypedArrayObtainStyledAttributes3.hasValue(C0036R.styleable.TextAppearance_fontVariationSettings)) {
            string2 = tintTypedArrayObtainStyledAttributes3.getString(C0036R.styleable.TextAppearance_fontVariationSettings);
        }
        ...
        int dimensionPixelSize2 = tintTypedArrayObtainStyledAttributes4.getDimensionPixelSize(C0036R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int dimensionPixelSize3 = tintTypedArrayObtainStyledAttributes4.getDimensionPixelSize(C0036R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        if (tintTypedArrayObtainStyledAttributes4.hasValue(C0036R.styleable.AppCompatTextView_lineHeight)) {
            TypedValue typedValuePeekValue = tintTypedArrayObtainStyledAttributes4.peekValue(C0036R.styleable.AppCompatTextView_lineHeight);
            if (typedValuePeekValue != null && typedValuePeekValue.type == 5) {
                ...
                dimensionPixelSize = tintTypedArrayObtainStyledAttributes4.getDimensionPixelSize(C0036R.styleable.AppCompatTextView_lineHeight, -1);
            }
