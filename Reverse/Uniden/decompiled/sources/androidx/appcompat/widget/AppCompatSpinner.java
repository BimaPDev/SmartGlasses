...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatSpinner> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject("backgroundTint", C0036R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject("backgroundTintMode", C0036R.attr.backgroundTintMode);
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Resources.Theme theme) throws Throwable {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0036R.styleable.Spinner, i, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, theme);
        } else {
            int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C0036R.styleable.Spinner_popupTheme, 0);
            if (resourceId != 0) {
        ...
        try {
            ...
            if (i2 == 0) {
                ...
                dialogPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0036R.styleable.Spinner_android_prompt));
            } else if (i2 == 1) {
                final DropdownPopup dropdownPopup = new DropdownPopup(this.mPopupContext, attributeSet, i);
                TintTypedArray tintTypedArrayObtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0036R.styleable.Spinner, i, 0);
                this.mDropDownWidth = tintTypedArrayObtainStyledAttributes2.getLayoutDimension(C0036R.styleable.Spinner_android_dropDownWidth, -2);
                dropdownPopup.setBackgroundDrawable(tintTypedArrayObtainStyledAttributes2.getDrawable(C0036R.styleable.Spinner_android_popupBackground));
                dropdownPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0036R.styleable.Spinner_android_prompt));
            ...
            CharSequence[] textArray = tintTypedArrayObtainStyledAttributes.getTextArray(C0036R.styleable.Spinner_android_entries);
            if (textArray != null) {
                ArrayAdapter arrayAdapter = new ArrayAdapter(context, R.layout.simple_spinner_item, textArray);
                arrayAdapter.setDropDownViewResource(C0036R.layout.support_simple_spinner_dropdown_item);
