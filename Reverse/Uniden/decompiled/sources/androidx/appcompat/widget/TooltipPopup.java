...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C0036R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C0036R.id.message);
