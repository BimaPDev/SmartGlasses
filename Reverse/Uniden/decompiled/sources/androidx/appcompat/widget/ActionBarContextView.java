...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        setBackground(tintTypedArrayObtainStyledAttributes.getDrawable(C0036R.styleable.ActionMode_background));
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) linearLayout.findViewById(C0036R.id.action_bar_title);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        View viewFindViewById = this.mClose.findViewById(C0036R.id.action_mode_close_button);
