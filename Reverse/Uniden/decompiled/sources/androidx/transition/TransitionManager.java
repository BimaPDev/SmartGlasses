...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo586clone = transition.mo586clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo586clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo586clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo586clone);
    }
    ...
    public static void m70go(Scene scene) {
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo586clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    /* JADX INFO: renamed from: go */
    public static void m71go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo586clone = transition.mo586clone();
        sceneChangeSetup(viewGroup, transitionMo586clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo586clone);
    }
