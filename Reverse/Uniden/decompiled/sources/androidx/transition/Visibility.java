...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        ...
        View view4 = (View) view3.getTag(C0744R.id.save_overlay_view);
        if (view4 != null) {
            view2 = null;
            z2 = true;
        } else {
        ...
        if (!z2) {
            if (animatorOnDisappear2 == null) {
                ...
                view3.setTag(C0744R.id.save_overlay_view, view4);
    ...
    private class OverlayListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onAnimationStart(Animator animator, boolean z) {
            if (z) {
                this.mStartView.setTag(C0744R.id.save_overlay_view, this.mOverlayView);
                this.mOverlayHost.getOverlay().add(this.mOverlayView);
        ...
        private void removeFromOverlay() {
            this.mStartView.setTag(C0744R.id.save_overlay_view, null);
            this.mOverlayHost.getOverlay().remove(this.mOverlayView);
