...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (this.mReparent) {
            ...
            transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0744R.id.transition_transform));
            transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0744R.id.parent_matrix));
        }
    }
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0744R.id.parent_matrix, matrix);
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0744R.id.transition_transform, null);
            this.mView.setTag(C0744R.id.parent_matrix, null);
        }
    ...
    private static class Listener extends AnimatorListenerAdapter {
        ...
        private void setCurrentMatrix(Matrix matrix) {
            ...
            this.mView.setTag(C0744R.id.transition_transform, this.mTempMatrix);
            this.mTransforms.restore(this.mView);
        }
    }
}
