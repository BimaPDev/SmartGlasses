...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((java.lang.reflect.Method) map2.get("set" + strReplaceFirst)) != null && (!strReplaceFirst.endsWith(BYTES_SUFFIX) || !map.containsKey("get" + strReplaceFirst.substring(0, strReplaceFirst.length() - 5)))) {
