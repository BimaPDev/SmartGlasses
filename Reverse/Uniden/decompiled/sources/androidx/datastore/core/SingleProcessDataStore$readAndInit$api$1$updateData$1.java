...
@DebugMetadata(m503c = "androidx.datastore.core.SingleProcessDataStore$readAndInit$api$1", m504f = "SingleProcessDataStore.kt", m505i = {0, 0, 1, 2, 2}, m506l = {TypedValues.PositionType.TYPE_PERCENT_WIDTH, 337, 339}, m507m = "updateData", m508n = {"transform", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "newData"}, m509s = {"L$0", "L$1", "L$0", "L$0", "L$2"})
