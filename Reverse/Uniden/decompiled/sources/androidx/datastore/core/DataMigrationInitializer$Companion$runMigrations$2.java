...
@Metadata(m490d1 = {"\u0000\u0004\n\u0002\b\u0003\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001\"\u0004\b\u0001\u0010\u00012\u0006\u0010\u0002\u001a\u0002H\u0001H\u008a@"}, m491d2 = {"<anonymous>", ExifInterface.GPS_DIRECTION_TRUE, "startingData"}, m492k = 3, m493mv = {1, 5, 1}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m503c = "androidx.datastore.core.DataMigrationInitializer$Companion$runMigrations$2", m504f = "DataMigrationInitializer.kt", m505i = {0, 0}, m506l = {44, 46}, m507m = "invokeSuspend", m508n = {"migration", "data"}, m509s = {"L$2", "L$3"})
