...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.m74of("t", "s", "e", "o", "i", "h", TypedValues.TransitionType.S_TO, "ti");
    static JsonReader.Options INTERPOLATOR_NAMES = JsonReader.Options.m74of("x", "y");
    ...
    private static Interpolator interpolatorFor(PointF pointF, PointF pointF2) {
        ...
        WeakReference<Interpolator> interpolator = C0883L.getDisablePathInterpolatorCache() ? null : getInterpolator(iHashFor);
        ...
        if (interpolator == null || interpolator2 == null) {
            ...
            if (!C0883L.getDisablePathInterpolatorCache()) {
                try {
