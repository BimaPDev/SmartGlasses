...
class FontCharacterParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m74of("ch", "size", "w", "style", "fFamily", "data");
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m74of("shapes");
