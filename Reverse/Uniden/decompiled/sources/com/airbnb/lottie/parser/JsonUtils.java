...
class JsonUtils {
    private static final JsonReader.Options POINT_NAMES = JsonReader.Options.m74of("x", "y");
    ...
    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C09061.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C09061.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[tokenPeek.ordinal()];
        if (i == 1) {
