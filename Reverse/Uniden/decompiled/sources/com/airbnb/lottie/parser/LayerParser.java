...
public class LayerParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m74of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", "st", "w", "h", "ip", "op", "tm", "cl", "hd");
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m74of("d", "a");
    private static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m74of("ty", "nm");
            ...
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 9:
                    ...
                    if (iNextInt4 >= Layer.MatteType.values().length) {
                        ...
                        int i = C09071.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[matteType2.ordinal()];
                        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.airbnb.lottie.parser.LayerParser$1 */
