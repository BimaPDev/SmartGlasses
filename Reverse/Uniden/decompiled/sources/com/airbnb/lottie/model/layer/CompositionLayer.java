...
public class CompositionLayer extends BaseLayer {
        ...
        while (true) {
            ...
            if (baseLayerForModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C09021.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
    ...
    /* JADX INFO: renamed from: com.airbnb.lottie.model.layer.CompositionLayer$1 */
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C0883L.beginSection("CompositionLayer#draw");
        ...
        canvas.restore();
        C0883L.endSection("CompositionLayer#draw");
    }
    ...
    public void setProgress(float f) {
        C0883L.beginSection("CompositionLayer#setProgress");
        this.progress = f;
        super.setProgress(f);
        ...
        C0883L.endSection("CompositionLayer#setProgress");
    }
