...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    public void setProgress(float f) {
        C0883L.beginSection("BaseKeyframeAnimation#setProgress");
        if (this.keyframesWrapper.isEmpty()) {
            C0883L.endSection("BaseKeyframeAnimation#setProgress");
            return;
        }
    ...
    public void notifyListeners() {
        C0883L.beginSection("BaseKeyframeAnimation#notifyListeners");
        for (int i = 0; i < this.listeners.size(); i++) {
            this.listeners.get(i).onValueChanged();
        }
        C0883L.endSection("BaseKeyframeAnimation#notifyListeners");
    }

    protected Keyframe<K> getCurrentKeyframe() {
        C0883L.beginSection("BaseKeyframeAnimation#getCurrentKeyframe");
        Keyframe<K> currentKeyframe = this.keyframesWrapper.getCurrentKeyframe();
        C0883L.endSection("BaseKeyframeAnimation#getCurrentKeyframe");
