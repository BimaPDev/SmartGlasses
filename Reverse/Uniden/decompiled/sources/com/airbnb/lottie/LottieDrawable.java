...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    /* synthetic */ void m600lambda$new$0$comairbnblottieLottieDrawable(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m601lambda$new$1$comairbnblottieLottieDrawable() {
        CompositionLayer compositionLayer = this.compositionLayer;
        if (compositionLayer == null) {
            return;
        }
    ...
    public LottieDrawable() {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m600lambda$new$0$comairbnblottieLottieDrawable(valueAnimator);
            }
        };
        this.progressUpdateListener = animatorUpdateListener;
        this.setProgressDrawLock = new Semaphore(1);
        this.updateProgressRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m601lambda$new$1$comairbnblottieLottieDrawable();
            }
        };
    ...
    public void draw(Canvas canvas) {
        ...
        if (asyncUpdatesEnabled) {
            try {
                ...
                C0883L.endSection("Drawable#draw");
                if (!asyncUpdatesEnabled) {
                    return;
                }
                this.setProgressDrawLock.release();
        ...
        C0883L.beginSection("Drawable#draw");
        ...
        if (asyncUpdatesEnabled) {
            try {
                ...
                if (!asyncUpdatesEnabled) {
                    ...
                    if ((progress > animatedValueAbsolute ? 1 : (progress == animatedValueAbsolute ? 0 : -1)) == 0) {
                        return;
                    }
                }
            } finally {
    ...
    /* JADX INFO: renamed from: lambda$playAnimation$2$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m602lambda$playAnimation$2$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        playAnimation();
    }
        ...
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda4
                ...
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m602lambda$playAnimation$2$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: lambda$resumeAnimation$3$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m603lambda$resumeAnimation$3$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        resumeAnimation();
    }
    ...
    public void resumeAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda14
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m603lambda$resumeAnimation$3$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: lambda$setMinFrame$4$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m612lambda$setMinFrame$4$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMinFrame(i);
    }
    ...
    public void setMinFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda11
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m612lambda$setMinFrame$4$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setMinProgress$5$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m614lambda$setMinProgress$5$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMinProgress(f);
    }
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda12
                ...
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m614lambda$setMinProgress$5$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setMaxFrame$6$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m605lambda$setMaxFrame$6$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMaxFrame(i);
    }
    ...
    public void setMaxFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda13
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m605lambda$setMaxFrame$6$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setMaxProgress$7$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m607lambda$setMaxProgress$7$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMaxProgress(f);
    }
    ...
    public void setMaxProgress(final float f) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda3
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m607lambda$setMaxProgress$7$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setMinFrame$8$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m613lambda$setMinFrame$8$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMinFrame(str);
    }
    ...
    public void setMinFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda1
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m613lambda$setMinFrame$8$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: lambda$setMaxFrame$9$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m606lambda$setMaxFrame$9$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMaxFrame(str);
    }
    ...
    public void setMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda15
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m606lambda$setMaxFrame$9$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m608lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda7
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m608lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m609lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(String str, String str2, boolean z, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str, final String str2, final boolean z) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda16
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m609lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(str, str2, z, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m610lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(int i, int i2, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final int i, final int i2) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda6
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m610lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(i, i2, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setMinAndMaxProgress$13$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m611lambda$setMinAndMaxProgress$13$comairbnblottieLottieDrawable(float f, float f2, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(final float f, final float f2) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda10
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.m611lambda$setMinAndMaxProgress$13$comairbnblottieLottieDrawable(f, f2, lottieComposition2);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setFrame$14$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m604lambda$setFrame$14$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setFrame(i);
    }
    ...
    public void setFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda5
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m604lambda$setFrame$14$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$setProgress$15$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m615lambda$setProgress$15$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setProgress(f);
    }
    ...
    public void setProgress(final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda9
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m615lambda$setProgress$15$comairbnblottieLottieDrawable(f, lottieComposition);
                }
            });
            return;
        }
        C0883L.beginSection("Drawable#setProgress");
        this.animator.setFrame(this.composition.getFrameForProgress(f));
        C0883L.endSection("Drawable#setProgress");
    }
    ...
    public <T> void addValueCallback(final KeyPath keyPath, final T t, final LottieValueCallback<T> lottieValueCallback) {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda2
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.m599lambda$addValueCallback$16$comairbnblottieLottieDrawable(keyPath, t, lottieValueCallback, lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: renamed from: lambda$addValueCallback$16$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    /* synthetic */ void m599lambda$addValueCallback$16$comairbnblottieLottieDrawable(KeyPath keyPath, Object obj, LottieValueCallback lottieValueCallback, LottieComposition lottieComposition) {
        addValueCallback(keyPath, obj, (LottieValueCallback<Object>) lottieValueCallback);
    }

    public <T> void addValueCallback(KeyPath keyPath, T t, final SimpleLottieValueCallback<T> simpleLottieValueCallback) {
        addValueCallback(keyPath, t, new LottieValueCallback<T>() { // from class: com.airbnb.lottie.LottieDrawable.1
