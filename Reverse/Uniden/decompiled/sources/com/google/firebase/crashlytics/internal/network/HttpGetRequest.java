...
public class HttpGetRequest {
    ...
    public HttpResponse execute() throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m458v("GET Request URL: " + strCreateUrlWithParams);
    ...
    private String createParamsString(Map<String, String> map) throws UnsupportedEncodingException {
        ...
        sb.append(next.getKey()).append("=").append(next.getValue() != null ? URLEncoder.encode(next.getValue(), Key.STRING_CHARSET_NAME) : "");
        while (it.hasNext()) {
            Map.Entry<String, String> next2 = it.next();
            sb.append("&").append(next2.getKey()).append("=").append(next2.getValue() != null ? URLEncoder.encode(next2.getValue(), Key.STRING_CHARSET_NAME) : "");
        }
        return sb.toString();
    }
