...
final class C1907x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    ...
    private C1907x7e3e3ebd(String str, int i, List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> list) {
        this.name = str;
        this.importance = i;
        this.frames = list;
    }
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            return new C1907x7e3e3ebd(this.name, this.importance, this.frames);
        }
    }
}
