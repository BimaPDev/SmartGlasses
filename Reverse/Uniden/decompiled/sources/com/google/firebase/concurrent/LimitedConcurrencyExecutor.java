    ...
    private Runnable decorate(final Runnable runnable) {
        return new Runnable() { // from class: com.google.firebase.concurrent.LimitedConcurrencyExecutor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m447x96c64136(runnable);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$decorate$0$com-google-firebase-concurrent-LimitedConcurrencyExecutor */
    /* synthetic */ void m447x96c64136(Runnable runnable) {
        try {
            runnable.run();
        } finally {
            this.semaphore.release();
