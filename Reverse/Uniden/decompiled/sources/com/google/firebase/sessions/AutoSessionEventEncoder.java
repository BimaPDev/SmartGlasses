...
public final class AutoSessionEventEncoder implements Configurator {
    ...
    private static final class SessionEventEncoder implements ObjectEncoder<SessionEvent> {
        ...
        private static final FieldDescriptor EVENTTYPE_DESCRIPTOR = FieldDescriptor.m481of("eventType");
        private static final FieldDescriptor SESSIONDATA_DESCRIPTOR = FieldDescriptor.m481of("sessionData");
        private static final FieldDescriptor APPLICATIONINFO_DESCRIPTOR = FieldDescriptor.m481of("applicationInfo");
    ...
    private static final class SessionInfoEncoder implements ObjectEncoder<SessionInfo> {
        ...
        private static final FieldDescriptor SESSIONID_DESCRIPTOR = FieldDescriptor.m481of("sessionId");
        private static final FieldDescriptor FIRSTSESSIONID_DESCRIPTOR = FieldDescriptor.m481of("firstSessionId");
        private static final FieldDescriptor SESSIONINDEX_DESCRIPTOR = FieldDescriptor.m481of("sessionIndex");
        private static final FieldDescriptor EVENTTIMESTAMPUS_DESCRIPTOR = FieldDescriptor.m481of("eventTimestampUs");
        private static final FieldDescriptor DATACOLLECTIONSTATUS_DESCRIPTOR = FieldDescriptor.m481of("dataCollectionStatus");
    ...
    private static final class DataCollectionStatusEncoder implements ObjectEncoder<DataCollectionStatus> {
        ...
        private static final FieldDescriptor PERFORMANCE_DESCRIPTOR = FieldDescriptor.m481of("performance");
        private static final FieldDescriptor CRASHLYTICS_DESCRIPTOR = FieldDescriptor.m481of("crashlytics");
        private static final FieldDescriptor SESSIONSAMPLINGRATE_DESCRIPTOR = FieldDescriptor.m481of("sessionSamplingRate");
    ...
    private static final class ApplicationInfoEncoder implements ObjectEncoder<ApplicationInfo> {
        ...
        private static final FieldDescriptor APPID_DESCRIPTOR = FieldDescriptor.m481of("appId");
        private static final FieldDescriptor DEVICEMODEL_DESCRIPTOR = FieldDescriptor.m481of("deviceModel");
        private static final FieldDescriptor SESSIONSDKVERSION_DESCRIPTOR = FieldDescriptor.m481of("sessionSdkVersion");
        private static final FieldDescriptor OSVERSION_DESCRIPTOR = FieldDescriptor.m481of("osVersion");
        private static final FieldDescriptor LOGENVIRONMENT_DESCRIPTOR = FieldDescriptor.m481of("logEnvironment");
        private static final FieldDescriptor ANDROIDAPPINFO_DESCRIPTOR = FieldDescriptor.m481of("androidAppInfo");
    ...
    private static final class AndroidApplicationInfoEncoder implements ObjectEncoder<AndroidApplicationInfo> {
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.m481of("packageName");
        private static final FieldDescriptor VERSIONNAME_DESCRIPTOR = FieldDescriptor.m481of("versionName");
        private static final FieldDescriptor APPBUILDVERSION_DESCRIPTOR = FieldDescriptor.m481of("appBuildVersion");
        private static final FieldDescriptor DEVICEMANUFACTURER_DESCRIPTOR = FieldDescriptor.m481of("deviceManufacturer");
