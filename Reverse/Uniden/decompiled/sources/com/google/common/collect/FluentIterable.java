...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m248of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo242or(this);
    }
    ...
    public static <E> FluentIterable<E> m260of() {
        return from(Collections.emptyList());
    }

    /* JADX INFO: renamed from: of */
    public static <E> FluentIterable<E> m261of(@ParametricNullness E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m248of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m248of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m248of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m248of(next);
    }
