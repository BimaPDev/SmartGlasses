...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        private final AtomicInteger f369id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int iIncrementAndGet = this.f369id.incrementAndGet();
            String strJoin = Joiner.m246on(Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f369id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f369id);
        }
