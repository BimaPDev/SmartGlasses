...
public abstract class Invokable<T, R> implements AnnotatedElement, Member {
    ...
    public final TypeToken<? extends R> getReturnType() {
        return (TypeToken<? extends R>) TypeToken.m429of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.add(new Parameter(this, i, TypeToken.m429of(genericParameterTypes[i]), parameterAnnotations[i]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type type : getGenericExceptionTypes()) {
            builder.add(TypeToken.m429of(type));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> cls) {
        return returning(TypeToken.m428of((Class) cls));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m428of((Class) getDeclaringClass());
    }
