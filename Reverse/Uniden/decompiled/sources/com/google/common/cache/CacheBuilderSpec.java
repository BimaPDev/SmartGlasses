...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m253on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m253on('=').trimResults();
    ...
    CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C14301.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
        ...
        if (this.valueStrength != null) {
            int i = C14301.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
