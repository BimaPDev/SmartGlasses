...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher m244is(char c) {
        return new C1403Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m244is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    public CharMatcher mo245or(CharMatcher charMatcher) {
        return new C1404Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m244is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C1404Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1404Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C1403Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo245or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo245or(charMatcher);
        }
