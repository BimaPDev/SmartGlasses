...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static ImmutableDoubleArray m401of() {
        return EMPTY;
    }
    ...
    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m402of(double d) {
        return new ImmutableDoubleArray(new double[]{d});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m403of(double d, double d2) {
        return new ImmutableDoubleArray(new double[]{d, d2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m404of(double d, double d2, double d3) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m405of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m406of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m407of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m408of(double d, double... dArr) {
