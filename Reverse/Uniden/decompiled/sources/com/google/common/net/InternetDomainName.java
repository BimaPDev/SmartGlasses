...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m253on('.');
    private static final Joiner DOT_JOINER = Joiner.m246on('.');
    ...
    static {
        ...
        CharMatcher charMatcherMo245or = CharMatcher.inRange('a', 'z').mo245or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = charMatcherMo245or;
        PART_CHAR_MATCHER = charMatcherInRange.mo245or(charMatcherMo245or).mo245or(charMatcherAnyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m248of(PublicSuffixType.REGISTRY));
    }
