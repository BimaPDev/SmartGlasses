...
class StandardNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    StandardNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(networkBuilder.expectedNodeCount.mo242or(10).intValue()), networkBuilder.edgeOrder.createMap(networkBuilder.expectedEdgeCount.mo242or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.m389of(this, nCheckedReferenceNode, ((NetworkConnections) Objects.requireNonNull(this.nodeConnections.get(nCheckedReferenceNode))).adjacentNode(e));
    }
