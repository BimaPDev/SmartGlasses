...
public class HeroCarouselStrategy extends CarouselStrategy {
    ...
    KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        Arrangement arrangementFindLowestCostArrangement = Arrangement.findLowestCostArrangement(f2, fClamp, smallItemSizeMin, fMax, i3 != 0 ? doubleCounts(iArr2) : iArr2, f3, i3 != 0 ? doubleCounts(MEDIUM_COUNTS) : MEDIUM_COUNTS, fMin, iArr3);
