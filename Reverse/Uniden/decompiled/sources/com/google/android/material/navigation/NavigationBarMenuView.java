...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        if (isInEditMode()) {
            ...
            autoTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1081R.attr.motionDurationMedium4, getResources().getInteger(C1081R.integer.material_motion_duration_long_1)));
            autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1081R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
