...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C1081R.attr.materialTimePickerStyle, C1081R.style.Widget_MaterialComponents_TimePicker);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C1081R.styleable.MaterialTimePicker, C1081R.attr.materialTimePickerStyle, C1081R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = typedArrayObtainStyledAttributes.getResourceId(C1081R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = typedArrayObtainStyledAttributes.getResourceId(C1081R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int color = typedArrayObtainStyledAttributes.getColor(C1081R.styleable.MaterialTimePicker_backgroundTint, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C1081R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C1081R.id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C1081R.id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C1081R.id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C1081R.id.header_title);
        ...
        Button button = (Button) viewGroup2.findViewById(C1081R.id.material_timepicker_ok_button);
        ...
        Button button2 = (Button) viewGroup2.findViewById(C1081R.id.material_timepicker_cancel_button);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m237xac73da03();
                }
            }, 100L);
        }
    }

    /* JADX INFO: renamed from: lambda$onViewCreated$0$com-google-android-material-timepicker-MaterialTimePicker */
    /* synthetic */ void m237xac73da03() {
        TimePickerPresenter timePickerPresenter = this.activePresenter;
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C1081R.string.material_timepicker_text_input_mode_description));
        }
        if (i == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C1081R.string.material_timepicker_clock_mode_description));
        }
    ...
    private int getThemeResId() {
        ...
        TypedValue typedValueResolve = MaterialAttributes.resolve(requireContext(), C1081R.attr.materialTimePickerTheme);
