...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, null, C1081R.attr.materialCalendarStyle, C1081R.style.Widget_MaterialComponents_MaterialCalendar);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C1081R.styleable.MaterialCalendar, C1081R.attr.materialCalendarStyle, C1081R.style.Widget_MaterialComponents_MaterialCalendar);
        int color = typedArrayObtainStyledAttributes.getColor(C1081R.styleable.MaterialCalendar_backgroundTint, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C1081R.layout.mtrl_picker_fullscreen : C1081R.layout.mtrl_picker_dialog, viewGroup);
        ...
        if (this.fullscreen) {
            viewInflate.findViewById(C1081R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            viewInflate.findViewById(C1081R.id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) viewInflate.findViewById(C1081R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C1081R.id.mtrl_picker_header_toggle);
        this.headerTitleTextView = (TextView) viewInflate.findViewById(C1081R.id.mtrl_picker_title_text);
        initHeaderToggle(context);
        this.confirmButton = (Button) viewInflate.findViewById(C1081R.id.confirm_button);
        ...
        Button button = (Button) viewInflate.findViewById(C1081R.id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1081R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final View viewFindViewById = requireView().findViewById(C1081R.id.fullscreen_header);
    ...
    private void startPickerFragment() {
        ...
        fragmentTransactionBeginTransaction.replace(C1081R.id.mtrl_calendar_frame, this.pickerFragment);
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                this.f$0.m200x8a93f18a(view);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$initHeaderToggle$0$com-google-android-material-datepicker-MaterialDatePicker */
    /* synthetic */ void m200x8a93f18a(View view) {
    ...
    private void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        String string;
        if (this.inputMode == 1) {
            string = checkableImageButton.getContext().getString(C1081R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            string = checkableImageButton.getContext().getString(C1081R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, AppCompatResources.getDrawable(context, C1081R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1081R.drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C1081R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1081R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1081R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1081R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1081R.dimen.mtrl_calendar_month_horizontal_padding));
    }
