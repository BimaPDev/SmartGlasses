...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box box) {
        ...
        return (((((((this.moments[getIndex(box.f259r1, box.f257g1, box.f255b1)] - this.moments[getIndex(box.f259r1, box.f257g1, box.f254b0)]) - this.moments[getIndex(box.f259r1, box.f256g0, box.f255b1)]) + this.moments[getIndex(box.f259r1, box.f256g0, box.f254b0)]) - this.moments[getIndex(box.f258r0, box.f257g1, box.f255b1)]) + this.moments[getIndex(box.f258r0, box.f257g1, box.f254b0)]) + this.moments[getIndex(box.f258r0, box.f256g0, box.f255b1)]) - this.moments[getIndex(box.f258r0, box.f256g0, box.f254b0)]) - (((double) (((iVolume * iVolume) + (iVolume2 * iVolume2)) + (iVolume3 * iVolume3))) / ((double) volume(box, this.weights)));
    }
    ...
    Boolean cut(Box box, Box box2) {
        ...
        MaximizeResult maximizeResultMaximize = maximize(box, Direction.RED, box.f258r0 + 1, box.f259r1, iVolume, iVolume2, iVolume3, iVolume4);
        MaximizeResult maximizeResultMaximize2 = maximize(box, Direction.GREEN, box.f256g0 + 1, box.f257g1, iVolume, iVolume2, iVolume3, iVolume4);
        MaximizeResult maximizeResultMaximize3 = maximize(box, Direction.BLUE, box.f254b0 + 1, box.f255b1, iVolume, iVolume2, iVolume3, iVolume4);
        ...
        box2.f259r1 = box.f259r1;
        box2.f257g1 = box.f257g1;
        box2.f255b1 = box.f255b1;
        int i = C11511.f253x8739cebf[direction.ordinal()];
        if (i == 1) {
            box.f259r1 = maximizeResultMaximize.cutLocation;
            box2.f258r0 = box.f259r1;
            box2.f256g0 = box.f256g0;
            box2.f254b0 = box.f254b0;
        } else if (i == 2) {
            box.f257g1 = maximizeResultMaximize2.cutLocation;
            box2.f258r0 = box.f258r0;
            box2.f256g0 = box.f257g1;
            box2.f254b0 = box.f254b0;
        } else if (i == 3) {
            box.f255b1 = maximizeResultMaximize3.cutLocation;
            box2.f258r0 = box.f258r0;
            box2.f256g0 = box.f256g0;
            box2.f254b0 = box.f255b1;
        }
        box.vol = (box.f259r1 - box.f258r0) * (box.f257g1 - box.f256g0) * (box.f255b1 - box.f254b0);
        box2.vol = (box2.f259r1 - box2.f258r0) * (box2.f257g1 - box2.f256g0) * (box2.f255b1 - box2.f254b0);
        return true;
    }
    ...
    static /* synthetic */ class C11511 {
        ...
        static final /* synthetic */ int[] f253x8739cebf;
        ...
        static {
            ...
            try {
                f253x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f253x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box box, int[] iArr) {
        return ((((((iArr[getIndex(box.f259r1, box.f257g1, box.f255b1)] - iArr[getIndex(box.f259r1, box.f257g1, box.f254b0)]) - iArr[getIndex(box.f259r1, box.f256g0, box.f255b1)]) + iArr[getIndex(box.f259r1, box.f256g0, box.f254b0)]) - iArr[getIndex(box.f258r0, box.f257g1, box.f255b1)]) + iArr[getIndex(box.f258r0, box.f257g1, box.f254b0)]) + iArr[getIndex(box.f258r0, box.f256g0, box.f255b1)]) - iArr[getIndex(box.f258r0, box.f256g0, box.f254b0)];
    }

    static int bottom(Box box, Direction direction, int[] iArr) {
        int i;
        int i2;
        int i3 = C11511.f253x8739cebf[direction.ordinal()];
        if (i3 == 1) {
            i = (-iArr[getIndex(box.f258r0, box.f257g1, box.f255b1)]) + iArr[getIndex(box.f258r0, box.f257g1, box.f254b0)] + iArr[getIndex(box.f258r0, box.f256g0, box.f255b1)];
            i2 = iArr[getIndex(box.f258r0, box.f256g0, box.f254b0)];
        } else if (i3 == 2) {
            i = (-iArr[getIndex(box.f259r1, box.f256g0, box.f255b1)]) + iArr[getIndex(box.f259r1, box.f256g0, box.f254b0)] + iArr[getIndex(box.f258r0, box.f256g0, box.f255b1)];
            i2 = iArr[getIndex(box.f258r0, box.f256g0, box.f254b0)];
        } else if (i3 == 3) {
            i = (-iArr[getIndex(box.f259r1, box.f257g1, box.f254b0)]) + iArr[getIndex(box.f259r1, box.f256g0, box.f254b0)] + iArr[getIndex(box.f258r0, box.f257g1, box.f254b0)];
            i2 = iArr[getIndex(box.f258r0, box.f256g0, box.f254b0)];
        } else {
    ...
    static int top(Box box, Direction direction, int i, int[] iArr) {
        int i2;
        int i3;
        int i4 = C11511.f253x8739cebf[direction.ordinal()];
        if (i4 == 1) {
            i2 = (iArr[getIndex(i, box.f257g1, box.f255b1)] - iArr[getIndex(i, box.f257g1, box.f254b0)]) - iArr[getIndex(i, box.f256g0, box.f255b1)];
            i3 = iArr[getIndex(i, box.f256g0, box.f254b0)];
        } else if (i4 == 2) {
            i2 = (iArr[getIndex(box.f259r1, i, box.f255b1)] - iArr[getIndex(box.f259r1, i, box.f254b0)]) - iArr[getIndex(box.f258r0, i, box.f255b1)];
            i3 = iArr[getIndex(box.f258r0, i, box.f254b0)];
        } else if (i4 == 3) {
            i2 = (iArr[getIndex(box.f259r1, box.f257g1, i)] - iArr[getIndex(box.f259r1, box.f256g0, i)]) - iArr[getIndex(box.f258r0, box.f257g1, i)];
            i3 = iArr[getIndex(box.f258r0, box.f256g0, i)];
        } else {
            throw new IllegalArgumentException("unexpected direction " + direction);
        }
        return i2 + i3;
