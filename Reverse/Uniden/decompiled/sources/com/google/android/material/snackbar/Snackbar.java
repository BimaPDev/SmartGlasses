...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1081R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C1081R.attr.snackbarButtonStyle, C1081R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i) {
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i2 = C1081R.layout.mtrl_layout_snackbar_include;
        } else {
            i2 = C1081R.layout.design_layout_snackbar_include;
        }
        ...
        if (TextUtils.isEmpty(charSequence) || onClickListener == null) {
            ...
            actionView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    this.f$0.m623lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(onClickListener, view);
                }
            });
        }
        return this;
    ...
    /* synthetic */ void m623lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
