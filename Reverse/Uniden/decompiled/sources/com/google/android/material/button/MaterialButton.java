...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C1081R.style.Widget_MaterialComponents_Button;
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<MaterialButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mIconPaddingId = propertyMapper.mapInt("iconPadding", C1081R.attr.iconPadding);
    ...
    public MaterialButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1081R.attr.materialButtonStyle);
    }
    ...
    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1081R.styleable.MaterialButton, i, i2, new int[0]);
        this.iconPadding = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1081R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1081R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), typedArrayObtainStyledAttributes, C1081R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), typedArrayObtainStyledAttributes, C1081R.styleable.MaterialButton_icon);
        this.iconGravity = typedArrayObtainStyledAttributes.getInteger(C1081R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1081R.styleable.MaterialButton_iconSize, 0);
