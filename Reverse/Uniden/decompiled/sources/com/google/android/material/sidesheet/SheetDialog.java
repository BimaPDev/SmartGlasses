...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C1081R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C1081R.id.touch_outside;
    ...
    /* JADX INFO: renamed from: lambda$wrapInSheet$0$com-google-android-material-sidesheet-SheetDialog */
    /* synthetic */ void m217x401f75dd(View view) {
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        if (GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).gravity, ViewCompat.getLayoutDirection(this.sheet)) == 3) {
            i = C1081R.style.Animation_Material3_SideSheetDialog_Left;
        } else {
            i = C1081R.style.Animation_Material3_SideSheetDialog_Right;
        }
