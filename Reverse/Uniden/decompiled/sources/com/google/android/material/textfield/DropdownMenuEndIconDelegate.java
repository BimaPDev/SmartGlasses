...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ void m229xd03fedd4(View view) {
        showHideDropdown();
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ void m230xac016995(View view, boolean z) {
    ...
    /* JADX INFO: renamed from: lambda$new$2$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ void m231x87c2e556(boolean z) {
    ...
    DropdownMenuEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m231x87c2e556(z);
            }
        };
        this.dropdownPopupActivatedAt = Long.MAX_VALUE;
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1081R.attr.motionDurationShort3, 67);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1081R.attr.motionDurationShort3, 50);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1081R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    }
    ...
    int getIconDrawableResId() {
        return IS_LOLLIPOP ? C1081R.drawable.mtrl_dropdown_arrow : C1081R.drawable.mtrl_ic_arrow_drop_down;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C1081R.string.exposed_dropdown_menu_content_description;
    }
    ...
    public void afterEditTextChanged(Editable editable) {
        ...
        this.autoCompleteTextView.post(new Runnable() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m227xae660ff2();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$afterEditTextChanged$3$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ void m227xae660ff2() {
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda5
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.m232x5f2e2537(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
    ...
    /* JADX INFO: renamed from: lambda$setUpDropdownShowHideBehavior$4$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ boolean m232x5f2e2537(View view, MotionEvent motionEvent) {
    ...
    /* JADX INFO: renamed from: lambda$setUpDropdownShowHideBehavior$5$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ void m233x3aefa0f8() {
        updateDropdownPopupDirty();
        setEndIconChecked(false);
    }
    ...
    private ValueAnimator getAlphaAnimator(int i, float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m228x6b943a83(valueAnimator);
            }
        });
        return valueAnimatorOfFloat;
    }

    /* JADX INFO: renamed from: lambda$getAlphaAnimator$6$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    /* synthetic */ void m228x6b943a83(ValueAnimator valueAnimator) {
