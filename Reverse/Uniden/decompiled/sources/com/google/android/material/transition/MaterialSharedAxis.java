...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    private static final int DEFAULT_THEMED_DURATION_ATTR = C1081R.attr.motionDurationLong1;
    private static final int DEFAULT_THEMED_EASING_ATTR = C1081R.attr.motionEasingEmphasizedInterpolator;

    /* JADX INFO: renamed from: X */
    public static final int f273X = 0;

    /* JADX INFO: renamed from: Y */
    public static final int f274Y = 1;

    /* JADX INFO: renamed from: Z */
    public static final int f275Z = 2;
