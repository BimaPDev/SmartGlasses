...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f164ix = readShort();
        this.header.currentFrame.f165iy = readShort();
        this.header.currentFrame.f163iw = readShort();
        this.header.currentFrame.f162ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
