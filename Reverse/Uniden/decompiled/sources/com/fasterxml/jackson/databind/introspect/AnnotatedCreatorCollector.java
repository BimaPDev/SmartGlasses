...
final class AnnotatedCreatorCollector extends CollectorBase {
    ...
    protected AnnotatedConstructor constructNonDefaultConstructor(ClassUtil.Ctor ctor, ClassUtil.Ctor ctor2) {
        ...
        Annotation[][] parameterAnnotations2 = null;
        ...
        if (paramCount != parameterAnnotations.length) {
            ...
            if (ctor2 == null) {
                ...
                parameterAnnotations2 = ctor2.getParameterAnnotations();
            }
            annotationMapArrCollectAnnotations = collectAnnotations(parameterAnnotations, parameterAnnotations2);
        }
    ...
    protected AnnotatedMethod constructFactoryCreator(Method method, Method method2) {
        ...
        AnnotationMap annotationMapCollectAnnotations = collectAnnotations(method, method2);
        ...
        return new AnnotatedMethod(typeResolutionContext, method, annotationMapCollectAnnotations, collectAnnotations(parameterAnnotations2, parameterAnnotations));
    }
