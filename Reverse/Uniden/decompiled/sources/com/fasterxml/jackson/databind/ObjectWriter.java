...
public class ObjectWriter implements Versioned, Serializable {
    ...
    public static final class GeneratorSettings implements Serializable {
        ...
        public GeneratorSettings withRootValueSeparator(String str) {
            ...
            return str.equals(_rootValueSeparatorAsString()) ? this : new GeneratorSettings(this.prettyPrinter, this.schema, this.characterEscapes, new SerializedString(str));
        }
        ...
        public GeneratorSettings withRootValueSeparator(SerializableString serializableString) {
            ...
            return serializableString.equals(this.rootValueSeparator) ? this : new GeneratorSettings(this.prettyPrinter, this.schema, this.characterEscapes, serializableString);
        }
