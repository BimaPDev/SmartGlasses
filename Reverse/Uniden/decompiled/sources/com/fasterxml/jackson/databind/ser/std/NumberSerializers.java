...
public class NumberSerializers {
    ...
    public static abstract class Base<T> extends StdScalarSerializer<T> implements ContextualSerializer {
        ...
        public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
            ...
            if (valueFindFormatOverrides == null || C10421.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[valueFindFormatOverrides.getShape().ordinal()] != 1) {
                return this;
            }
    ...
    /* JADX INFO: renamed from: com.fasterxml.jackson.databind.ser.std.NumberSerializers$1 */
    static /* synthetic */ class C10421 {
