...
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
    ...
    protected JsonDeserializer<Object> buildBuilderBasedDeserializer(DeserializationContext deserializationContext, JavaType javaType, BeanDescription beanDescription) throws JsonMappingException {
        try {
            ...
            String str = valueFindPOJOBuilderConfig == null ? JsonPOJOBuilder.DEFAULT_BUILD_METHOD : valueFindPOJOBuilderConfig.buildMethodName;
    ...
    protected SettableAnyProperty constructAnySetter(DeserializationContext deserializationContext, BeanDescription beanDescription, AnnotatedMember annotatedMember) throws JsonMappingException {
        ...
        ?? r4 = objFindKeyDeserializerFromAnnotation;
        ...
        return new SettableAnyProperty(std, annotatedMember, javaTypeResolveMemberAndTypeAnnotations, r4, jsonDeserializerFindContentDeserializerFromAnnotation != null ? deserializationContext.handlePrimaryContextualization(jsonDeserializerFindContentDeserializerFromAnnotation, std, javaTypeResolveMemberAndTypeAnnotations) : jsonDeserializerFindContentDeserializerFromAnnotation, (TypeDeserializer) javaTypeResolveMemberAndTypeAnnotations.getTypeHandler());
    }
