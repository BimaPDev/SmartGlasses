...
public final class CharTypes {
    ...
    private static final byte[] f185HB;

    /* JADX INFO: renamed from: HC */
    private static final char[] f186HC;
    ...
    static {
        ...
        f185HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f185HB[i2] = (byte) f186HC[i2];
        }
    ...
    public static char[] copyHexChars() {
        return (char[]) f186HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f185HB.clone();
    }
