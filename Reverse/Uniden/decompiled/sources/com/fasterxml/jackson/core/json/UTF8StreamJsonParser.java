...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    protected final String _getText2(JsonToken jsonToken) {
        ...
        int iM76id = jsonToken.m76id();
        if (iM76id == 5) {
            return this._parsingContext.getCurrentName();
        }
        if (iM76id == 6 || iM76id == 7 || iM76id == 8) {
            return this._textBuffer.contentsAsString();
        }
    ...
    public char[] getTextCharacters() throws IOException {
        ...
        int iM76id = this._currToken.m76id();
        if (iM76id == 5) {
            if (!this._nameCopied) {
                String currentName = this._parsingContext.getCurrentName();
    ...
    */
    ...
    /* JADX WARN: Code duplicated, block: B:15:0x003b A[DONT_INVERT, PHI: r10
      0x003b: PHI (r10v4 int) = (r10v3 int), (r10v25 int) binds: [B:9:0x002d, B:13:0x0037] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:52:0x010d A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:53:0x010f A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:56:0x0124 A[EDGE_INSN: B:56:0x0124->B:57:0x012c BREAK  A[LOOP:0: B:3:0x000e->B:78:0x000e]] */
    ...
    /* JADX WARN: Code duplicated, block: B:73:0x0086 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:74:0x00ef A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:76:0x00a5 A[SYNTHETIC] */
        ...
        while (true) {
            ...
            if (i12 > 32) {
                ...
                if (iDecodeBase64Char4 < 0) {
                    ...
                    iDecodeBase64Char4 = _decodeBase64Escape(base64Variant, i12, 0);
                    if (iDecodeBase64Char4 >= 0) {
                        if (i9 > length) {
                            i10 += i9;
                        ...
                        if (iDecodeBase64Char < 0) {
                            iDecodeBase64Char = _decodeBase64Escape(base64Variant, i2, 1);
                        }
                        ...
                        if (iDecodeBase64Char2 >= 0) {
                            if (iDecodeBase64Char2 != -2) {
                                ...
                                iDecodeBase64Char2 = _decodeBase64Escape(base64Variant, i4, 2);
                            }
                            if (iDecodeBase64Char2 == -2) {
                                if (this._inputPtr >= this._inputEnd) {
                                    _loadMoreGuaranteed();
                        ...
                        if (iDecodeBase64Char3 < 0) {
                            if (iDecodeBase64Char3 != -2) {
                                ...
                                i = 3;
                                iDecodeBase64Char3 = _decodeBase64Escape(base64Variant, i6, 3);
                            }
                            if (iDecodeBase64Char3 == -2) {
                                int i19 = i9 + 1;
                                bArr[i9] = (byte) (i5 >> 10);
                    ...
                    if (iDecodeBase64Char2 >= 0) {
                        ...
                        if (iDecodeBase64Char2 == -2) {
                            ...
                            int i113 = this._inputPtr;
                            this._inputPtr = i113 + 1;
                            i7 = bArr9[i113] & 255;
                            if (base64Variant.usesPaddingChar(i7) && _decodeBase64Escape(base64Variant, i7, i8) != -2) {
                                throw reportInvalidBase64Char(base64Variant, i7, i8, "expected padding character '" + base64Variant.getPaddingChar() + "'");
                            }
                            bArr[i9] = (byte) (i3 >> 4);
                            i9++;
                        }
                    ...
                    int i114 = this._inputPtr;
                    this._inputPtr = i114 + 1;
                    i6 = bArr10[i114] & 255;
                    iDecodeBase64Char3 = base64Variant.decodeBase64Char(i6);
                    if (iDecodeBase64Char3 < 0) {
                        if (iDecodeBase64Char3 != -2) {
