...
public final class DurationKt {
    ...
    private static final long m2148timesmvk6XK0(int i, long j) {
        return Duration.m2059timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2147timeskIfJnKk(double d, long j) {
        return Duration.m2058timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2124getZEROUwyO8pc = Duration.INSTANCE.m2124getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    int i3 = length3 + 1;
                    DurationUnit durationUnitDurationUnitByIsoChar = DurationUnitKt.durationUnitByIsoChar(cCharAt5, z7);
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2057plusLRDsOJo = Duration.m2057plusLRDsOJo(jM2124getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM2124getZEROUwyO8pc = Duration.m2057plusLRDsOJo(jM2057plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2124getZEROUwyO8pc = Duration.m2057plusLRDsOJo(jM2124getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    i = i3;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM2124getZEROUwyO8pc = Duration.INSTANCE.m2122getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < length) {
                    ...
                    int i4 = length2;
                    while (i4 < str.length() && (('0' <= (cCharAt2 = str.charAt(i4)) && cCharAt2 < ':') || cCharAt2 == '.')) {
                        i4++;
                    }
                    Intrinsics.checkNotNull(str, "null cannot be cast to non-null type java.lang.String");
                    ...
                    int i5 = length4;
                    while (i5 < str.length() && 'a' <= (cCharAt = str.charAt(i5)) && cCharAt < '{') {
                        i5++;
                    }
                    Intrinsics.checkNotNull(str, "null cannot be cast to non-null type java.lang.String");
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2057plusLRDsOJo2 = Duration.m2057plusLRDsOJo(jM2124getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2124getZEROUwyO8pc = Duration.m2057plusLRDsOJo(jM2057plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2124getZEROUwyO8pc = Duration.m2057plusLRDsOJo(jM2124getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m2074unaryMinusUwyO8pc(jM2124getZEROUwyO8pc) : jM2124getZEROUwyO8pc;
    }
