...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public void resumeWith(Object result) {
        while (true) {
            ...
            if (obj == CoroutineSingletons.UNDECIDED) {
                if (C0137xc40028dd.m5m(RESULT, this, CoroutineSingletons.UNDECIDED, result)) {
                    return;
                }
            } else {
                ...
                if (C0137xc40028dd.m5m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
    ...
    public final Object getOrThrow() throws Throwable {
        Object obj = this.result;
        if (obj == CoroutineSingletons.UNDECIDED) {
            if (C0137xc40028dd.m5m(RESULT, this, CoroutineSingletons.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
