        ...
        try {
            ...
            if (text instanceof String) {
                ...
                while (charBufferAsReadOnlyBuffer.hasRemaining()) {
                    if (!(true ^ charsetEncoderNewReplaceEncoder.encode(charBufferAsReadOnlyBuffer, byteBufferByteBufferForEncoding, true).isError())) {
