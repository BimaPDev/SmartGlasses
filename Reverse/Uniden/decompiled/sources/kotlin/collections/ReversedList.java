...
final class ReversedList<T> extends AbstractMutableList<T> {
    ...
    public static final class C22081 implements ListIterator<T>, KMutableListIterator {
        ...
        C22081(ReversedList<T> reversedList, int i) {
