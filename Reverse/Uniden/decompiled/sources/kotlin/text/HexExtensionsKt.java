...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m915toStringimpl(ULong.m869constructorimpl(j))));
        }
        return (int) j;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:66:0x0150 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:69:0x0105 A[SYNTHETIC] */
    private static final byte[] hexToByteArraySlowPath(String str, int i, int i2, HexFormat.BytesHexFormat bytesHexFormat) {
        ...
        String groupSeparator = bytesHexFormat.getGroupSeparator();
        boolean ignoreCase = bytesHexFormat.getIgnoreCase();
        int i12 = parsedByteArrayMaxSize(i2 - i, bytesPerLine, bytesPerGroup, groupSeparator.length(), byteSeparator.length(), bytePrefix.length(), byteSuffix.length());
            ...
            if (i14 == bytesPerLine) {
                ...
                if (i15 == bytesPerGroup) {
                    ...
                    if (str4.length() == 0) {
                        ...
                        while (i16 < length4) {
                            int i17 = i14;
                            int i18 = length4;
                            if (!CharsKt.equals(groupSeparator.charAt(i16), str.charAt(length3 + i16), ignoreCase)) {
                    ...
                    if (i15 != 0) {
                        ...
                        if (str5.length() == 0) {
                            ...
                            while (i20 < length5) {
                                int i21 = length5;
                                int i22 = i15;
                                if (!CharsKt.equals(byteSeparator.charAt(i20), str.charAt(length3 + i20), ignoreCase)) {
                ...
                if (str2.length() == 0) {
                    ...
                    while (i7 < length) {
                        int i24 = length;
                        int i25 = i6;
                        if (!CharsKt.equals(bytePrefix.charAt(i7), str.charAt(length3 + i7), ignoreCase)) {
                ...
                if (i2 - 2 < length3) {
                    throwInvalidNumberOfDigits(str, length3, i2, 2, true);
                }
                i9 = i13 + 1;
                bArr[i13] = parseByteAt(str, length3);
                length3 += 2;
                str3 = byteSuffix;
                if (str3.length() == 0) {
                    i11 = i9;
                    ...
                    while (i10 < length2) {
                        int i26 = i9;
                        if (!CharsKt.equals(byteSuffix.charAt(i10), str.charAt(length3 + i10), ignoreCase)) {
    ...
    public static final String toHexString(byte b, HexFormat format) {
        ...
        if (number.getIsDigitsOnly()) {
            char[] cArr = {str.charAt((b >> 4) & 15), str.charAt(b & Ascii.f290SI)};
    ...
    private static final String toHexStringImpl(long j, HexFormat.NumberHexFormat numberHexFormat, String str, int i) {
        ...
        int iCheckFormatLength = checkFormatLength(((long) prefix.length()) + ((long) i2) + ((long) suffix.length()));
