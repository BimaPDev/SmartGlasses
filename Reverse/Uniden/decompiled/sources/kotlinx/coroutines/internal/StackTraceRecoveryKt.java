...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM695constructorimpl = Result.m695constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM695constructorimpl = Result.m695constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m698exceptionOrNullimpl(objM695constructorimpl) == null) {
            obj2 = objM695constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM695constructorimpl2 = Result.m695constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM695constructorimpl2 = Result.m695constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m698exceptionOrNullimpl(objM695constructorimpl2) == null) {
            obj = objM695constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m498to(cause, stackTrace);
                }
            }
            return TuplesKt.m498to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m498to(e, new StackTraceElement[0]);
    }
