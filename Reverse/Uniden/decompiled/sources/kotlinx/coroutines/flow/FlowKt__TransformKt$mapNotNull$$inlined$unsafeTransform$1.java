...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C24762<T> implements FlowCollector {
        ...
        @DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m504f = "Transform.kt", m505i = {0}, m506l = {219, 220}, m507m = "emit", m508n = {"$this$mapNotNull_u24lambda_u246"}, m509s = {"L$0"})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C24762.this.emit(null, this);
            }
        }

        public C24762(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C24762(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C24762 c24762 = new C24762(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c24762, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
