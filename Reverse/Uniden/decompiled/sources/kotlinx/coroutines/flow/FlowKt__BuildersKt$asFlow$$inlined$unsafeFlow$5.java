...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m504f = "Builders.kt", m505i = {0}, m506l = {114}, m507m = "collect", m508n = {"$this$asFlow_u24lambda_u247"}, m509s = {"L$0"})
    public static final class C23991 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C23991(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator<T> it;
        if (continuation instanceof C23991) {
            c23991 = (C23991) continuation;
            if ((c23991.label & Integer.MIN_VALUE) != 0) {
                c23991.label -= Integer.MIN_VALUE;
            } else {
                c23991 = new C23991(continuation);
            }
        } else {
            c23991 = new C23991(continuation);
        }
        Object obj = c23991.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c23991.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c23991.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c23991.L$0 = flowCollector2;
            c23991.L$1 = it;
            c23991.label = 1;
            if (flowCollector2.emit(next, c23991) == coroutine_suspended) {
