...
public final class C2436xdf1aa1b6<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", m504f = "Limit.kt", m505i = {0}, m506l = {139}, m507m = "emit", m508n = {"this"}, m509s = {"L$0"})
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return C2436xdf1aa1b6.this.emit(null, this);
        }
    }

    public C2436xdf1aa1b6(Function3 function3, FlowCollector flowCollector) {
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        C2436xdf1aa1b6<T> c2436xdf1aa1b6;
        ...
        if (i == 0) {
            ...
            c2436xdf1aa1b6 = (C2436xdf1aa1b6) anonymousClass1.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
        if (((Boolean) objInvoke).booleanValue()) {
            return Unit.INSTANCE;
        }
        throw new AbortFlowException(c2436xdf1aa1b6);
    }
}
