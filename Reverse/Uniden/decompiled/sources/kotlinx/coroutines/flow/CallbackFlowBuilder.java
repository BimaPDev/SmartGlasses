...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m504f = "Builders.kt", m505i = {0}, m506l = {330}, m507m = "collectTo", m508n = {"scope"}, m509s = {"L$0"})
    static final class C23921 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C23921(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C23921> continuation) {
            super(continuation);
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        C23921 c23921;
        if (continuation instanceof C23921) {
            c23921 = (C23921) continuation;
            if ((c23921.label & Integer.MIN_VALUE) != 0) {
                c23921.label -= Integer.MIN_VALUE;
            } else {
                c23921 = new C23921(this, continuation);
            }
        } else {
            c23921 = new C23921(this, continuation);
        }
        Object obj = c23921.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c23921.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c23921.L$0 = producerScope;
            c23921.label = 1;
            if (super.collectTo(producerScope, c23921) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c23921.L$0;
            ResultKt.throwOnFailure(obj);
        }
