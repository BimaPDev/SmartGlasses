...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m504f = "Reduce.kt", m505i = {0, 0}, m506l = {139}, m507m = "emit", m508n = {"this", "it"}, m509s = {"L$0", "L$1"})
    public static final class C24481 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C24481(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C24481) {
            c24481 = (C24481) continuation;
            if ((c24481.label & Integer.MIN_VALUE) != 0) {
                c24481.label -= Integer.MIN_VALUE;
            } else {
                c24481 = new C24481(continuation);
            }
        } else {
            c24481 = new C24481(continuation);
        }
        Object objInvoke = c24481.result;
        ...
        if (i == 0) {
            ...
            c24481.label = 1;
            InlineMarker.mark(6);
            objInvoke = function2.invoke(t, c24481);
            InlineMarker.mark(7);
            ...
            t = (T) c24481.L$1;
            flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c24481.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
