...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m504f = "Builders.kt", m505i = {0}, m506l = {114}, m507m = "collect", m508n = {"$this$asFlow_u24lambda_u2419"}, m509s = {"L$0"})
    public static final class C23951 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C23951(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super Long> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator<Long> it;
        if (continuation instanceof C23951) {
            c23951 = (C23951) continuation;
            if ((c23951.label & Integer.MIN_VALUE) != 0) {
                c23951.label -= Integer.MIN_VALUE;
            } else {
                c23951 = new C23951(continuation);
            }
        } else {
            c23951 = new C23951(continuation);
        }
        Object obj = c23951.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c23951.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c23951.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Long lBoxLong = Boxing.boxLong(((LongIterator) it).nextLong());
            c23951.L$0 = flowCollector2;
            c23951.L$1 = it;
            c23951.label = 1;
            if (flowCollector2.emit(lBoxLong, c23951) == coroutine_suspended) {
