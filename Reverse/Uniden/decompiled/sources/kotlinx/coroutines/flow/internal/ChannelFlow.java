...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m504f = "ChannelFlow.kt", m505i = {}, m506l = {119}, m507m = "invokeSuspend", m508n = {}, m509s = {})
    static final class C25012 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C25012(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C25012> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C25012 c25012 = new C25012(this.$collector, this.this$0, continuation);
            c25012.L$0 = obj;
            return c25012;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C25012) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C25012(flowCollector, channelFlow, null), continuation);
