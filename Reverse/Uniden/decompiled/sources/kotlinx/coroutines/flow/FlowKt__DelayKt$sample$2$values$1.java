...
@DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m504f = "Delay.kt", m505i = {}, m506l = {273}, m507m = "invokeSuspend", m508n = {}, m509s = {})
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C24191<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C24191(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C24191 c24191 = new C24191(producerScope);
            this.label = 1;
            if (flow.collect(c24191, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
