...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m504f = "Builders.kt", m505i = {0}, m506l = {114}, m507m = "collect", m508n = {"$this$asFlow_u24lambda_u245"}, m509s = {"L$0"})
    public static final class C23981 extends ContinuationImpl {
        ...
        public C23981(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator it;
        if (continuation instanceof C23981) {
            c23981 = (C23981) continuation;
            if ((c23981.label & Integer.MIN_VALUE) != 0) {
                c23981.label -= Integer.MIN_VALUE;
            } else {
                c23981 = new C23981(continuation);
            }
        } else {
            c23981 = new C23981(continuation);
        }
        Object obj = c23981.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c23981.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c23981.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Object next = it.next();
            c23981.L$0 = flowCollector2;
            c23981.L$1 = it;
            c23981.label = 1;
            if (flowCollector2.emit(next, c23981) == coroutine_suspended) {
