...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.channels.BroadcastChannelImpl", m504f = "BroadcastChannel.kt", m505i = {0, 0}, m506l = {227}, m507m = "send", m508n = {"this", "element"}, m509s = {"L$0", "L$1"})
    static final class C23271 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        C23271(BroadcastChannelImpl<E> broadcastChannelImpl, Continuation<? super C23271> continuation) {
            super(continuation);
    ...
    public java.lang.Object send(E r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.channels.BroadcastChannelImpl.C23271
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.channels.BroadcastChannelImpl$send$1 r0 = (kotlinx.coroutines.channels.BroadcastChannelImpl.C23271) r0
            int r1 = r0.label
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.channels.BroadcastChannelImpl$registerSelectForSend$2", m504f = "BroadcastChannel.kt", m505i = {}, m506l = {288}, m507m = "invokeSuspend", m508n = {}, m509s = {})
    static final class C23262 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23262(BroadcastChannelImpl<E> broadcastChannelImpl, Object obj, SelectInstance<?> selectInstance, Continuation<? super C23262> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C23262(this.this$0, this.$element, this.$select, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C23262) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: BroadcastChannel.kt */
    @Metadata(m490d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0082\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016¨\u0006\u0007"}, m491d2 = {"Lkotlinx/coroutines/channels/BroadcastChannelImpl$SubscriberBuffered;", "Lkotlinx/coroutines/channels/BufferedChannel;", "(Lkotlinx/coroutines/channels/BroadcastChannelImpl;)V", "cancelImpl", "", "cause", "", "kotlinx-coroutines-core"}, m492k = 1, m493mv = {1, 9, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                subscriberConflated.mo2197trySendJP2dKIU(getValue());
            }
    ...
    public Object mo2197trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                Object objMo2197trySendJP2dKIU = super.mo2197trySendJP2dKIU(element);
                reentrantLock.unlock();
                return objMo2197trySendJP2dKIU;
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (((BufferedChannel) it.next()).shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object objM2222failurePtdJZtk = ChannelResult.INSTANCE.m2222failurePtdJZtk();
                        reentrantLock.unlock();
                        return objM2222failurePtdJZtk;
                    }
                }
            }
            if (this.capacity == -1) {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2197trySendJP2dKIU(element);
            }
            Object objM2223successJP2dKIU = ChannelResult.INSTANCE.m2223successJP2dKIU(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM2223successJP2dKIU;
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        ...
        try {
            ...
            if (objRemove != null) {
                ...
                Unit unit = Unit.INSTANCE;
                reentrantLock.unlock();
                BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(select.getContext()), null, CoroutineStart.UNDISPATCHED, new C23262(this, element, select, null), 1, null);
            }
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
