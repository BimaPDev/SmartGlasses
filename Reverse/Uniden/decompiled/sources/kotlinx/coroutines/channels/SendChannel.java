...
public interface SendChannel<E> {
    ...
    Object mo2197trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2218isSuccessimpl(objMo2197trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2212exceptionOrNullimpl = ChannelResult.m2212exceptionOrNullimpl(objMo2197trySendJP2dKIU);
