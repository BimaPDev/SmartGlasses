...
public final class ProduceKt {
    ...
    @DebugMetadata(m503c = "kotlinx.coroutines.channels.ProduceKt", m504f = "Produce.kt", m505i = {0, 0}, m506l = {150}, m507m = "awaitClose", m508n = {"$this$awaitClose", "block"}, m509s = {"L$0", "L$1"})
    static final class C23781 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C23781(Continuation<? super C23781> continuation) {
            super(continuation);
        }
    ...
    public static final Object awaitClose(ProducerScope<?> producerScope, Function0<Unit> function0, Continuation<? super Unit> continuation) {
        C23781 c23781;
        if (continuation instanceof C23781) {
            c23781 = (C23781) continuation;
            if ((c23781.label & Integer.MIN_VALUE) != 0) {
                c23781.label -= Integer.MIN_VALUE;
            } else {
                c23781 = new C23781(continuation);
            }
        } else {
            c23781 = new C23781(continuation);
        }
        Object obj = c23781.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c23781.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (c23781.getContext().get(Job.INSTANCE) != producerScope) {
                    throw new IllegalStateException("awaitClose() can only be invoked from the producer context".toString());
                }
                c23781.L$0 = producerScope;
                c23781.L$1 = function0;
                c23781.label = 1;
                CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c23781), 1);
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c23781);
                }
                ...
                function0 = (Function0) c23781.L$1;
                ResultKt.throwOnFailure(obj);
            }
            function0.invoke();
            return Unit.INSTANCE;
