...
public final class InterruptibleKt {
    ...
    /* JADX INFO: compiled from: Interruptible.kt */
    @Metadata(m490d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m491d2 = {"<anonymous>", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m492k = 3, m493mv = {1, 9, 0}, m495xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(m503c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m504f = "Interruptible.kt", m505i = {}, m506l = {}, m507m = "invokeSuspend", m508n = {}, m509s = {})
    static final class C23192<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C23192(Function0<? extends T> function0, Continuation<? super C23192> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C23192 c23192 = new C23192(this.$block, continuation);
            c23192.L$0 = obj;
            return c23192;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C23192) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C23192(function0, null), continuation);
    }
