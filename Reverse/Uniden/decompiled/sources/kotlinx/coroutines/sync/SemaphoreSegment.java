...
final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public final boolean cas(int index, Object expected, Object value) {
        return C1850xa7a47114.m431m(getAcquirers(), index, expected, value);
    }
