...
public final /* synthetic */ class JobKt__JobKt {
    ...
    /* synthetic */ class C23201 extends FunctionReferenceImpl implements Function1<Throwable, Unit> {
        C23201(Object obj) {
    ...
    public static final DisposableHandle invokeOnCompletion(Job job, boolean z, boolean z2, InternalCompletionHandler internalCompletionHandler) {
        return job instanceof JobSupport ? ((JobSupport) job).invokeOnCompletionInternal$kotlinx_coroutines_core(z, z2, internalCompletionHandler) : job.invokeOnCompletion(z, z2, new C23201(internalCompletionHandler));
    }
    ...
    public static final /* synthetic */ Job m2190Job(Job job) {
        return JobKt.Job(job);
    }

    /* JADX INFO: renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m2191Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2190Job(job);
