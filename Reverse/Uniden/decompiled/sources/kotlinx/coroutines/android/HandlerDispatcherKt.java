...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM695constructorimpl = Result.m695constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM695constructorimpl = Result.m695constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m701isFailureimpl(objM695constructorimpl) ? null : objM695constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2252dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
